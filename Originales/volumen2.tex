...
\begin{figure}[H]
  \centering
  \caption{Intersección entre los planos $x + 2y + z = 4$ y $x = 2y$}
  \label{fig:interseccion_planos}
  \includegraphics[height=3.5cm]{Fig/148.pdf} \hspace{3mm}
  \includegraphics[height=3.5cm]{Fig/149.pdf}
  \fuentepropia
\end{figure}
...
\begin{figure}[H]
  \centering
  \caption{Proyección de los planos $x + 2y + z = 4$ y $x = 2y$}
  \label{fig:proyeccion_planos}
  \includegraphics[height=3.2cm]{Fig/150.pdf} \hspace{3mm}
  \includegraphics[height=3.2cm]{Fig/151.pdf} \hspace{3mm}
  \includegraphics[height=3.2cm]{Fig/152.pdf}
  \fuentepropia
\end{figure}

Los gráficos de la figura~\ref{fig:proyeccion_planos} nos ayudan a establecer los límites de las integrales triples que determinan su volumen.
\begin{multline*}
...
\begin{figure}[H]
  \centering
  \caption{Intersección entre los planos $x - y + z = 0$ y $y = 1$}
  \label{fig:interseccion_xy_planos}
  \includegraphics[height=4cm]{Fig/153.pdf} \hspace{3mm}
  \includegraphics[height=4cm]{Fig/154.pdf}
  \fuentepropia
\end{figure}
...
\begin{figure}[H]
  \centering
  \caption[Proyección de los planos $x - y + z = 0$, $y = 1$ y su intersección]{Proyección de los planos $x - y + z = 0$, $y = 1$\\ y su intersección}
  \label{fig:proyeccion_interseccion_planos}
  \includegraphics[height=3cm]{Fig/155.pdf} \hspace{3mm}
  \includegraphics[height=3cm]{Fig/156.pdf} \hspace{3mm}
  \includegraphics[height=3cm]{Fig/157.pdf}
  \fuentepropia
\end{figure}
...
\begin{figure}[H]
  ...
  \includegraphics[height=3.5cm]{Img/16c.pdf} \hspace{2mm}
  \includegraphics[height=3.5cm]{Img/16a.pdf} \hspace{2mm}
  \includegraphics[height=3.5cm]{Img/16b.pdf}
  \fuentepropia
\end{figure}

Esta figura se obtiene ejecutando las siguientes instrucciones:
...
\begin{figure}[H]
  ...
  \includegraphics[height=3.2cm]{Fig/158.pdf} \hspace{3mm}
  \includegraphics[height=3.2cm]{Fig/159.pdf} \hspace{3mm}
  \includegraphics[height=3.2cm]{Fig/160.pdf}
  \fuentepropia
\end{figure}

Las anteriores figuras nos orientan para plantear las siguientes integrales triples.
\begin{multline*}
...
\includegraphics[height=3.5cm]{Fig/161.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=3.5cm]{Fig/162.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Fig/163.pdf}
\fuentepropia
\end{figure}
...
Para efectos de la figura~\ref{fig:solido_parabolico_y}, la parte sobre el cilindro se parametriza con
$(1-u)\langle 0,t,4-t^{2}\rangle +u\langle t,t,4-t^{2}\rangle=\langle ut,t,4-t^{2}\rangle$.
...
entonces, $ |{\bf r}_{u}\cdot({\bf r}_{v}\times {\bf r}_{w})|=16|v^{2}(u-1)(uv+2-v)|$.
Por último, el volumen del sólido está dado por:
...
\begin{figure}[H]
\centering
\caption[Superficies delimitantes: $z = 2 - x$, $z^2 = x$, $y = 0$, $y = 3$, $z = 0$]{Superficies delimitantes: $z = 2 - x$, $z^2 = x$,\\
$y = 0$, $y = 3$, $z = 0$}
\label{fig:superficies_z2x_z2x_y03_2}
\includegraphics[height=3.5cm]{Fig/164.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Fig/165.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=2.8cm]{Img/15a.pdf} \hspace{2mm}
\includegraphics[height=2.8cm]{Img/15b.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=3cm]{Fig/166.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Fig/167.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Fig/168.pdf}
\fuentepropia
\end{figure}
...
\begin{figure}[H]
\centering
\caption[Superficies delimitantes: $z = 2 - x$, $z^2 = x$, $y = 0$, $y = 3$, $z = 0$]{Superficies delimitantes: $z = 2 - x$, $z^2 = x$,\\ $y = 0$, $y = 3$, $z = 0$}
\label{fig:superficies_z2x_z2x_y03_3}
\includegraphics[height=3.3cm]{Fig/206.pdf} \qquad
\includegraphics[height=3.3cm]{Fig/207.pdf}
\fuentepropia
\end{figure}
...
$y^2+z^2=9$, $z=x$ y $y=0$. Su gráfico se muestra en la figura~\ref{fig:solido_yz_xz}:

\begin{figure}[H]
\centering
\caption{Sólido determinado por $0 \leq y \leq \sqrt{9-z^2}$ y $0 \leq x \leq z$}
\label{fig:solido_yz_xz}
\includegraphics[height=3.5cm]{Fig/208.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Fig/209.pdf}
\fuentepropia
\end{figure}
...
\begin{figure}[H]
\centering
\caption[Proyecciones de $y^2 + z^2 = 9$, $z = x$, $y = 0$ y sus intersecciones]{Proyecciones de $y^2 + z^2 = 9$, $z = x$, $y = 0$\\ y sus intersecciones}
\label{fig:proyecciones_cilindro_plano}
\includegraphics[height=3.5cm]{Fig/210.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Fig/211.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Fig/212.pdf}
\fuentepropia
\end{figure}
...
Integrate[1,{y,0,3},{x,0,Sqrt[9-y^2]},{z,x,Sqrt[9-y^2]}]
...
\begin{figure}[H]
\centering
\caption{Sólido determinado por $x^2 + y^2 \leq x$, para $0 \leq z \leq -y$}
\label{fig:solido_disco_inclinado}
\includegraphics[height=3.5cm]{Img/12c.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Img/12a.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Img/12b.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=3.5cm]{Fig/213.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Fig/214.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Fig/215.pdf}
\fuentepropia
\end{figure}
...
+Sqrt[1/4-y^2]},{z,0,-y}]
Integrate[1,{x,0,1},{z,0,Sqrt[x-x^2]},{y,-Sqrt[x-x^2],-z}]
...
Se pueden formar segmentos rectilíneos que unan estos puntos y parame\-trizar así el sólido. Esto es $(1-w)Q+wP$ y es por esta razón que se usará la función
\[{\bf r}\left( u,v,w\right) =\left\langle \frac{1}{2}+u\cos (v) ,u\sin
(v) , (w-1)u\sin (v) \right\rangle,\]
para $u\in [0,1/2],\,v\in [-\pi,0],\,w\in [0,1]$. Por lo anterior, obtenemos los siguientes vectores:
\begin{eqnarray*}
...
\begin{figure}[H]
\centering
\caption{Sólido determinado por $0 \leq y + z \leq 2$ y $0 \leq x \leq 4 - y^2$}
\label{fig:solido_yz_xy}
\includegraphics[height=3.5cm]{Fig/216.pdf} \hspace{5mm}
\includegraphics[height=3.5cm]{Fig/217.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=3cm]{Fig/218.pdf} \hspace{5mm}
\includegraphics[height=3cm]{Fig/219.pdf} \\[5mm]
\includegraphics[height=3cm]{Fig/220.pdf}
\fuentepropia
\end{figure}
...
en donde $t\in [0,2]$, $u\in \lbrack 0,1]$, $w\in \lbrack 0,1]$.

Al derivar parcialmente se obtienen los siguientes vectores:
\begin{gather*}
{\bf r}_{t} = \langle -2wt,1,-u\rangle, \quad
{\bf r}_{u} = \langle 0,0,2-t\rangle, \quad
...
Integrate[Dot[D[r,w],Cross[D[r,t],D[r,u]]],{u,0,1},{t,0,2},{w,0,1}]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on

\subsection{Tres planos y un cilindro parabólico III}
Evaluar $\iiint_{E}6xydV$, en donde $E$ es el sólido acotado por las figuras de las ecuaciones $z=1+x+y$, $y=\sqrt{x}$, $x=1$, $z=0$, $y=0$. La figura~\ref{fig:solido_parabolico_inclinado} muestra la región en mención.

\begin{figure}[H]
\centering
\caption[Sólido determinado por $0 \leq z \leq 1 + x + y$,\; $y^2 \leq x \leq 1$,\; $0 \leq y \leq 1$]{Sólido determinado por $0 \leq z \leq 1 + x + y$,\\ $y^2 \leq x \leq 1$,\; $0 \leq y \leq 1$}
\label{fig:solido_parabolico_inclinado}
\includegraphics[height=3cm]{Fig/221.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Img/9b.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Img/9a.pdf}
\fuentepropia
\end{figure}
...
La intersección del plano y el cilindro parabólico está dada por la ecuación $z=1+x+\sqrt{x}$, de donde $x=(-\frac{1}{2}+\sqrt{z-3/4})^2$.
Además, la otra posible sustitución nos lleva a la expresión $z=1+y+y^2$, lo cual equivale a $y=-\frac{1}{2}+\frac{1}{2}\sqrt{4z-3}$.

\begin{figure}[H]
\centering
\caption[Visualización del sólido y sus proyecciones para el cálculo de volumen]{Visualización del sólido y sus proyecciones\\ para el cálculo de volumen}
\label{fig:volumen_solido_proyecciones}
\includegraphics[height=2.9cm]{Fig/222.pdf} \hspace{2mm}
\includegraphics[height=2.9cm]{Fig/223.pdf} \hspace{2mm}
\includegraphics[height=2.9cm]{Fig/224.pdf}
\fuentepropia
\end{figure}

\textls[-10]{La proyección en el plano $xy$ es una región acotada por una porción de parábola y dos rectas; además $z$ recorre la región desde el plano $z=0$ hasta el plano $z=1+x+y$.
Con lo anterior, la integral triple está determinada por:}
\[\int_{0}^{1}\int_{0}^{\sqrt{x}}\int_{0}^{1+x+y}6xydzdydx=\int_{0}^{1}\int_{y^2}^{1}\int_{0}^{1+x+y}6xydzdxdy= \frac{65}{28}.\]
En el caso de plantear las integrales en el orden $dxdydz$ y $dydxdz$ puede ser necesario presentar cuatro integrales triples, los gráficos de la figura~\ref{fig:volumen_solido_proyecciones} ilustran el porqué de esta situación.
...
\begin{gather*} \int_{0}^{1}\int_{0}^{1+x}\int_{0}^{\sqrt{x}}6xydydzdx+\int_{0}^{1}\int_{1+x}^{1+x+\sqrt[2]{x}}\int_{z-1-x}^{\sqrt{x}}6xydydzdx \\
...
\includegraphics[height=3cm]{Fig/225.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Fig/226.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Fig/227.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=3cm]{Fig/303.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Fig/302.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Imgn/62a.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=3.5cm]{Fig/304.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Fig/305.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Fig/306.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=3.5cm]{Fig/307.pdf}
\fuentepropia
\end{figure}
...
\textls[-10]{Sobre el plano $z=1-y$ se satisface que la coordenada $z$ tiene la forma
$z=(1-t)(1-u)$. El sólido se parametriza mediante una combinación convexa de dos puntos de la forma
$\langle t^2,\,u+(1-u)t,\,0\rangle$ y $\langle t^2,\,u+\mbox{(1-u)t,}\,(1-t)(1-u)\rangle$,
...
\includegraphics[height=2.4cm]{Img/27b.pdf} \hspace{2mm}
\includegraphics[height=2.4cm]{Img/27a.pdf} \hspace{2mm}
\includegraphics[height=2.4cm]{Img/27c.pdf} \hspace{2mm}
\includegraphics[height=2.4cm]{Img/27d.pdf}
\fuentepropia
\end{figure}
...
Ticks->{{0,1},{0,1,2},{-1,0}}]
RegionPlot3D[-Sqrt[1-x^2]<z<Sqrt[1-x^2]&&x<y<2*x&&0<x<1,
{x,0,1},{y,0,2},{z,-1,1},PlotPoints->90,Mesh->False,
Ticks->{{0,1},{0,1,2},{-1,0,1}}]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
\centering
\caption{Proyección del sólido en los planos coordenados}
\includegraphics[height=4cm]{Fig/308.pdf}
\includegraphics[height=4cm]{Fig/309.pdf}
\includegraphics[height=4cm]{Fig/310.pdf}
\fuentepropia
\end{figure}
...
Al integrar con respecto a $z$, los planos $y=x$ y $y=2x$ son paralelos al eje $z$ por lo que los límites para $z$ van desde la parte negativa del cilindro a la parte positiva de este. Por lo tanto, la integral en este caso es:
...
\end{gather*}
Las integrales anteriores en los órdenes $dydxdz$, $dzdxdy$ y $dxdzdy$ se evalúan en \verb"Mathematica" ejecutando las siguientes instrucciones:

% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
Integrate[1,{z,-1,1},{x,0,Sqrt[1-z^2]},{y,x,2x}]
Integrate[1,{y,0,1},{x,y/2,y},{z,-Sqrt[1-x^2],Sqrt[1-x^2]}]+
Integrate[1,{y,1,2},{x,y/2,1},{z,-Sqrt[1-x^2],Sqrt[1-x^2]}]
Integrate[1,{y,0,1},{z,-Sqrt[1-y^2],Sqrt[1-y^2]},{x,y/2,y}]+
Integrate[1,{y,0,1},{z,Sqrt[1-y^2],Sqrt[1-y^2/4]},
{x,y/2,Sqrt[1-z^2]}]+Integrate[1,{y,0,1},
{z,-Sqrt[1-y^2/4],-Sqrt[1-y^2]},{x,y/2,Sqrt[1-z^2]}]+
Integrate[1,{y,1,2},{z,-Sqrt[1-y^2/4],Sqrt[1-y^2/4]},
{x,y/2,Sqrt[1-z^2]}]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
\includegraphics[height=3.5cm]{Fig/311.pdf}
\fuentepropia
\end{figure}
...
El paraboloide con ecuación  $z = 4 - x^2 - y^2$ y el plano $x = 2-2y$ se intersecan en una región del espacio que se muestra en la figura~\ref{fig:solido_parabolico_inclinado_44}.
...
\includegraphics[height=3cm]{Img/44d.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Img/44a.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Img/44c.pdf}
\fuentepropia
\end{figure}
...
% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
ContourPlot3D[{z==4-x^2-y^2,x==2-2*y,y==0},{x,0,2},{y,0,2},{z,0,4},
Ticks->{{0,2},{2,4},{0,2,4}},MeshStyle->Gray]
RegionPlot3D[0<z<4-x^2-y^2&&0<x<2-2*y&&0<y<1,{x,0,2},{y,0,1},
{z,0,4},PlotPoints->90,Mesh->False,PlotStyle->RGBColor[0.7,0.2,0.1]]
ContourPlot3D[{z==4-x^2-y^2,x==2-2*y},{x,-2,2},{y,-2,2},{z,0,4},
ContourStyle->{Directive[Opacity[0.8]],
Directive[Cyan,Opacity[0.7]]},Mesh->False]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on

Plantearemos ahora las integrales triples que se requieren evaluar para determinar el volumen de esta región. Para determinar la proyección del sólido en los planos coordenados se debe eliminar una de las variables adecuadamente escogidas. En el plano $xy$ (que equivale a $z=0$), la proyección está dada por las expresiones $x = 2 -2y\,$ y $\,x^2 + y^2=4$.
...
\label{fig:proysoldosplano}
\includegraphics[height=3.5cm]{Fig/312.pdf}
\includegraphics[height=3.5cm]{Fig/313.pdf}
\fuentepropia
\end{figure}

Al integrar primera con respecto a $z$, esta toma valores desde el plano $xy$ hasta el paraboloide y los límites de integración con respecto a $x$ e $y$ se pueden obtener del primero de los gráficos de la figura~\ref{fig:proysoldosplano}. Mientras que al integrar primero con respecto a $x$, esta toma valores desde el plano $yz$ hasta el paraboloide, en un caso, y desde el plano $yz$ hasta el plano $x=2-2y$ en el otro caso. Por lo tanto, el volumen está dado por las siguientes integrales:
\begin{gather*}
...
$z^\prime =8-10y=0$, entonces $y=\frac{4}{5}$, por lo tanto el valor máximo de $z$ es.
...
\includegraphics[height=4cm]{Fig/314.pdf}
\fuentepropia
\end{figure}
...
% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
Integrate[1,{z,0,16/5},{y,0,(4-Sqrt[16-5*z])/5},{x,0,Sqrt[4-z-y^2]}]
+Integrate[1,{z,3,16/5},{y,(4+Sqrt[16-5*z])/5,Sqrt[4-z]},
{x,0,Sqrt[4-z-y^2]}]+Integrate[1,{z,16/5,4},{y,0,Sqrt[4-z]},
{x,0,Sqrt[4-z-y^2]}]+Integrate[1,{z,0,3},{y,(4-Sqrt[16-5*z])/5,1},
{x,0,2-2*y}]+Integrate[1,{z,3,16/5},{y,(4-Sqrt[16-5*z])/5,
...
también se sigue que $x=\frac{2}{5} \pm \frac{2}{5} \sqrt{16-5z}$. En los gráficos de la figura~\ref{fig:proysoldoxz} se ilustra porque en el orden $dydzdx$ se requiere evaluar dos integrales triples mientras que en el orden $dydxdz$ son necesarias cinco integrales triples.

\begin{figure}[H]
\centering
\caption{Proyección en el plano $xz$}
\label{fig:proysoldoxz}
\includegraphics[height=3.5cm]{Fig/315.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Fig/316.pdf}
\fuentepropia
\end{figure}

\textls[-10]{Apoyándonos en estas figuras presentamos las integrales triples respectivas:}
\begin{gather*}
...
% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
Integrate[1,{z,0,3},{x,0,(2+2*Sqrt[16-5z])/5},{y,0,1-x/2}]+
Integrate[1,{z,3,16/5},{x,2*(1-Sqrt[16-5z])/5,2*(1+Sqrt[16-5z])/5},
{y,0,1-x/2}]+Integrate[1,{z,3,16/5},{x,0,(2-2*Sqrt[16-5z])/5},
{y,0,Sqrt[4-z-x^2]}]+
Integrate[1,{z,16/5,4},{x,0,Sqrt[4-z]},{y,0,Sqrt[4-z-x^2]}]+
Integrate[1,{z,0,16/5},{x,(2+2*Sqrt[16-5z])/5,Sqrt[4-z]},
{y,0,Sqrt[4-z-x^2]}]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
& = \left\langle 2ut,1-u,w\left( 3+2u-u^{2}\left( 4t^{2}+1\right) \right) \right\rangle,
\end{align*}
...
\[\int_{0}^{1}\int_{0}^{1}\int_{0}^{1}\left| -2u\left( 3+2u-\left(4t^{2}+1\right) u^{2}\right)\right|\, dtdudw = \frac{19}{6} \]
%\end{tcolorbox}
...
$z=1-|y|$ y $z=x^2$. La región del espacio se muestra en la figura~\ref{fig:solido_parabolico_absoluto_2}.

\begin{figure}[H]
\centering
\caption{Sólido determinado por $x^2 \leq z \leq 1 - |y|$}
\label{fig:solido_parabolico_absoluto_2}
\includegraphics[height=3.5cm]{Img/28a.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Img/28c.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Img/28d.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=3.7cm]{Fig/317.pdf}
\includegraphics[height=3.5cm]{Fig/318.pdf}
\includegraphics[height=3.5cm]{Fig/319.pdf}
\fuentepropia
\end{figure}

Con estos gráficos (figura~\ref{fig:proyeccion_solido_parabolico_absoluto_2}) se plantean las integrales que determinan el volumen del sólido. Integrando primero con respecto a $z$, esta recorre puntos desde el cilindro parabólico $z=x^2$ hasta los planos $z=1-y$ y $z=1+y$.
\begin{multline*}
...
\includegraphics[height=4cm]{Fig/319.pdf}
\fuentepropia
\end{figure}
...
\textls[-10]{Estos cálculos se hacen en \verb"Mathematica" usando las siguientes instrucciones:}
...
$x^2+y^2=4$ y $x^2+y^2=2y$, que denominaremos cilindros mayor y menor respectivamente, acotan el siguiente sólido.

\begin{figure}[H]
\centering
\caption{Sólido determinado por $0 \leq z \leq 2 - y$, \quad $2y \leq x^2 + y^2 \leq 4$}
\label{fig:solido_corona_inclinada}
\includegraphics[height=4cm]{Img/31a.pdf} \hspace{2mm}
\includegraphics[height=4cm]{Img/31b.pdf}
\fuentepropia
\end{figure}
...
\centering
\caption{Proyección en el plano $yz$}
\includegraphics[height=4cm]{Fig/320.pdf}
\fuentepropia
\end{figure}

\textls[-10]{Por esta razón, el volumen se determina evaluando las siguientes integrales:}
\begin{multline*}
...
% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
Integrate[1,{y,-2,0},{z,0,2-y},{x,-Sqrt[4-y^2],Sqrt[4-y^2]}]+
Integrate[1,{y,0,2},{z,0,2-y},{x,-Sqrt[4-y^2],-Sqrt[2*y-y^2]}]+
Integrate[1,{y,0,2},{z,0,2-y},{x,Sqrt[2*y-y^2],Sqrt[4-y^2]}]
Integrate[1,{z,0,2},{y,-2,0},{x,-Sqrt[4-y^2],Sqrt[4-y^2]}]+
Integrate[1,{z,2,4},{y,-2,2-z},{x,-Sqrt[4-y^2],Sqrt[4-y^2]}]+
Integrate[1,{z,0,2},{y,0,2-z},{x,-Sqrt[4-y^2],-Sqrt[2*y-y^2]}]+
Integrate[1,{z,0,2},{y,0,2-z},{x,Sqrt[2*y-y^2],Sqrt[4-y^2]}]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
\label{fig:integracion_solido_planoxy}
\includegraphics[height=3.5cm]{Fig/321.pdf}
\includegraphics[height=3.5cm]{Fig/322.pdf}
\fuentepropia
\end{figure}

Los gráficos de la figura~\ref{fig:integracion_solido_planoxy} son útiles para calcular el volumen mediante el planteamiento de las integrales triples necesarias, integrando primero con respecto a $z$.
\begin{small}
\begin{multline*}
...
\includegraphics[height=4cm]{Fig/323.pdf}
\includegraphics[height=4cm]{Fig/324.pdf}
\fuentepropia
\end{figure}

Al reemplazar $y=2-z$, de la ecuación del plano en las ecuaciones de los cilindros se obtiene
$x^2+\left( 2-z\right) ^2=4$, por lo tanto $x^2+z^2=4z$ y $x^2+\left( 2-z\right) ^2=2\left( 2-z\right)$, entonces $x^2+z^2=2z$.
El sólido proyectado en el plano $xz$, junto con las líneas mencionadas antes, se observan en la figura~\ref{fig:cono_truncado_oblicuo}.

\begin{figure}[H]
\centering
\caption{Cono truncado oblicuo determinado por ${\bf r}(u,t)$}
\label{fig:cono_truncado_oblicuo}
\includegraphics[height=4cm]{Fig/325.pdf} \hspace{8mm}
\includegraphics[height=4cm]{Fig/326.pdf}
\fuentepropia
\end{figure}
...
\end{eqnarray}
Cuando $y$ va desde el cilindro de mayor radio al mismo cilindro son dos regiones que en el plano $xz$, que se proyectan con el sombreado gris oscuro.
\begin{eqnarray}
...
Desde la parte positiva del cilindro pequeño al plano, cuya proyección en el plano $xz$ corresponde a la parte sombreada en gris oscuro, tendremos la siguiente integral:
...
Desde la parte negativa del cilindro grande a la parte negativa del cilindro pequeño, cuya proyección en el plano $xz$ es la región cuadriculada:
...
+\int_{1}^2\int_{\sqrt{2z-z^2}}^{1}\int_{-\sqrt{4-x^2}}^{2-z}dydxdz \approx 0. 8822 \label{31k}
\end{multline}
\begin{eqnarray}
...
\end{eqnarray}
Desde el cilindro de mayor radio al mismo cilindro, hay dos regiones que en el plano $xz$ se proyectan de color gris claro.
\begin{eqnarray}
...
\end{eqnarray}
De la parte positiva del cilindro pequeño al plano, cuya proyección en el plano $xz$, corresponde a la parte en gris oscuro.
\begin{multline}
...
\end{multline}
Existe una parte (la región en azul es parte de ella) que posee una \emph{región atrás}, donde $y$ se recorre desde la parte negativa del cilindro mayor hasta la parte negativa el cilindro menor.
\begin{multline}
...
f=NIntegrate[1,{z,0,2-Sqrt[3]},{x,-2,-1},{y,-Sqrt[4-x^2],
Sqrt[4-x^2]}]+NIntegrate[1,{z,2-Sqrt[3],2},{x,-2,-Sqrt[4*z-z^2]},
{y,-Sqrt[4-x^2],Sqrt[4-x^2]}]+NIntegrate[1,{z,0,2-Sqrt[3]},{x,1,2},
{y,-Sqrt[4-x^2],Sqrt[4-x^2]}]+NIntegrate[1,{z,2-Sqrt[3],2},
{x,Sqrt[4*z-z^2],2},{y,-Sqrt[4-x^2],Sqrt[4-x^2]}]
g=Integrate[1,{z,0,2-Sqrt[3]},{x,-Sqrt[4*z-z^2],-Sqrt[2*z-z^2]},
{y,1+Sqrt[1-x^2],2-z}]+Integrate[1,{z,2-Sqrt[3],1},
{x,-1,-Sqrt[2*z-z^2]},{y,1+Sqrt[1-x^2],2-z}]
+Integrate[1,{z,0,2-Sqrt[3]},{x,Sqrt[2*z-z^2],Sqrt[4*z-z^2]},
{y,1+Sqrt[1-x^2],2-z}]+Integrate[1,{z,2-Sqrt[3],1},
{x,Sqrt[2*z-z^2],1},{y,1+Sqrt[1-x^2],2-z}]
h=NIntegrate[1,{z,0,2-Sqrt[3]},{x,-1,-Sqrt[4*z-z^2]},
{y,1+Sqrt[1-x^2],Sqrt[4-x^2]}]
+NIntegrate[1,{z,0,2-Sqrt[3]},{x,Sqrt[4*z-z^2],1},
{y,1+Sqrt[1-x^2],Sqrt[4-x^2]}]
i=NIntegrate[1,{z,0,1},{x,-1,-Sqrt[2*z-z^2]},{y,-Sqrt[4-x^2],
1-Sqrt[1-x^2]}]+NIntegrate[1,{z,0,1},{x,Sqrt[2*z-z^2],1},
...
\label{fig:yleqx2}
\includegraphics[height=4cm]{Fig/328.pdf}
\fuentepropia
\end{figure}

Los puntos $P$ y $Q$ de la figura~\ref{fig:yleqx2}, se determinan por medio de las funciones
...
\textls[-15]{Este valor se obtiene en \verb"Mathematica" usando las siguientes instrucciones:}
...
Esta superficie, junto con el plano $x=0$, acotan un sólido. La figura es la que se muestra a continuación.

\begin{figure}[H]
\centering
\caption{Sólido definido por $0 \leq x \leq 4 - (z - 2)^2 - \frac{4}{9}(y - 3)^2$}
\label{fig:solido_eliptico_desplazado_2}
\includegraphics[height=3.5cm]{Img/32a.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Img/32.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=3.5cm]{Fig/329.pdf}
\includegraphics[height=3.5cm]{Fig/330.pdf}
\includegraphics[height=3.5cm]{Fig/331.pdf}
\fuentepropia
\end{figure}
...
se obtiene \[x=4\left( 1-\frac{(z-2)^2}{4}-\frac{(y-3)^2}{9}\right),\] por lo tanto:
\[
\frac{(z-2)^2}{4} + \frac{(y-3)^2}{9} = 1 - \frac{x}{4},
\]
se obtiene
...
\int_{2 - \frac{1}{3}\sqrt{-9x - 4y^2 + 24y}}^{2 + \frac{1}{3}\sqrt{-9x - 4y^2 + 24y}} dz\,dy\,dx = 12\pi,
\]
\[
\int_{0}^{6}
...
% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
Integrate[1,{x,0,4},{y,3-3*Sqrt[4-x]/2,3+3*Sqrt[4-x]/2},
{z,2-Sqrt[24*y-4y^2-9*x]/3,2+Sqrt[24*y-4y^2-9*x]/3}]
Integrate[1,{y,0,6},{z,2-2Sqrt[6*y-y^2]/3,2+2Sqrt[6*y-y^2]/3},
{x,0,4-(z-2)^2-4*(y-3)^2/9}]
Integrate[1,{z,0,4},{x,0,4*z-z^2},{y,3-3*Sqrt[4*z-x-z^2]/2,
3+3*Sqrt[4*z-x-z^2]/2}]
...
\textls[-15]{La proyección del sólido en el plano $yz$ corresponde a una elipse cuyo interior se puede parametrizar como: $y=3+3u\sin t,\ z=2+2u\cos t$, en donde $u \in [0,1]$, $t \in [0,2\pi]$. Con dos puntos $A$ y $B$ sobre la elipse (con igual coordenada $y$) se escoge un punto $P$; este punto se proyecta sobre el paraboloide. Con una combinación convexa entre $P$ y $Q$ se parametriza el sólido.}

\begin{figure}[H]
\centering
\caption{$(2uv, 2(1 - v + uv))$}
\label{fig:curva_parametrica_uv_3}
\includegraphics[height=4cm]{Fig/332.pdf}
\fuentepropia
\end{figure}

Las coordenadas $x$ del punto $Q$ que está sobre el paraboloide satisfacen que
$x=4-4u^2$. Por lo tanto, los puntos mencionados son:
...
\[\int_{0}^{1}\int_{0}^{1}\int_{0}^{2\pi }\left| 24u^{3}-24u\right|dtdudw = 12\pi.\]
...
\includegraphics[height=3.5cm]{Img/81a.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Img/81b.pdf}
\fuentepropia
\end{figure}
...
\includegraphics{Fig/333.pdf}
\includegraphics{Fig/334.pdf}
\fuentepropia
\end{figure}
...
\textls[-10]{La proyección del sólido en el plano $xy$ en la forma $\left( u\cos v,u\sin v\right) $, con $u\in [0,1]$, $v\in [0,2\pi ]$, la coordenada $z$ sobre la esfera y el paraboloide están dadas, respectivamente, por $z =\sqrt{2-x^2-y^2}= \sqrt{2-u^2}$ y $z=x^2+y^2= u^2$. El sólido se parametriza simplificando una combinación convexa de la forma $(1-w)P+wQ$, en donde $P\left( u\cos v,u\sin v,\sqrt{2-u^2}\right)$ es un punto sobre la esfera y $Q\left( u\cos v,u\sin v,u^2\right)$ es un punto sobre el paraboloide.}
\begin{gather*}
...
\includegraphics[height=3.5cm]{Img/14d.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Img/14a.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Img/14b.pdf}
\fuentepropia
\end{figure}

En \verb"Mathematica", los gráficos de la figura~\ref{fig:solido_paraboloide_plano} se consiguen usando las siguientes instrucciones:
...
\centering
\caption{Proyecciones del sólido en los planos coordenados}
\includegraphics[height=3.2cm,valign=t]{Fig/335.pdf} \hspace{2mm}
\includegraphics[height=2.9cm,valign=t]{Fig/336.pdf} \hspace{2mm}
\includegraphics[height=2.7cm,valign=t]{Fig/337.pdf}
\fuentepropia
\end{figure}
...
\begin{multline*}
\bi_{-\frac{5}{2}}^{\frac{5}{2}}\bi_{\frac{13}{2}-\sqrt{\frac{25}{4}-x^2}}^{\frac{13}{2}+\sqrt{\frac{25}{4}-x^2}}\bi_{-\sqrt{z-x^2}}^{6-z}dydzdx \\Z +\bi_{-\sqrt{6}}^{\sqrt{6}}\bi_{x^2}^{\frac{13}{2}-\sqrt{\frac{25}{4}-x^2}}\bi_{-\sqrt{z-x^2}}^{\sqrt{z-x^2}}dydzdx = \frac{625\pi}{32}.
\end{multline*}
...
Integrate[1,{y,-3,2},{z,y^2,6-y},{x,-Sqrt[z-y^2],Sqrt[z-y^2]}]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
El procedimiento descrito antes, se puede efectuar mediante la ejecución de las siguientes instrucciones:
...
\label{fig:solido}
\includegraphics[height=3.5cm]{Img/3a.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Fig/338.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Img/3c.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=3.4cm]{Fig/339.pdf}
\includegraphics[height=3.4cm]{Fig/340.pdf}
\fuentepropia
\end{figure}
...
\textls[-10]{Estas integrales se evalúan en \verb"Mathematica" con las siguientes instrucciones:}
...
Con ayuda del gráfico de la figura~\ref{fig:sqrt4z_2}, el volumen se puede plantear mediante las siguientes integrales:
...
\includegraphics[height=4.2cm]{Fig/342.pdf}
\fuentepropia
\end{figure}
...
$( 1-u)(1+\cos(t) ,\sin(t)) +u(2\cos(t),2\sin(t))$, para $u\in [0,1]$.
Consideremos un punto $P( 1-u+(u+1)\cos (t),(1+u)\sin (t),0)$ en la base del sólido y $Q( 1-u+(u+1)\cos (t),(1+u)\sin (t),2(1-u^2)(1-\cos(t)))$ un punto sobre el paraboloide.
...
\subsection{Un paraboloide hueco} \index{Paraboloide!hueco}
...
\includegraphics[height=3.5cm]{Img/79a.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Img/79b.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Img/79c.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=4.2cm]{Fig/343.pdf}
\fuentepropia
\end{figure}

El sólido se parametriza mediante la función
\begin{multline*}
{\bf r}\left( t,u,v\right) = \left\langle 1-u+\left( 1+2u\right) \cos (2t) ,\left( 1+2u\right) \sin (2t) , \right. \\
\left. \left( 7-2u-5u^2+\left( 4u^2-2u-2\right) \cos(2t)\right) v\right\rangle,
\end{multline*}
en donde $t\in [0,\pi]$, $u\in [0,1]$ y $v \in [0,1]$.
Con la función ${\bf r}$ hallamos los siguientes vectores:
\begin{align*}
{\bf r}_{t} &= \left\langle -2\left( 2u+1\right) \sin (2t),2\left( 2u+1\right) \cos (2t) ,-4v(2u^2-u-1)\sin (2t) \right\rangle \\
...
% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
{x,y}=(1-u)*{3*Cos[2*t],3*Sin[2*t]}+u*{1+Cos[2*t],Sin[2*t]};
...
\begin{gather*}
  \int_{-3}^{3}\int_{-\sqrt{9-x^2}}^{\sqrt{9-x^2}}\left(9-x^2-y^2\right) dydx- 2\int_{0}^2\int_{0}^{\sqrt{2x-x^2}}\left(9-x^2-y^2\right)dydx= 33\pi,
\end{gather*}
...
Sqrt[9-x^2]}]-2*Integrate[9-x^2-y^2,{x,0,2},{y,0,Sqrt[2*x-x^2]}]
...
\includegraphics[height=3.7cm]{Img/26a.pdf} \hspace{2mm}
\includegraphics[height=3.7cm]{Img/26b.pdf} \hspace{2mm}
\includegraphics[height=3.7cm]{Img/26c.pdf}
\fuentepropia
\end{figure}
...
RegionPlot3D[x^2+y^2<z<5-y^2&&-Sqrt[5-2*y^2]<x<Sqrt[5-2*y^2],
{x,-2.5,2.5},{y,-2.5,2.5},{z,0,5},
...
\centering
\caption{Proyecciones del sólido en los planos coordenados}
\includegraphics[height=3.2cm,valign=m]{Fig/344.pdf} \hspace{3mm}
\includegraphics[height=3.2cm,valign=m]{Fig/345.pdf}
\includegraphics[height=2.5cm,valign=m]{Fig/346.pdf}
\fuentepropia
\end{figure}

Eliminando $z$ de las ecuaciones $z=x^2+y^2$ y $z=5-y^2$, se obtiene $x^2+2y^2=5$; esta expresión en el plano $xy$ representa una elipse.
Para integrar primero con respecto a $z$ se debe tener en cuenta que $z$ recorre los puntos que se hallan entre el paraboloide y el cilindro, los límites en $y$ y $x$ se pueden obtener de la proyección en el plano $xy$. Por lo tanto, el volumen del sólido está dado por las siguientes integrales:
...
La coordenada $z$ está dada por {\small $z = \frac{5}{2}u^2\cos ^2t+\frac{5}{2}u^2$} para el paraboloide, {\small $z=5-\frac{5}{2}u^2\sin ^2t$} para el cilindro. Con un punto $P$ sobre el paraboloide y un punto $Q$ sobre el cilindro, se forma una combinación convexa de la forma $(1-w)P+wQ$ que parametriza el sólido, esto es,
...
Con lo anterior, se calcula el producto vectorial triple que corresponde al elemento diferencial de volumen $| {\bf r}_{t}\cdot ( {\bf r}_{u}\times {\bf r}_{w}) | =\frac{25}{2}\sqrt{2} \left| u( u^2-1)\right|$, que al integrarlo, nos produce el volumen del sólido mencionado:
...
El siguiente ejercicio es tomado de \textcite{thomas_calculo_2015}.
...
\includegraphics[height=3.5cm]{Img/96a.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Img/96b.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Img/96c.pdf}
\fuentepropia
\end{figure}

Los gráficos de la figura~\ref{fig:solido_paraboloides_elipticos} se consiguen con la ayuda de las siguientes instrucciones:

% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
ContourPlot3D[{z==8-x^2-y^2,z==x^2+3*y^2},{x,-3,3},{y,-3,3},{z,0,8},
ContourStyle->{Directive[Cyan,Opacity[0.8]],
Directive[Orange,Opacity[0.9]]},Mesh->False]
RegionPlot3D[x^2+3*y^2<z<8-x^2-y^2&&x^2+2y^2<4,{x,-2,2},
{y,-Sqrt[2],Sqrt[2]},{z,0,8},Mesh->False,PlotPoints->90]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
\centering
\caption{Cono truncado oblicuo determinado por ${\bf r}(u,t)$}
\includegraphics[height=4.2cm]{Fig/347.pdf} \hspace{8mm}
\includegraphics[height=4.2cm]{Fig/348.pdf}
\fuentepropia
\end{figure}
...
\end{gather}
\textls[-15]{Estas integrales se evalúan en \verb"Mathematica" con las siguientes instrucciones:}

% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
Integrate[1,{x,-2,2},{z,6-x^2/2,8-x^2},{y,-Sqrt[8-z-x^2],
Sqrt[8-z-x^2]}]+Integrate[1,{x,-2,2},{z,x^2,6-x^2/2},
{y,-Sqrt[(z-x^2)/3],Sqrt[(z-x^2)/3]}]
Integrate[1,{z,4,6},{x,-Sqrt[8-z],-Sqrt[12-2z]},
{y,-Sqrt[8-z-x^2],Sqrt[8-z-x^2]}]+Integrate[1,{z,4,6},
{x,Sqrt[12-2z],Sqrt[8-z]},{y,-Sqrt[8-z-x^2],Sqrt[8-z-x^2]}]+
Integrate[1,{z,6,8},{x,-Sqrt[8-z],Sqrt[8-z]},
{y,-Sqrt[8-z-x^2],Sqrt[8-z-x^2]}]+Integrate[1,{z,4,6},
{x,-Sqrt[12-2z],Sqrt[12-2z]},{y,-Sqrt[(z-x^2)/3],Sqrt[(z-x^2)/3]}]+
Integrate[1,{z,0,4},{x,-Sqrt[z],Sqrt[z]},{y,-Sqrt[(z-x^2)/3],
Sqrt[(z-x^2)/3]}]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
\begin{gather}
\bi_{-\sqrt{2}}^{\sqrt{2}}\bi_{4+y^2 }^{8-y^2}\bi_{-\sqrt{8-z-y^2}}^{\sqrt{8-z-y^2}}dxdzdy
...
% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
Integrate[1,{y,-Sqrt[2],Sqrt[2]},{z,4+y^2,8-y^2},{x,-Sqrt[8-z-y^2],
Sqrt[8-z-y^2]}]+Integrate[1,{y,Sqrt[2],Sqrt[2]},{z,3*y^2,4+y^2},
{x,-Sqrt[z-3y^2],Sqrt[z-3y^2]}]
...
\includegraphics[height=3.5cm]{Fig/349.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=2.5cm]{Img/89b.pdf} \hspace{2mm}
\includegraphics[height=2.5cm]{Img/89c.pdf} \hspace{2mm}
\includegraphics[height=2.5cm]{Img/89d.pdf}
\fuentepropia
\end{figure}

Con las siguientes instrucciones se obtuvo la figura~\ref{fig:region_paraboloides_89}.
...
\includegraphics[height=3.5cm]{Fig/350.pdf} \hspace{10mm}
\includegraphics[height=3.5cm]{Fig/351.pdf} \hspace{10mm}
\includegraphics[height=3.5cm]{Fig/352.pdf}
\fuentepropia
\end{figure}
...
Al integrar primero con respecto a $x$, se debe tener presente que $x$, igual que en el caso anterior, recorre los puntos desde la parte negativa de cada paraboloide hasta la parte positiva del mismo, por tal razón las integrales en este caso son:
\begin{multline*}
...
% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
Integrate[1,{z,-4,2},{y,1,8-7*(z+1)^2/9},{x,-2-2*
Sqrt[(8-y)/7-(z+1)^2/9],-2+2*Sqrt[(8-y)/7-(z+1)^2/9]}]+
Integrate[1,{z,-4,2},{y,-2+(z+1)^2/3,1},
{x,-2-Sqrt[(4/3)*(y+2)-4(z+1)^2/9],-2+Sqrt[(4/3)*(y+2)4(z+1)^2/9]}]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
\end{eqnarray*}
El elemento diferencial de volumen es
$\left\vert {\bf r}_{t}\cdot \left({\bf r}_{u}\times {\bf r}_{w}\right) \right\vert =\left\vert 60u\left( u^2-1\right) \right\vert $,
...
\includegraphics[height=3.5cm]{Img/61a.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Img/61c.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Img/61b.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=3.5cm]{Fig/353.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Fig/354.pdf}
\fuentepropia
\end{figure}
...
\begin{gather*}
\int_{-3}^{3}\int_{-\sqrt{9-x^2}}^{\sqrt{9-x^2}}\int_{-\sqrt{16-x^2-z^2}}^{\sqrt{16-x^2-z^2}}dydzdx + 4\bigg(\int_{-3}^{3}\int_{\sqrt{9-x^2}}^{\sqrt{\frac{25}{2}-x^2}}\int_{\sqrt{x^2+z^2-9}}^{\sqrt{16-x^2-z^2}}dydzdx+ \\
...
Si se integra primero con respecto a $z$, hay tres regiones en el espacio, en dos de ellas $z$ recorre los puntos desde la parte negativa de la esfera hasta su parte positiva; en la tercer región $z$ recorre los puntos que van desde la parte negativa del hiperboloide hasta su parte positiva, razón por la cual las integrales a evaluar en este caso son:
\begin{multline*}
...
% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
Integrate[r,{\[Theta],0,2*Pi},{r,0,3},{y,-Sqrt[16-r^2],
Sqrt[16-r^2]}]+2*Integrate[r,{\[Theta],0,2*Pi},{r,3,5/Sqrt[2]},
{y,Sqrt[r^2-9],Sqrt[16-r^2]}]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
\begin{enumerate}
\item Las expresiones $63x^2+252x+28z^2+56z+36y=8$ y $9x^2+36x+16+4z^2+8z-12y=0$, en las órdenes $dxdydz$ y $dzdxdy$.
\item $x^2 + y^2 + z^2 \leq 16$ y $x^2 + z^2 \leq 9 + y^2$; en los órdenes $dydxdz$, $dzdydx$ $dxdydz$ y $dxdzdy$.
...
% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
RegionPlot3D[x^2+y^2+z^2<=1&&z<1-Sqrt[x^2+y^2]&&x^2+y^2<=1,
{x,-1,1},{y,-1,1},{z,-1,1},PlotPoints->90,Mesh->None]
...
\includegraphics[height=3.2cm]{Img/13c.pdf} \hspace{2mm}
\includegraphics[height=3.2cm]{Img/13b.pdf} \hspace{2mm}
\includegraphics[height=3.2cm]{Img/13a.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=2.8cm]{Fig/355.pdf} \hspace{2mm}
\includegraphics[height=2.8cm]{Fig/356.pdf} \hspace{2mm}
\includegraphics[height=2.8cm]{Fig/357.pdf}
\fuentepropia
\end{figure}
...
\int_{-1}^{1} \int_{-\sqrt{1 - y^2}}^{\sqrt{1 - y^2}} \int_{-\sqrt{1 - x^2 - y^2}}^{1 - \sqrt{x^2 + y^2}} dz\,dx\,dy = \pi.
\end{gather*}
...
\textls[-15]{Esta integral se evalúa con \verb"Mathematica", ejecutando la siguiente instrucción.}

% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
Integrate[1,{z,0,1},{x,z-1,1-z},{y,-Sqrt[(1-z)^2-x^2],
Sqrt[(1-z)^2-x^2]}]+Integrate[1,{z,-1,0},{x,-Sqrt[1-z^2],
Sqrt[1-z^2]},{y,-Sqrt[1-x^2-z^2],Sqrt[1-z^2-x^2]}]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
$\int_{0}^{2\pi }\int_{0}^{1}\int_{-\sqrt{1-r^2}}^{1-r}rdzdrd\theta = \pi$.
...
Derivando parcialmente, se obtiene el elemento diferencial de volumen $\left| {\bf r}_{w}\cdot \left( {\bf r}_{u}\times {\bf r}_{v}\right) \right| = u\left( \sqrt{1-u^2}-u+1\right)$, cuya integración nos proporciona el volumen del sólido:
\[\int_{0}^{1}\int_{0}^{2\pi}\int_{0}^{1}u\left( \sqrt{1-u^2}-u+1\right) dudvdw= \pi.\]

\enlargethispage*{\baselineskip}

\section{Un elipsoide y un hiperboloide} \index{Elipsoide} \index{Hiperboloide}
...
\includegraphics[height=3cm]{Img/60c.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Img/60a.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Img/60aa.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=3cm]{Fig/358.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Fig/359.pdf}
\fuentepropia
\end{figure}

\begin{figure}[H]
\centering
\caption{El sólido proyectado en el plano $xy$}
\includegraphics[height=3cm]{Fig/360.pdf}
\end{figure}
...
\includegraphics[height=3.5cm]{Img/34d.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Img/34a.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Img/34c.pdf}
\fuentepropia
\end{figure}
...
% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
ContourPlot3D[{z==4-y^2,2-x^2==y},{x,-2,2},{y,-2,2},{z,0,4},
ContourStyle->{Blend[{Yellow,Red}],RGBColor[0.3,0.6,0.4]},
Mesh->None,PlotPoints->60]
RegionPlot3D[0<z<4-y^2&&-Sqrt[2-y]<x<Sqrt[2-y]&&-2<y<2,{x,-2,2},
{y,-2,2},{z,0,4},PlotPoints->90,Mesh->None,PlotStyle->Orange]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
Integrando primero con respecto a $z$, los puntos recorridos van desde $z=0$ hasta el cilindro $z=4-y^2$ y los límites para $x$ e $y$ se pueden obtener del segundo de los gráficos de la figura~\ref{fig:proyecciones_yz_xy}. Además, integrando primero con respecto a $x$,
...
\includegraphics[height=4cm]{Fig/361.pdf} \hspace{2mm}
\includegraphics[height=4cm]{Fig/362.pdf} \hspace{2mm}
\fuentepropia
\end{figure}

Con la información observada en los gráficos de la figura~\ref{fig:proyecciones_yz_xy}, las siguientes integrales triples determinan el volumen del sólido.
...
{y,-Sqrt[4-z],Sqrt[4-z]}]+
NIntegrate[1,{x,-2,2},{z,0,4*x^2-x^4},{y,-Sqrt[4-z],2-x^2}]
NIntegrate[1,{z,0,4},{x,-Sqrt[2-Sqrt[4-z]],Sqrt[2-Sqrt[4-z]]},
{y,-Sqrt[4-z],Sqrt[4-z]}]+NIntegrate[1,{z,0,4},
{x,-Sqrt[2+Sqrt[4-z]],-Sqrt[2-Sqrt[4-z]]},{y,-Sqrt[4-z],2-x^2}]+
NIntegrate[1,{z,0,4},{x,Sqrt[2-Sqrt[4-z]],Sqrt[2+Sqrt[4-z]]},
{y,-Sqrt[4-z],2-x^2}]
\end{Verbatim}
\end{tcolorbox}
...
{\small
\[{\bf r}(u,v,w) = \langle t,(4-t^2)u-2,-(t^2-4)uw((t^2-4)u+4)\rangle,
\]}

y que parametriza el sólido con $t\in [ -2,2]$, $u\in [0,1]$, $w\in [0,1]$.
...
Con lo anterior, el elemento diferencial de volumen está dado por:
\[\left| {\bf r}_{t}\cdot \left({\bf r}_{u}\times {\bf r}_{w}\right) \right| =\left| \left( t^2-4\right) ^2\left( u-1\right) \left(t^2-ut^2+4u\right) \right|,\]
...
\includegraphics[height=3cm]{Img/84b.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Img/84c.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Img/84d.pdf}
\fuentepropia
\end{figure}
...
% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
ContourPlot3D[{z==1-x^2,z==Cos[y]},{x,-Sqrt[2],Sqrt[2]},
{y,0,2*Pi},{z,-1,1},Mesh->False,ContourStyle->{Orange,Green}]
RegionPlot3D[Cos[y]<z<1-x^2&&-2<x<2,{x,-Sqrt[2],Sqrt[2]},
{y,0,2*Pi},{z,-1,1},PlotPoints->30,Mesh->False]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
\includegraphics[height=2.5cm]{Fig/365.pdf} \hspace{2mm}
\includegraphics[height=2.5cm]{Fig/366.pdf} \hspace{2mm}
\includegraphics[height=2.5cm]{Fig/367.pdf}
\fuentepropia
\end{figure}
...
Integrate[1,{y,0,2*Pi},{z,Cos[y],1},{x,-Sqrt[1-z],Sqrt[1-z]}]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
\caption{$\cos(y) = 1 - x^2$}
\label{fig:curva_cosyx2}
\includegraphics[height=4cm]{Fig/368.pdf}
\fuentepropia
\end{figure}

El sólido se parametriza mediante una función $\mathbf{r}$, que es combinación convexa con dos puntos de la forma $P((2u - 1)\sqrt{1 - \cos t}, t, \cos t)$ y $Q((1 - 2u)\sqrt{1 - \cos t}, 4u(1 - u) + (1 - 2u)^2 \cos t)$. Esto es:
\begin{gather*}
\begin{aligned}
...
$z= 4x-x^2$, $z= 4y-y^2$ y el plano $z=0$ acotan un sólido en el primer octante, su gráfico se muestra en la figura~\ref{fig:parabolas_z_2}.

\begin{figure}[H]
\centering
\caption{$0 \leq z \leq 4x - x^2$, \quad $0 \leq z \leq 4y - y^2$}
\label{fig:parabolas_z_2}
\includegraphics[height=4cm]{Img/10b.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Img/10a.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=4cm]{Fig/369.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Img/10c.pdf}
\fuentepropia
\end{figure}
...
% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
RegionPlot3D[0<z<2*x-x^2&&0<z<2*y-y^2&&2-x<y<x&&1<x<2,{x,0,2},
{y,0,2},{z,0,1},PlotPoints->90,Mesh->False,PlotStyle->Orange]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
\includegraphics[height=4cm]{Fig/370.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Fig/371.pdf}
\fuentepropia
\end{figure}
...
\textls[-10]{En el plano $xz$ se forma una combinación convexa entre dos puntos de la forma $P(2-\sqrt{4-t}, t)$ y $Q(2 + \sqrt{4-t}, t)$, obteniendo} $({2+(2u-1)}\sqrt{4-t}, t)$ que parametriza la porción interior a la parábola sobre el eje $z$, con $t \in[0,4]$, $u \in[0,1]$.
...
El sólido se parametriza simplificando una combinación convexa entre dos puntos de la forma $(2+(2u-1)\sqrt{4-t},$ $2-\sqrt{4-t},$ $t)$ y $({2+(2u-1)}$ $\sqrt{4-t},$ ${2+\sqrt{4-t}},$ $t)$. Por lo tanto, la parametrización escogida para el sólido es ${\bf r}(u,t,w)= \langle 2+(2u-1)\sqrt{4-t},2+(2w-1)\sqrt{4-t},t \rangle$, en donde $t\in [0,4]$, $u\in [0,1]$ y $w\in [0,1]$.
...
Integrate[Dot[D[r,w],Cross[D[r,t],D[r,u]]],{u,0,1},{t,0,4},{w,0,1}]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on

\subsection{Un cilindro parabólico y un plano inclinado}
Consideremos el sólido acotado por el gráfico de las ecuaciones $y=4-x^2$, $z=2-y/2$, $y=0$ y $z=0$ (figura~\ref{fig:parabolas_z}); de este modo, hallaremos su volumen de varias maneras.

\begin{figure}[H]
\centering
\caption{$0 \leq z \leq 4x - x^2$, \quad $0 \leq z \leq 4y - y^2$}
\label{fig:parabolas_z}
\includegraphics[height=3.5cm]{Img/T_0a.pdf} \hspace{5mm}
\includegraphics[height=3.5cm]{Fig/373.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=3cm]{Fig/374.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Fig/375.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Fig/376.pdf}
\fuentepropia
\end{figure}
...
La proyección del sólido en el plano $xz$ es un rectángulo dividido por la curva $z=x^2/2$. En el orden $dydxdz$ es necesario plantear tres integrales triples:
\begin{multline*}
\int_{0}^2\int_{-\sqrt{2z}}^{\sqrt{2z}}\int_{0}^{4-2z}dydxdz
+\int_{0}^2\int_{-2}^{-\sqrt{2z}}\int_{0}^{4-x^2}dydxdz \\
+\int_{0}^2\int_{\sqrt{2z}}^2\int_{0}^{4-x^2}dydxdz= \frac{64}{5}\\
\int_{-2}^2\int_{x^2/2}^2\int_{0}^{4-2z}dydzdx +\int_{-2}^2\int_0^{x^2/2}\int_{0}^{4-x^2}dydzdx=\frac{64}{5}.
\end{multline*}

\textls[-10]{Estas integrales se evalúan en \verb"Mathematica" con las siguientes indicaciones:}

% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
Integrate[1,{z,0,2},{y,0,4-2*z},{x,-Sqrt[4-y],Sqrt[4-y]}]
...
La región sobre el plano $xy$ se parametriza uniendo dos puntos, uno sobre el eje $x$ que tiene la forma $(t,0) $ y el otro sobre la curva $y=4-x^2$ que posee la forma $(t,4-t^2)$, con $t\in [-2,2]$. Simplificando $( 1-u) ( t,0) +u( t,4-t^2)$ se sigue, por un lado, que $z=2+y/2= 2-2u+\frac{1}{2}ut^2$.

Por lo tanto, la función ${\bf r}$ es una combinación convexa entre un punto sobre el plano $xy$ y otros sobre el plano $z=2-y/2;$ simplificando ${(1-w)} \langle t,u( 4-t^2),0\rangle +w\langle t,u( 4-t^2) ,2-2u+\frac{1}{2}ut^2\rangle$ se define ${\bf r}( t,u,w) = \langle t,4u-ut^2,\frac{1}{2}w( 4-4u+ut^2)\rangle $, con $t \in [-2,2]$, $u \in [0,1]$, $w \in [0,1]$. Además,
\begin{align*} {\bf r}_{t} &= \langle 1,-2tu,wtu\rangle \\
{\bf r}_{u}&= \langle 0,4-t^2,w(t^2-4)/2 \rangle \\
{\bf r}_{w}&= \langle 0,0,2-2u+ut^2/2 \rangle.
\end{align*}

El triple producto vectorial
$|{\bf r}_t\cdot ( {\bf r}_u \times {\bf r}_w)| =\frac{1}{2}|(4-t^2)(4-4u+ut^2)|$ se integra para obtener el volumen del sólido
...
\includegraphics[height=4cm]{Fig/378.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Fig/379.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=3cm]{Fig/380.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Fig/381.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Fig/382.pdf}
\fuentepropia
\end{figure}
...
$z=( 2-t^2) u$, por lo tanto un punto del sólido en el plano
...
El cálculo anterior se hace en \verb"Mathematica" utilizando las siguientes \mbox{sentencias}:

% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
r=(1-w)*{t,0,u*(2-t^2)}+w*{t,2-u*(2-t^2),u*(2-t^2)};
A=Simplify[Dot[D[r,t],Cross[D[r,u],D[r,w]]]]
Integrate[Abs[A],{t,-Sqrt[2],Sqrt[2]},{u,0,1},{w,0,1}]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
\includegraphics[height=3.5cm]{Img/25a.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Img/25b.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Img/25c.pdf}
\fuentepropia
\end{figure}
%
...
\includegraphics[height=4cm]{Fig/383.pdf} \hspace{5mm}
\includegraphics[height=3.8cm]{Fig/384.pdf}
\fuentepropia
\end{figure}
...
hasta el cilindro $z=4-x^2$ y los límites de integración para $x$ e $y$ se obtienen del primero de los gráficos de la figura~\ref{fig:proyeccion_xy_xz_2}. Entonces, el volumen del sólido está dado por:
...
$x= \pm \sqrt{y}$ y $x= \pm \sqrt{8-z}$. Los límites de integración para $x$ y $z$ se obtienen del segundo de los gráficos de la figura~\ref{fig:proyeccion_xy_xz_2}.
...
\includegraphics[height=3.5cm]{Fig/385.pdf}
\fuentepropia
\end{figure}
...
Integrate[1,{z,0,4},{x,-Sqrt[4-z],Sqrt[4-z]},{y,x^2,8-x^2}]
Integrate[1,{y,0,4},{x,-Sqrt[y],Sqrt[y]},{z,0,4-x^2}]+
Integrate[1,{y,4,8},{x,-Sqrt[8-y],Sqrt[8-y]},{z,0,4-x^2}]
Integrate[1,{z,0,4},{y,0,4-z},{x,-Sqrt[y],Sqrt[y]}]+
Integrate[1,{z,0,4},{y,4-z,z+4},{x,-Sqrt[4-z],Sqrt[4-z]}]+
Integrate[1,{z,0,4},{y,z+4,8},{x,-Sqrt[8-y],Sqrt[8-y]}]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
\textls[-20]{Este proceso se hace en \verb"Mathematica" ejecutando las siguientes instrucciones:}
...
\includegraphics[height=3cm]{Fig/387.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Fig/388.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Img/7b.pdf}
\fuentepropia
\end{figure}

La línea gruesa corresponde a la curva de intersección de los dos cilindros parabólicos; en esta curva se usó la parametrización
...
% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
ContourPlot3D[{z==4*x-x^2,y==4*x-x^2},{x,0,4},{y,0,4},{z,0,4}]
RegionPlot3D[0<z<4*x-x^2&&0<y<4*x-x^2,{x,0,4},{y,0,4},{z,0,4},
PlotStyle->{Blend[{Red,Orange,Gray}]},Mesh->False,PlotPoints->50]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
\includegraphics[height=3cm]{Fig/389.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Fig/390.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Fig/391.pdf}
\fuentepropia
\end{figure}

Con ayuda de los elementos anteriores se presentan las integrales triples necesarias para calcular el volumen del sólido en mención.
\begin{gather*}
\ds \int_{0}^{4}\int_{0}^{z}\int_{2-\sqrt{4-z}}^{2+\sqrt{4-z}}dxdydz+\int_{0}^{4}\int_{z}^{4}\int_{2-\sqrt{4-y}}^{2+\sqrt{4-y}}dxdydz= \frac{512}{15}\\
\ds \int_{0}^{4}\int_{y}^{4}\int_{2-\sqrt{4-z}}^{2+\sqrt{4-z}}dxdzdy+\int_{0}^{4}\int_{0}^{y}\int_{2-\sqrt{4-y}}^{2+\sqrt{4-y}}dxdzdy= \frac{512}{15}\\
\ds \int_{0}^{4}\int_{0}^{4x-x^2}\int_{0}^{4x-x^2}dzdydx = \int_{0}^{4}\int_{2-\sqrt{4-y}}^{2+\sqrt{4-y}}\int_{0}^{4x-x^2}dzdxdy= \frac{512}{15}\\
\ds \int_{0}^{4}\int_{0}^{4x-x^2}\int_{0}^{4x-x^2}dydzdx= \int_{0}^{4}\int_{2-\sqrt{4-z}}^{2+\sqrt{4-z}}\int_{0}^{4x-x^2}dydxdz= \frac{512}{15}.
\end{gather*}
...
Integrate[1,{z,0,4},{x,2-Sqrt[4-z],2+Sqrt[4-z]},{y,0,4*x-x^2}]
Integrate[1,{z,0,4},{y,0,z},{x,2-Sqrt[4-z],2+Sqrt[4-z]}]+
Integrate[1,{z,0,4},{y,z,4},{x,2-Sqrt[4-y],2+Sqrt[4-y]}]
Integrate[1,{y,0,4},{z,y,4},{x,2-Sqrt[4-z],2+Sqrt[4-z]}]
+Integrate[1,{y,0,4},{z,0,y},{x,2-Sqrt[4-y],2+Sqrt[4-y]}]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
\includegraphics[height=3.5cm]{Fig/392.pdf}
\fuentepropia
\end{figure}
...
\textls[-15]{El cálculo anterior se hizo en \verb"Mathematica" con las siguientes instrucciones:}
...
determinan una región en el espacio, su gráfico se muestra en la figura~\ref{fig:solido_parabolico_2y}:

\begin{figure}[H]
\centering
\caption{Visualización del sólido definido por $0 \leq z \leq 2 - y$, \quad $x^2 \leq y \leq 2$}
\label{fig:solido_parabolico_2y}
\includegraphics[height=3.5cm]{Fig/393.pdf} \hspace{5mm}
\includegraphics[height=3.5cm]{Fig/394.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=3cm]{Fig/395.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Fig/396.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Fig/397.pdf}
\fuentepropia
\end{figure}

Los gráficos de la figura~\ref{fig:proyecciones_coordenadas_final} nos ayudan a plantear las integrales necesarias para calcular el volumen del sólido.
...
Sobre el plano $z=2-y$ se satisface que $z=(t^2-2)(u-1) $. Por lo tanto, el sólido se parametriza con una combinación convexa de la forma
...
Por lo tanto, el volumen del sólido está dado por:
%
...
\includegraphics[height=4cm]{Fig/398.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Fig/399.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=3cm]{Fig/400.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Fig/401.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Fig/402.pdf}
\fuentepropia
\end{figure}
...
\, dt\, du\, dw = \frac{5}{12}.
\]
\textls[-20]{Con las siguientes sentencias se hace el procedimiento descrito anteriormente.}
...
\includegraphics[height=2.8cm]{Imgn/53a.pdf} \hspace{3mm}
\includegraphics[height=2.8cm]{Img/53b.pdf} \hspace{3mm}
\includegraphics[height=3cm]{Img/53c.pdf} \hspace{3mm}
\includegraphics[height=3cm]{Img/53d.pdf}
\fuentepropia
\end{figure}

Los gráficos de la figura~\ref{fig:solido_curvo} se obtienen con la ayuda de las siguientes expresiones:

% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
ContourPlot3D[{x==z^2,x==4*y-y^2},{x,0,4},{y,0,4},{z,-2,2},
PlotPoints->50,Mesh->False,Ticks->{{0,2,4},{0,1,3},{0,2}},
ContourStyle->{Blend[{Yellow,Pink,Green}],Orange}]
...
Al igualar estas expresiones para determinar su proyección en el plano $yz$, obtenemos $(y-2)^2+z^2=4$, que corresponde a una circunferencia de radio $2$ centrada en el punto $(2,0)$.

En el plano $xz$ la proyección es la porción de parábola $x=z^2$ para $x\in[0,4];$ mientras que para el plano $xy$ la región de integración es la porción de parábola $x=4y-y^2$ para $x\in[0,4]$. En los gráficos de la figura~\ref{fig:proyecciones_curvas} se ilustran estas regiones.

\begin{figure}[H]
\centering
\caption{Proyecciones en los planos coordenados}
\label{fig:proyecciones_curvas}
\includegraphics[height=3cm]{Fig/403.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Fig/404.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Fig/405.pdf}
\fuentepropia
\end{figure}

Con ayuda de los gráficos de la figura~\ref{fig:proyecciones_curvas} se pueden plantear las integrales que determinan el volumen del sólido; en un caso conviene escribir la expresión $x=4y-y^2$ en la forma
$y=2\pm \sqrt{4-x}$.
...
% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
Integrate[1,{y,0,4},{z,-Sqrt[4y-y^2],Sqrt[4y-y^2]},{x,z^2,4y-y^2}]
Integrate[1,{z,-2,2},{y,2-Sqrt[4-z^2],2+Sqrt[4-z^2]},{x,z^2,4y-y^2}]
Integrate[1,{y,0,4},{x,0,4y-y^2},{y,-Sqrt[x],Sqrt[x]}]
Integrate[1,{z,-2,2},{x,z^2,4},{y,2-Sqrt[4-x],2+Sqrt[4-x]}]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
Integrate[Dot[D[r,t],Cross[D[r,u],D[r,w]]],{w,0,1},{u,0,1},{t,0,4}]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
\includegraphics[height=3.5cm]{Fig/406.pdf} \hspace{5mm}
\includegraphics[height=3.5cm]{Fig/407.pdf}
\fuentepropia
\end{figure}
...
$xy$. Es decir, $4x=z^2=(y^2)^2$, luego $4x=y^4$, con lo anterior se obtiene la siguiente figura.

\begin{figure}[H]
\centering
\caption{Proyección sobre los planos coordenados}
\label{fig:proyecciones_planes_curvas}
\includegraphics[height=3.5cm]{Fig/408.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Fig/409.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Fig/410.pdf}
\fuentepropia
\end{figure}

Con ayuda de la figura~\ref{fig:proyecciones_planes_curvas} se pueden plantear las seis integrales triples que permiten calcular el volumen del sólido mencionado.
\begin{multline*}
...
La figura~\ref{fig:solido_80_xyz} ofrece otras vistas del mismo sólido.

\begin{figure}[H]
\centering
\caption{Visualización del sólido definido por $0 \leq 4x \leq z^2$, \quad $0 \leq z \leq y^2$}
\label{fig:solido_80_xyz}
\includegraphics[height=3.5cm]{Img/80c.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Img/80b.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Img/80a.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=3.5cm]{Fig/411.pdf}
\fuentepropia
\end{figure}
...
\[\left| {\bf r}_{t}\cdot \left( {\bf r}_{u}\times {\bf r}_{w}\right) \right| = \frac{1}{2}\left| t^{5}\left( t-2\right) \right|,\]
...
\textls[-20]{Este valor se obtiene en \verb"Mathematica" ejecutando las siguientes instrucciones:}

% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
r=(1-w)*{t^4/4,t+u*(2-t),t^2}+w*{0,t+u*(2-t),t^2}
Integrate[Dot[D[r,w],Cross[D[r,t],D[r,u]]],{t,0,2},{u,0,1},{w,0,1}]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
\includegraphics[height=3cm]{Img/88a.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Img/88b.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Img/88d.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=3.5cm]{Fig/412.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Fig/413.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Fig/414.pdf}
\fuentepropia
\end{figure}
...
Cinco de estas integrales se evalúan en \verb"Mathematica" ejecutando las siguientes instrucciones:

% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]
\begin{Verbatim}[formatcom=\letraverbatim]
Integrate[1,{y,-Sqrt[2],Sqrt[2]},{z,y^2,2},{x,-1,3-2z}]
Integrate[1,{y,-Sqrt[2],Sqrt[2]},{x,-1,3-2y^2},{z,y^2,(3-x)/2}]
...
tiene la forma $(-1,t)$. Por lo tanto, la proyección del sólido se parametriza mediante una combinación convexa de $M$ y $N$,
...
\includegraphics[height=3.5cm]{Fig/415.pdf}
\fuentepropia
\end{figure}
...
\]
Por lo tanto, $Q$ es de la forma $Q( 2u\left( 2-t^2\right) -1,t,u\left( t^2-2\right)+2)$. Formando una combinación convexa entre $P$ y $Q$, se parametriza el sólido, esto es,
\begin{equation*}
...
% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
r=Simplify[(1-w)*{2u*(2-t^2)-1,t,t^2}+w*{2u*(2-t^2)-1,t,
u*(t^2-2)+2}]
...
\includegraphics[height=3cm]{Img/30a.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Fig/416.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Img/30d.pdf}
\fuentepropia
\end{figure}
...
\begin{SaveVerbatim}{apretar_contour}
ContourPlot3D[{x==1-z^2,z==1-y},{x,0,1},{y,0,2},{z,-1,1},Mesh->False,
ContourStyle->{Orange,Gray,Opacity[0.85]},PlotPoints->80]
RegionPlot3D[0<x<1-z^2&&0<y<1-z,{x,0,1},{y,0,2},{z,-1,1},
PlotStyle->Blend[{Yellow,Orange,Gray,Red}],Mesh->False,
PlotPoints->90]
\end{SaveVerbatim}
% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]
   \textls[-10]{\UseVerbatim[formatcom=\letraverbatim]{apretar_contour}}
\end{tcolorbox}
% tex-fmt: on

Con el propósito de plantear las integrales triples que se requieren pa\-ra~calcu\-lar el volumen de $E$, se muestran ahora las proyecciones en los planos coordenados. Para el caso del plano $xy$, se elimina la variable $z$ de las expresiones que determinan la intersección, es decir, se hace la sustitución $x=1-z^2=1-(1-y)^2=2y-y^2$.
...
\includegraphics[height=3cm]{Fig/417.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Fig/418.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Fig/419.pdf}
\fuentepropia
\end{figure}
...
Integrate[1,{y,0,1},{x,2*y-y^2,1},{z,-Sqrt[1-x],Sqrt[1-x]}]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
En el plano $xz$, sobre la curva $x=1-z^2$ consideramos dos puntos $P(u,\sqrt{1-u})$ y $Q(u,-\sqrt{1-u});$ Formando segmentos rectilíneos de la forma $(1-v)P +vQ$, con $v\in [0,1]$; \textls[-15]{así, se simplifica como $\big(u,\sqrt{1-u}(2v-1)\big)$,} para $u \in [0,1],\ v \in [0,1]$.

\begin{figure}[H]
\centering
\caption{Región delimitada por $0 \leq x \leq 1 - z^2$}
\label{fig:region_parabolica_xz}
\includegraphics[height=3.5cm]{Fig/420.pdf}
\fuentepropia
\end{figure}
...
\begin{figure}[H]
\centering
\caption{Visualización del sólido definido por $0 \leq z \leq 10 - x - \frac{y^2}{8}$ y $x^3 \leq y \leq \sqrt{8(10 - x)}$}
\label{fig:solido_11_xyz}
\includegraphics[height=3cm]{Img/11d.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Img/11c.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Img/11b.pdf}
\fuentepropia
\end{figure}
...
&&0<=x<=2,{x,0,2},{y,0,9},{z,0,10},PlotPoints->90,Mesh->False]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
\caption{Proyecciones del sólido en los planos coordenados}
\label{figura115}
\includegraphics[height=3cm]{Fig/421.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Fig/422.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Fig/423.pdf}
\fuentepropia
\end{figure}
...
Al integrar primero con respecto a $x$ se debe observar que en una región esta recorre los puntos desde el plano $yz$ hasta el cilindro $x=\sqrt[3]{y}$, y en otro caso hasta la superficie $x=10-z-y^2/8$.
\begin{gather*}
...
% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
Integrate[1,{x,0,2},{y,x^3,Sqrt[8*(10-x)]},{z,0,10-x-y^2/8}]
Integrate[1,{y,0,8},{x,0,y^(1/3)},{z,0,10-x-y^2/8}]+
Integrate[1,{y,8,Sqrt[80]},{x,0,10-y^2/8},{z,0,10-x-y^2/8}]
Integrate[1,{x,0,2},{z,0,10-x-x^6/8},{y,x^3,Sqrt[8*(10-x-z)]}]
Integrate[1,{y,0,8},{z,0,10-y^(1/3)-y^2/8},{x,0,y^(1/3)}]+
Integrate[1,{y,0,8},{z,10-y^(1/3)y^2/8,10-y^2/8},{x,0,10-z-y^2/8}]+
Integrate[1,{y,8,Sqrt[80]},{z,0,10-y^2/8},{x,0,10-z-y^2/8}]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
Si la densidad del sólido en cualquier punto $(x,y,z)$ está dada por $\delta(x,y,z)$ $= xy$, entonces la masa del sólido es:
\[M=\int_0^2\int_{x^3}^{\sqrt{8 (10-x)}}\int_0^{10-x-\frac{y^2}{8}}xydzdydx=\frac{13\,000}{63}.\]
...
&= \frac{5120 \left(18\,700 \sqrt{5}-34\,721\right)}{35\,343} \\[1ex]
...
$(\overline{x},\overline{y},\overline{z})=\left(\frac{8708}{8125},\frac{512 \sqrt{5}}{39}-\frac{4\,444\,288}{182\,325},\frac{22\,198}{8125}\right)$.
Este proceso se hace en \verb"Mathematica" como sigue:

\begin{SaveVerbatim}{apretado}
M=Integrate[x*y,{x,0,2},{y,x^3,Sqrt[8*(10-x)]},{z,0,10-x-y^2/8}];
Mxy=Integrate[x*y*z,{x,0,2},{y,x^3,Sqrt[8*(10-x)]},{z,0,10-x-y^2/8}];
Mxz=Integrate[x*y^2,{x,0,2},{y,x^3,Sqrt[8*(10-x)]},{z,0,10-x-y^2/8}];
Myz=Integrate[x^2*y,{x,0,2},{y,x^3,Sqrt[8*(10-x)]},{z,0,10-x-y^2/8}];
Simplify[{Myz/M,Mxz/M,Mxy/M}]
\end{SaveVerbatim}

% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]
   \textls[-5]{\UseVerbatim[formatcom=\letraverbatim]{apretado}}
\end{tcolorbox}
% tex-fmt: on
...
%\begin{tcolorbox}[title=\bfseries Parametrizando el sólido]
%\small
La proyección del sólido en el plano $xy$ (figura \ref{figura115})
se parametriza considerando dos puntos $A(t,t^{3})$ y $B\left( t,\sqrt{8\left( 10-t\right) }\right) $ para $t\in[0,2]$. Simplificando la expresión $(1-u)A+uB$, se obtiene
\[\left\langle t,t^{3}(1-u)+u\sqrt{8\left(10-t\right) }\right\rangle.\]
...
\[P\left( t,t^{3}(1-u)+u\sqrt{8\left( 10-t\right) },0\right) \]
y
\[Q\left( t,t^{3}(1-u)+u\sqrt{8\left( 10-t\right) },\overline{z}\right)\]
...
$\left\vert {\bf r}_{t}\cdot \left({\bf r}_{u}\times {\bf r}_{v}\right) \right\vert$ está dado por:
\begin{gather*}
...
\begin{figure}[H]
\centering
\caption{Visualización del sólido definido por $x^2 + z^2 \leq 16$ y $2x^2 + y^2 \leq 8x$}
\label{fig:solido_cilindro_elipse}
\includegraphics[width=0.23\textwidth]{Img/29a.pdf} \hfill
\includegraphics[width=0.23\textwidth]{Img/29b.pdf} \hfill
\includegraphics[width=0.23\textwidth]{Img/29c.pdf} \hfill
\includegraphics[width=0.23\textwidth]{Img/29d.pdf}
\fuentepropia
\end{figure}
...
% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
ContourPlot3D[{16==x^2+z^2,2*x^2+y^2==8*x},{x,0,4},{y,0,3},{z,0,4},
PlotPoints->60,Ticks->{{0,2,4},{0,1,2},{0,2,4}},
Mesh->False,ContourStyle->{Orange,Blend[{Yellow,Pink,Green}]}]
RegionPlot3D[0<z<Sqrt[16-x^2]&&0<y<Sqrt[8*x-2*x^2]&&0<x<4,
{x,0,4},{y,0,3},{z,0,4},PlotPoints->90,
PlotStyle->Directive[Orange,Specularity[White,40]],Mesh->False]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on

Para establecer con claridad los límites en las integrales triples respectivas, que determinan el volumen del sólido, se verifica que en el plano $xz$ la región es un cuarto del círculo centrado en el origen y radio $4$. Entre tanto, en el plano $xy$, la expresión $2x^2+y^2=8x$ equivale a $2(x-2)^2+y^2=8$ y representa una elipse con centro en el punto $(2,0)$.

\begin{figure}[H]
\centering
\caption{Proyecciones en los planos coordenados}
\label{fig:proyecciones_cilindro_elipse_curva}
\includegraphics[height=3.5cm]{Fig/424.pdf} \hspace{2mm}
\includegraphics[height=3.4cm]{Fig/425.pdf} \hspace{2mm}
\includegraphics[height=3.6cm]{Fig/426.pdf}
\fuentepropia
\end{figure}

Con lo anterior, presentamos las integrales triples según el orden de integración señalado.

Al integrar primero con respecto a $x$, se debe tener en cuenta las dos regiones proyectadas en el plano $yz$, en un caso se parte de la parte negativa del cilindro elíptico y se llega hasta la parte positiva del mismo cilindro. Mientras que en la otra región $x$ recorre los puntos que van desde la parte negativa del cilindro elíptico hasta el cilindro circular.

\enlargethispage*{\baselineskip}

De la expresión $x^2+z^2=16$, se sigue que $x=\pm \sqrt{16-z^2}$. Del reemplazo en la otra ecuación se obtiene $16-z^2+2y^2=4\sqrt{16-z^2}$, que equivale a $\left( z^2-y^2\right) ^2=16\left( z^2+2y^2\right)$. De esta expresión se obtiene $z=\sqrt{8+\frac{y^2}{2}\pm 2\sqrt{16-2y^2}}$.
...
\[y=\sqrt{2z^2-32\pm 8\sqrt{16-z^2}},\]
entonces tenemos otra forma de hallar el mismo volumen.
\begin{multline*}
...
por lo tanto, el volumen del sólido esta dado por:
\begin{multline*}
\int_{0}^{4}\int_{0}^{\sqrt{8x-2x^2}}\int_{0}^{\sqrt{16-x^2}}dzdydx = \\
\int_{0}^{\sqrt{8}}\int_{2-\frac{1}{2}\sqrt{16-2y^2}}^{2+\frac{1}{2}\sqrt{16-2y^2}}\int_{0}^{\sqrt{16-x^2}}dzdxdy \approx 28.75.
\end{multline*}
Para el orden $dydxdz$, $y$ recorre los puntos desde el plano $xz$ hasta el cilindro elíptico; en este caso, las integrales correspondientes son las \mbox{siguientes}.
\begin{gather*}
...
\end{gather*}
\textls[-10]{Una de las integrales anteriores se evaluó numéricamente en} \verb"Mathematica" ejecutando la siguiente instrucción.

% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
NIntegrate[1,{y,0,Sqrt[8]},{z,0,Sqrt[8+y^2/2-Sqrt[64-8*y^2]]},
{x,2-Sqrt[16-2*y^2]/2,2+Sqrt[16-2*y^2]/2}]+
NIntegrate[1,{y,0,Sqrt[8]},{z,Sqrt[8+y^2/2-Sqrt[64-8*y^2]],
Sqrt[8+y^2/2+Sqrt[64-8*y^2]]},{x,2-Sqrt[16-2*y^2]/2,Sqrt[16-z^2]}]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
\textls[-15]{El triple producto vectorial proporciona el elemento diferencial de volumen,}
...
$z=1-x^2$, $x^2+y^2=1$ y $z=0$. La figura~\ref{fig:solido_disco_parabolico} ilustra esta situación.

\begin{figure}[H]
\centering
\caption{Visualización del sólido definido por $x^2 + y^2 \leq 1$ y $0 \leq z \leq 1 - x^2$}
\label{fig:solido_disco_parabolico}
\includegraphics[height=3.8cm]{Img/85c.pdf} \hspace{5mm}
\includegraphics[height=3.8cm]{Fig/428.pdf} \hspace{5mm}
\includegraphics[height=3.7cm]{Img/85b.pdf}
\fuentepropia
\end{figure}
...
% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
ContourPlot3D[{z==1-x^2,x^2+y^2==1},{x,-1,1},{y,-1,1},{z,0,1},
Mesh->False,ContourStyle->{Cyan,Orange}]
A=RegionPlot3D[0<z<1-x^2&&x^2+y^2<1,{x,-1,1},{y,-1,1},{z,0,1},
PlotStyle->RGBColor[0.8,0.2,0.2],Mesh->False,PlotPoints->90,
Axes->False,Boxed->False];
B=ParametricPlot3D[{{Cos[t],Sin[t],1-Cos[t]^2},{Cos[t],Sin[t],0}},
{t,0,2Pi},PlotStyle->{Gray,Gray}];
Show[A,B]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
\includegraphics[height=3cm]{Fig/429.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Fig/430.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Fig/431.pdf}
\fuentepropia
\end{figure}
...
En el plano $xz$, la proyección es una región acotada por una porción de parábola y en el plano $x$, el volumen está dado por:
...
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]
\begin{Verbatim}[formatcom=\letraverbatim]
Integrate[1,{x,-1,1},{y,-Sqrt[1-x^2],Sqrt[1-x^2]},{z,0,1-x^2}]
Integrate[1,{y,-1,1},{x,-Sqrt[1-y^2],Sqrt[1-y^2]},{z,0,1-x^2}]
Integrate[1,{y,-1,1},{z,y^2,1},{x,-Sqrt[1-z],Sqrt[1-z]}]+
Integrate[1,{y,-1,1},{z,0,y^2},{x,-Sqrt[1-y^2],Sqrt[1-y^2]}]
Integrate[1,{x,-1,1},{z,0,1-x^2},{y,-Sqrt[1-x^2],Sqrt[1-x^2]}]
Integrate[1,{z,0,1},{x,-Sqrt[1-z],Sqrt[1-z]},{y,-Sqrt[1-x^2],
Sqrt[1-x^2]}]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
\textls[-15]{La base del sólido es un círculo unitario que se parametriza $(u\cos \theta ,u\sin \theta ,0)$,} sobre el cilindro parabólico se satisface que $z=1-x^2=1-u^2\cos ^2\theta $. El sólido se parametriza formando una combinación convexa entre un punto en la base y otro punto sobre el cilindro parabólico, esto es ${(1-w)}$ $(u\cos \theta ,u\sin \theta ,0) +w( u\cos \theta ,u\sin \theta ,1-u^2\cos ^2\theta)$; al simplificarse, nos permite definir la función
...
entonces, el volumen del sólido esta dado por:
\[\int_{0}^{1}\int_{0}^{1}\int_{0}^{2\pi }u\left( 1-u^2\cos ^2\theta \right) d\theta dudw= \frac{3\pi}{4}.\]
\textls[-15]{Este cálculo se hace en \verb"Mathematica" ejecutando las siguientes instrucciones:}
...
\begin{figure}[H]
\centering
\caption{Visualización del sólido definido por $0 \leq z \leq 4 - x^2$ y $y^4 - 2y^2 \leq 4x \leq 2y^2$}
\label{fig:solido_curvas_parabolicas}
\includegraphics[height=4cm]{Img/17c.pdf} \hspace{2mm}
\includegraphics[height=4cm]{Img/17d.pdf} \hspace{2mm}
\includegraphics[height=4cm]{Img/17b.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=4.5cm]{Fig/432.pdf} \hspace{5mm}
\includegraphics[height=4.5cm]{Fig/433.pdf}
\fuentepropia
\end{figure}

Con ayuda de los gráficos de la figura~\ref{fig:proyecciones_curvas_parabolicas}, podemos plantear las integrales triples que determinan el volumen del sólido.
\begin{gather*}
\bigintss_{-\frac{1}{4}}^{0}\bigintss_{\sqrt{1-\sqrt{1+4x}}}^{\sqrt{1+\sqrt{1+4x}}}\bigintss_{0}^{4-x^2}dzdydx+\bigintss_{0}^2\bigintss_{\sqrt{2x}}^{\sqrt{1+\sqrt{1+4x}}}\bigintss_{0}^{4-x^2}dzdydx \\
\bigintss_{-\frac{1}{4}}^{0}\bigintss_{0}^{4-x^2}\bigintss_{\sqrt{1-\sqrt{1+4x}}}^{\sqrt{1+\sqrt{1+4x}}}dydzdx+\bigintss_{0}^2\bigintss_{0}^{4-x^2}\bigintss_{\sqrt{2x}}^{\sqrt{1+\sqrt{1+4x}}}dydzdx \\
= \bigintss_{0}^2 \bigintss_{\frac{y^{4}-2y^2}{4}}^{\frac{y^2}{2}}\bigintss_{0}^{4-x^2}dzdxdy= \frac{169\,472}{45\,045}.
\end{gather*}
...
\includegraphics[height=5cm,valign=t]{Fig/434.pdf} \hspace{2mm}
\includegraphics[height=4.6cm,valign=t]{Fig/435.pdf}
\fuentepropia
\end{figure}
...
% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
NIntegrate[1,{y,0,2},{z,0,4-y^4/4},{x,(y^4-2*y^2)/4,y^2/2}]+
NIntegrate[1,{y,0,2},{z,4-y^4/4,4-(y^4-2*y^2)^2/16},
{x,(y^4-2*y^2)/4,Sqrt[4-z]}]+NIntegrate[1,{y,0,Sqrt[2]},
{z,4-(y^4-2*y^2)^2/16,4},{x,-Sqrt[4-z],Sqrt[4-z]}]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
\includegraphics[height=3.5cm]{Fig/436.pdf}
\fuentepropia
\end{figure}
...
Por lo tanto, un punto $Q$ sobre el cilindro es de la forma
...
El elemento diferencial de volumen $|{\bf r}_{t}\cdot ({\bf r}_{u}\times {\bf r}_{w})|$ es $\frac{t^2}{64}(t^2-4)^2( t^2u+2)$ $(t^2(( t^2-4) u+2))$,
término que integramos para conseguir el volumen del sólido
\[\int_{0}^{1}\int_{0}^{1}\int_{0}^2 |{\bf r}_{t}\cdot ({\bf r}_{u}\times {\bf r}_{w})| dtdudw= \frac{169\,472}{45\,045}.\]
%\end{tcolorbox}
...
\begin{figure}[H]
\centering
\caption{Visualización del sólido definido por $2x \leq x^2 + y^2 \leq 4x$ y $x^2 + z^2 \leq 16$}
\label{fig:solido_anillo_cilindro}
\includegraphics[height=3.5cm]{Img/83a.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Img/83b.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Img/83c.pdf}
\fuentepropia
\end{figure}
...
% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
Manipulate[ParametricPlot[{{Cos[t]*Cos[t],Cos[t]*Sin[t]},
{2*Cos[t]*Cos[t],2*Cos[t]*Sin[t]}},{t,-Pi/2,k},
PlotRange->{{0,2},{-2,2}}],{k,-Pi/2+Pi/40,Pi/2}]
...
RegionPlot3D[x^2+z^2<16&&x^2+y^2>2*x&&x^2+y^2<4*x&&0<x<4,
{x,0,4},{y,-2,2},{z,-4,4},Mesh->False]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
\includegraphics[height=4cm]{Fig/437.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Fig/438.pdf}
\fuentepropia
\end{figure}
...
\[\left( 4\cos (\theta) \cos (\theta) ,4\cos \left(\theta \right) \sin (\theta) \right) = (4 \cos^2 (\theta), 2\sin(2\theta)).\]
\textls[-15]{La combinación convexa $\left( 1-u\right)P +uQ$ se simplifica como} $(2( 1+u)\cos^2(\theta),$ $(1+u)\sin (2\theta))$, y parametriza la región acotada por estas dos curvas. Sobre el cilindro $x^2+z^2 = 16$ se satisface que $z = \pm 2\sqrt{4-(1+u) ^2\cos ^{4}(\theta) }$. Sobre el cilindro circular, consideremos dos puntos $P_1$ y $Q_1$.
...
\includegraphics[height=3.5cm]{Fig/439.pdf}
\fuentepropia
\end{figure}
...
\setlength{\abovedisplayshortskip}{0pt}
\begin{align*}
P_1&= \big(2(1+u) \cos^2(\theta),\left( 1+u\right) \sin \left( 2\theta \right) ,-2\sqrt{4-(1+u)^2\cos ^{4}(\theta) }\big) \\
Q_1&=\big(2(1+u) \cos ^2(\theta) ,\left( 1+u\right) \sin \left( 2\theta \right) ,2\sqrt{4-\left( 1+u\right) ^2\cos ^{4}(\theta) }\big);
\end{align*}
\endgroup

simplificando la expresión $\left(1-w\right)P_1+wQ_1 $ se obtiene la función
\begin{gather*}
...
\includegraphics[height=4cm]{Img/18d.pdf} \hspace{2mm}
\includegraphics[height=4cm]{Img/18c.pdf} \hspace{2mm}
\includegraphics[height=4cm]{Img/18e.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=3.5cm]{Img/18a.pdf} \hspace{5mm}
\includegraphics[height=3.5cm]{Img/18b.pdf}
\fuentepropia
\end{figure}
...
ContourStyle->{LightPurple,Orange,Blend[{Green,Orange,Red}]}]
...
% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
a=ContourPlot3D[{y^2+2*z^2==4,2*x==y^2,4*x==y^4-2*y^2},
{x,-0.5,2},{y,0,2},{z,-2,2},PlotPoints->60,Mesh->False,
ContourStyle->{Directive[LightPurple,Opacity[0.9]],
Directive[Orange,Opacity[0.75]],Directive[Blend[{Green,
Orange,Red}],Opacity[0.75]],Opacity[0.75]}];
b=ParametricPlot3D[{{2-t^2,Sqrt[4-2*t^2],t},{(t^2-1)*(t^2-2),
Sqrt[4-2*t^2],t}},{t,-Sqrt[2],Sqrt[2]},PlotPoints->80,
PlotStyle->{Directive[Blue,Thickness->0.012],
Directive[Red,Thickness->0.012]}];
Show[a,b]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
\includegraphics[height=3.5cm]{Fig/440.pdf} \hspace{5mm}
\includegraphics[height=3.5cm]{Fig/441.pdf}
\fuentepropia
\end{figure}
...
\begin{gather*}
\begin{aligned}
\bigintsss_{-\frac{1}{4}}^{0}\bigintsss_{\sqrt{1-\sqrt{1+4x}}}^{\sqrt{1+\sqrt{1+4x}}}\bigintsss_{-\sqrt{\frac{4-y^2}{2}}}^{\sqrt{\frac{4-y^2}{2}}}dzdydx+\bigintsss_{0}^2\bigintsss_{\sqrt{2x}}^{\sqrt{1+\sqrt{1+4x}}}\bigintsss_{-\sqrt{\frac{4-y^2}{2}}}^{\sqrt{\frac{4-y^2}{2}}}dzdydx\\
...
Por la simetría de la figura con respecto al plano $xy$, la segunda gráfica de la figura~\ref{fig:proyeccion_xzx} se ha dividido en seis regiones que corresponden, respectivamente, a las seis integrales que se enuncian; luego de plantearlas basta multiplicar por $2$.

\begin{figure}[H]
\centering
\caption{Proyección del sólido en el plano $xz$}
\label{fig:proyeccion_xzx}
\includegraphics[height=4cm]{Fig/442.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Fig/443.pdf}
\fuentepropia
\end{figure}

\textls[-15]{Las regiones se enumeran en el mismo orden en que se presentan las siguien\-tes integrales, para abreviar usaremos la notación} {\small $a= \sqrt{1-\sqrt{1+4x}}$} y {\small $b=\sqrt{1+\sqrt{1+4x}}$.}
\begin{gather*}
\bigintsss_{1}^{\sqrt{2}}\bigintsss_{(z^2-1)(z^2-2)}^{0} \bigintsss_{ a }^{\sqrt{4-2z^2}}dydxdz
...
\bigintsss_{0}^{1}\bigintsss_{(z^2-1)(z^2-2)}^{2-z^2} \bigintsss_{\sqrt{2x}}^{\sqrt{4-2z^2}}dydxdz
...
{y,Sqrt[1-Sqrt[1+4*x]],Sqrt[4-2*z^2]}]+NIntegrate[1,{z,1,Sqrt[3/2]},
{x,-1/4,(z^2-1)*(z^2-2)},{y,Sqrt[1-Sqrt[1+4*x]],
Sqrt[1+Sqrt[1+4*x]]}]+NIntegrate[1,{z,0,1},{x,-1/4,0},
{y,Sqrt[1-Sqrt[1+4*x]],Sqrt[1+Sqrt[1+4*x]]}]+
Integrate[1,{z,1,Sqrt[2]},{x,0,2-z^2},{y,Sqrt[2*x],
Sqrt[4-2*z^2]}]+NIntegrate[1,{z,0,1},{x,(z^2-1)*(z^2-2),2-z^2},
{y,Sqrt[2*x],Sqrt[4-2*z^2]}]+NIntegrate[1,{z,0,1},
{x,0,(2-z^2)(1-z^2)},{y,Sqrt[2*x],Sqrt[1+Sqrt[1+4*x]]}])
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
&+\bigintsss_{-\frac{1}{4}}^0 \bigintsss_{\frac{1}{2}\sqrt{6-2\sqrt{1+4x}}}^{\frac{1}{2}\sqrt{6+2\sqrt{1+4x}}}\bigintsss_{ a }^{\sqrt{4-2z^2}}dydzdx\notag\\
&+ \bigintsss_0^2 \bigintsss_{\frac{1}{2}\sqrt{6-2\sqrt{1+4x}}}^{\sqrt{2-x}}\bigintsss_{\sqrt{2x}}^{\sqrt{4-2z^2}}dydzdx\notag\\
&+ \bigintsss_{0}^2\bigintsss_{0}^{\frac{1}{2}\sqrt{6-2\sqrt{1+4x}}} \bigintsss_{\sqrt{2x}}^{b}dydzdx\Bigg) \approx \frac{\pi}{\sqrt{2}}\label{trescilindros1}
\end{align}
\endgroup
...
%\begin{tcolorbox}[title=\bfseries Parametrizando el sólido]
En el plano $xy$ las curvas que determinan la proyección del sólido se parametrizan como {\small $\overrightarrow{\alpha }(t)=\left\langle \frac{1}{4}\left(
...
Dos puntos sobre el cilindro $y^2+2z^2=4$ tienen las formas:
...
\begin{figure}[H]
\centering
\caption{Sólido definido por $4x^2 + z^2 \leq 4$ y $\dfrac{z - 3}{2} \leq y \leq \dfrac{5 - x - z}{3}$}
\label{fig:solido_cilindro_planos}
\includegraphics[height=4cm]{Img/55a.pdf} \hspace{2mm}
\includegraphics[height=4cm]{Img/55b.pdf} \hspace{2mm}
\includegraphics[height=4cm]{Img/55c.pdf}
\fuentepropia
\end{figure}
...
\textls[-20]{La proyección en el plano $xy$, se determina reemplazando $z$ en la ecuación del cilindro $4x^2+z^2=4$, por el respectivo término de $z$ en las ecuaciones de los planos, de tal manera que la expresión resultante solo dependa de~$x$~y~$y$.}

\begin{figure}[H]
\centering
\caption{Proyecciones del sólido en los planos $xy$ y $xz$}
\label{fig:proyeccion_xy_xz}
\includegraphics[height=4cm]{Fig/444.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Fig/445.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[width=\textwidth]{Fig/446.pdf}
\fuentepropia
\end{figure}
...
\textls[-22]{Por lo tanto, el volumen del sólido está determinado por:}
...
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
a=Sqrt[1-z^2/4];
NIntegrate[1,{y,-5/2,-1/2},{z,-2,3+2*y},{x,-a,a}]+
NIntegrate[1,{y,-1/2,(5-Sqrt[5])/3},{z,-2,2},{x,-a,a}]+
NIntegrate[1,{y,(5-Sqrt[5])/3,7/3},{z,-2,-12*y/5+4
2*Sqrt[30*y-20-9y^2]/5},{x,-a,a}]+NIntegrate[1,{y,(5-Sqrt[5])/3,1},
{z,-12*y/5+4+2*Sqrt[30*y-20-9y^2]/5,2},{x,-a,a}]+
NIntegrate[1,{y,(5-Sqrt[5])/3,(5+Sqrt[5])/3},
{z,-12*y/5+4-2*Sqrt[30*y-20-9y^2]/5,
...
$\overrightarrow{\alpha}$ y $\overrightarrow{\beta}$ se forma una combinación convexa que permite parametrizar el sólido. Es decir, al simplificar $(1-w)\overrightarrow{\alpha}(t,u)+w\overrightarrow{\beta}(t,u)$
se obtiene
\begin{multline*}
...
\begin{figure}[H]
\centering
\caption{Visualización tridimensional del sólido definido por $0 \leq y \leq z^2$ y $x^2 \leq z \leq x^2$}
\label{fig:solido_parametrico_xyz}
\includegraphics[height=3.5cm]{Fig/447.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Fig/448.pdf}
\fuentepropia
\end{figure}
...
\begin{figure}[H]
\centering
\caption{Proyecciones del sólido en los planos $xy$ y $yz$, definido por $x^6 \leq y \leq x^4$ y $0 \leq y \leq z^2$}
\label{fig:proyeccion_xy_yz}
\includegraphics[height=3.5cm]{Fig/449.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Fig/450.pdf}
\fuentepropia
\end{figure}
...
\begin{figure}[H]
\centering
\caption{Visualización del sólido definido por $0 \leq y \leq z^2$ y $x^3 \leq z \leq x^2$}
\label{fig:solido_xz_yz}
\includegraphics[height=3.5cm]{Fig/451.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Fig/452.pdf}
\fuentepropia
\end{figure}
...
Integrate[1,{y,0,1},{z,Sqrt[y],1},{x,Sqrt[z],z^(1/3)}]
...
\includegraphics[height=4cm]{Fig/9.pdf}
\fuentepropia
\end{figure}

El sólido se recorre completamente uniendo un punto del segmento $\overline{AB}$
con un punto del segmento $\overline{CD}$, esto se consigue simplificando
\[\left( 1-w\right) \langle(1-v)\sqrt{u}(1-v)+v\sqrt[3]{u},0,u\rangle +w\langle(1-v)\sqrt{u}+v\sqrt[3]{u},u^{2},u\rangle,\]
...
Además, $\left| {\bf r}_{u}\cdot \left( {\bf r}_{v}\times {\bf r}_{w}\right) \right| = \left| \left( -\sqrt{u}+\sqrt[3]{u}\right) u^{2}\right|$, por lo tanto, el volumen del sólido es:
\begin{align*}
...
\[M= \ds \int_{0}^{1}\int_{x^{3}}^{x^{2}}\int_{0}^{z^{2}}xy^{2}z^{3}dydzdx=
\ds \int_{0}^{1}\int_{\sqrt[2]{z}}^{\sqrt[3]{z}}\int_{0}^{z^{2}}xy^{2}z^{3}dydxdz= \frac{1}{2112}.\]
...
\textls[-27]{Los momentos con respecto a los planos coordenados están determinados por:}
\begin{align*}
\mu_{yz} &= \int_0^1\int_{x^3}^{x^2}\int_0^{z^2}x^2 y^2 z^3 dydzdx =\frac{1}{2277} \\
\mu_{xz} &= \int_0^1\int_{x^3}^{x^2}\int_0^{z^2}x y^3 z^3 dydzdx =\frac{1}{3952} \\
\mu_{xy} &= \int_0^1\int_{x^3}^{x^2}\int_0^{z^2}x y^2 z^4 dydzdx=\frac{1}{2520}.
\end{align*}
...
Consideremos el sólido acotado por dos cilindros de igual radio con ejes de simetría perpendicular. En particular, se puede suponer que poseen ecuaciones $x^{2}+z^{2}=r^{2}$ y $x^{2}+y^{2}=r^{2}$, con $r>0$.

\begin{figure}[H]
\centering
\caption{Sólido definido por $x^2 + z^2 \leq r^2$ y $x^2 + y^2 \leq r^2$}
\label{fig:bicilindro}
\includegraphics[height=3.5cm]{Img/51a.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Img/51c.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Img/51d.pdf}
\fuentepropia
\end{figure}

La figura~\ref{fig:bicilindro} se obtiene ejecutando las siguientes instrucciones, en ellas se consideró $r=1$.

% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
ContourPlot3D[{x^2+y^2==1,x^2+z^2==1},{x,-1,1},{y,-1,1},
{z,-1,1},Mesh->False,PlotPoints->70,
ContourStyle->{Blend[{Cyan,Yellow},1/5],Yellow}]
RegionPlot3D[-Sqrt[1-y^2]<z<Sqrt[1-y^2]&&-Sqrt[1-x^2]<
y<Sqrt[1-x^2]&&-1<x<1,{x,-1,1},{y,-1,1},{z,-1,1},
PlotStyle->RGBColor[0.8,0.3,0.3],PlotPoints->90,Mesh->False]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
\begin{figure}[H]
\centering
\caption{Proyecciones del sólido definido por $x^2 + y^2 \leq r^2$, \quad $|x| \leq 1$ y $|z| \leq 1$}
\label{fig:cilindro_recortado}
\includegraphics[height=4cm]{Fig/454.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Fig/455.pdf}
\fuentepropia
\end{figure}
...
{x,-Sqrt[r^2-y^2],Sqrt[r^2-y^2]},{z,-Sqrt[r^2-x^2],Sqrt[r^2-x^2]}]]
...
+Integrate[1,{z,0,r},{y,-r,-z},{x,-Sqrt[r^2-y^2],Sqrt[r^2-y^2]}]
+Integrate[1,{z,-r,0},{y,-r,z},{x,-Sqrt[r^2-y^2],Sqrt[r^2-y^2]}]]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
Por lo tanto, el sólido se parametriza mediante una combinación convexa de dos puntos de la forma \[P(u \cos (v),u \sin (v),-\sqrt{r^2-u^2 \cos ^2v})\]
y \[Q(u \cos (v),u \sin (v),\sqrt{r^2-u^2 \cos ^2v}),\]
esto es, $(1-w)P+wQ$.
...
Derivando parcialmente se obtienen los siguientes vectores:
\begin{align*}
{\boldsymbol \alpha}_u &= \langle \cos(v), \sin(v), \frac{u(1-2w)\cos^2(v)}{\sqrt{r^2-u^2 \cos^2(v)}} \rangle \displaybreak \\
...
\end{align*}
Entonces, $|{\boldsymbol \alpha}_w \cdot ({\boldsymbol \alpha}_u \times {\boldsymbol \alpha}_v)| = 2u\sqrt{r^2-u^2 \cos^2(v)}$, con lo cual el volumen del mencionado esta dado por:
...
% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
ContourPlot3D[{x^2+y^2==1,y^2+z^2==1,x^2+z^2==1},{x,-1,1},{y,-1,1},
{z,-1,1},Mesh->False,ContourStyle->{Blend[{Cyan,Yellow},2/5],
RGBColor[0.9,0.8,0.6],Orange}]
RegionPlot3D[-Sqrt[1-y^2]<z<Sqrt[1-y^2]&&-Sqrt[1-x^2]<y<Sqrt[1-x^2]
&&-1<x<1,{x,-1,1},{y,-1,1},{z,-1,1},
PlotStyle->RGBColor[0.8,0.3,0.3],PlotPoints->90,Mesh->False]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
\includegraphics[height=4cm]{Img/52a.pdf} \hspace{2mm}
\includegraphics[height=4cm]{Img/52b.pdf}
\fuentepropia
\end{figure}
...
\begin{figure}[H]
\centering
\caption{Región definida por $y^2 + z^2 \leq r^2$, \quad $x > 0$ y $y > 0$}
\label{fig:cuarto_disco_yz}
\includegraphics[height=3.5cm]{Fig/456.pdf}
\fuentepropia
\end{figure}
...
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]
\begin{Verbatim}[formatcom=\letraverbatim]
Assuming[r\[Element]Reals&&r>0,8*(Integrate[1,{x,0,r/Sqrt[2]},
{y,0,x},{z,0,Sqrt[r^2-x^2]}]+Integrate[1,{x,r/Sqrt[2],r},
{y,0,Sqrt[r^2-x^2]},{z,0,Sqrt[r^2-x^2]}]+Integrate[1,
{x,0,r/Sqrt[2]},{y,x,Sqrt[r^2x^2]},{z,0,Sqrt[r^2-y^2]}])]
Assuming[r\[Element]Reals&&r>0,8*(Integrate[1,{y,0,r/Sqrt[2]},
{x,y,Sqrt[r^2-y^2]},{z,0,Sqrt[r^2-x^2]}]+Integrate[1,
{y,0,r/Sqrt[2]},{x,0,y},{z,0,Sqrt[r^2-y^2]}]+Integrate[1,
{y,r/Sqrt[2],r},{x,0,Sqrt[r^2-y^2]},{z,0,Sqrt[r^2-y^2]}])]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
representan dos esferas que se intersecan en $z=0$. Consideraremos el sólido acotado por los hemisferios negativos en $z$.

\begin{figure}[H]
\centering
\caption{Región definida por $2\rho \cos \varphi + 4 \leq \rho^2 \leq 4$}
\label{fig:region_polar_desplazada}
\includegraphics[height=3cm]{Img/90b.pdf} \hspace{0.2cm}
\includegraphics[height=3cm]{Img/90a.pdf}
\fuentepropia
\end{figure}

Los gráficos de la figura~\ref{fig:region_polar_desplazada} se obtienen con las siguientes instrucciones:

% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
ContourPlot3D[{x^2+y^2+(z-1)^2==5,x^2+y^2+z^2==4},{x,-3,3},{y,-3,3},
{z,-3,4},Mesh->False,ContourStyle->{Directive[Cyan,Opacity[0.8]],
...
\includegraphics[height=3cm]{Fig/457.pdf}
\fuentepropia
\end{figure}
...
$a=\sqrt{5-x^{2}-(z-1)^{2}}$.
\begin{gather*}
\int_{-2}^{2}\int_{1-\sqrt{5-x^{2}}}^{0}\int_{-\sqrt{4-x^{2}-z^{2}}}^{-a}dydzdx \\
+\int_{-2}^{2}\int_{1-\sqrt{5-x^{2}}}^{0}\int_{a}^{\sqrt{4-x^{2}-z^{2}}}dydzdx \\
...
Integrate[r,{\[Theta],0,2Pi},{r,0,2},{z,-Sqrt[4-r^2],1-Sqrt[5-r^2]}]
NIntegrate[2,{x,-2,2},{z,1-Sqrt[5-x^2],0},{y,-Sqrt[4-x^2-z^2],
-Sqrt[5-x^2-(z-1)^2]}]+NIntegrate[2,{x,-2,2},{z,1-Sqrt[5-x^2],0},
{y,Sqrt[5-x^2-(z-1)^2],Sqrt[4-x^2-z^2]}]+NIntegrate[1,{x,-2,2},
{z,-Sqrt[4-x^2],1-Sqrt[5-x^2]},{y,-Sqrt[4-x^2-z^2],Sqrt[4-x^2-z^2]}]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
Integrate[\[Rho]^2*Sin[\[Phi]],{\[Phi],Pi/2,Pi},{\[Theta],0,2*Pi},
{\[Rho],Cos[\[Phi]]+Sqrt[4+Cos[\[Phi]]^2],2}]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
\begin{align*}
{\bf r}_{u} &= \left\langle \cos v,\sin v,\frac{\left( 1-w\right) u}{\sqrt{4-u^{2}}}+\frac{uw}{\sqrt{5-u^{2}}} \right\rangle \\
{\bf r}_{v} &= \left( -u\sin v,u\cos v,0\right) \\
{\bf r}_{w} &= \left( 0,0,\sqrt{4-u^{2}}-\sqrt{5-u^{2}}+1\right) \\
\left\vert {\bf r}_{u}\cdot \left({\bf r}_{w}\times {\bf r}_{v}\right) \right\vert
&= \left|u\left( \sqrt{5-u^{2}}-\sqrt{4-u^{2}}-1\right) \right |
\end{align*}
Entonces el volumen del sólido está dado por:
...
\index{Cilindro cardióidico}
\subsection{Cilindros cardióidicos y el plano z=2-x/2}

En el plano, las ecuaciones $r = 1-\cos(t)$ y $r = 2- 2\cos(t)$ representan dos cardioides, mientras que en el espacio las mismas ecuaciones representan dos cilindros cardióidicos.

\begin{figure}[H]
\centering
\caption{Región delimitada por $r = 1 - \cos(t)$, $r = 2 - 2\cos(t)$ y $z = 2 - \frac{x}{2}$}
\label{fig:cardioide_revolucion}
\includegraphics[height=3cm,valign=m]{Fig/458.pdf} \hspace{2mm}
\includegraphics[height=3.3cm,valign=m]{Img/36a.pdf}
\fuentepropia
\end{figure}
...
\begin{figure}[H]
\centering
\caption{Sólido definido por $1 - \cos(t) \leq r \leq 2 - 2\cos(t)$ y $0 \leq z \leq 2 - \frac{x}{2}$}
\label{fig:cardioide_z_inclinado}
\includegraphics[height=3.5cm]{Img/36c.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Img/36d.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Img/36e.pdf}
\fuentepropia
\end{figure}
...
% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
Manipulate[ParametricPlot[{{(1-Cos[t])*Cos[t],(1-Cos[t])*Sin[t]},
{2*(1-Cos[t])*Cos[t],2*(1-Cos[t])*Sin[t]}},{t,0,k},
PlotRange->{{-4,1},{-3,3}}],{k,Pi/20,2*Pi}]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
\begin{SaveVerbatim}{apretar_4}
a=ParametricPlot3D[{{(1-Cos[t])*Cos[t],(1-Cos[t])*Sin[t],u},
{(2-2*Cos[t])*Cos[t],(2-2*Cos[t])*Sin[t],u}},{u,0,4},{t,0,2*Pi},
Mesh->False,PlotPoints->80,PlotStyle->{Orange,RGBColor[0.7,0.1,0.1]}];
b=ContourPlot3D[{z==2-x/2},{x,-5,5},{y,-5,5},{z,-2,4},Mesh->False,
ContourStyle->RGBColor[0.2,0.4,0.3]];
\end{SaveVerbatim}

% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]
  \textls[-20]{\UseVerbatim[formatcom=\letraverbatim]{apretar_4}}
\end{tcolorbox}
% tex-fmt: on

Además, la parte del plano que se halla entre los dos cilindros cardióidicos se consigue con estas sentencias:
...
\textls[-10]{En el plano $xy$, los cilindros cardióidicos se pueden parametrizar, haciendo $x = (1 -\cos(t))\cos(t)$, $y = (1 - \cos(t)) \sin(t),\,t \in[0, 2\pi];$ esto para el cilindro menor. Mientras que $x = (2 - 2\cos(t))\cos(t)$, $y = (2 - 2\cos(t))\sin(t)$ se usarán para el cilindro mayor. Lo anterior nos permite definir las funciones vectoriales que representan las curvas de intersección de los cilindros con el plano $xy$ ($z = 0$), que son:}
\begin{eqnarray*}
...
\includegraphics[height=3cm]{Fig/459.pdf} \hspace{5mm}
\includegraphics[height=3cm]{Fig/460.pdf}
\fuentepropia
\end{figure}
...
\begin{gather*}
\mathbf{r}_{t} = (1+u)\left\langle \sin (2 t)-\sin (t),2\sin^2\left(\tfrac{t}{2}\right) (2\cos(t)+1),\frac{1}{2} w (\sin (t)-\sin (2 t)) \right\rangle,\\
...
\begin{gather*}
\left| {\bf r}_{t}\cdot \left( {\bf r}_{u}\times {\bf r}_{w}\right) \right| =
\left|(u+1) \sin^4\left(\frac{t}{2}\right) \left(\left(u+1\right)\left(\cos (2 t)-2 \cos (t)\right)+u+9\right)\right|.
\end{gather*}
...
\subsection{Cilindros cardióidicos y el plano \texorpdfstring{\boldmath{$\mathsf{z=2-y/2}$}}{z=2-y/2}}
...
\begin{figure}[H]
\centering
\caption[Región delimitada por $r = 1 - \cos(t)$, $r = 2 - 2\cos(t)$, y $z = 2 - \frac{y}{2}$]{Región delimitada por $r = 1 - \cos(t)$,\\ $r = 2 - 2\cos(t)$, y $z = 2 - \frac{y}{2}$}
\label{fig:cardioide_y_inclinado}
\includegraphics[height=3.5cm]{Fig/461.pdf} \hspace{5mm}
\includegraphics[height=3.5cm]{Img/35e.pdf}
\fuentepropia
\end{figure}
...
\begin{figure}[H]
\centering
\caption{Sólido definido por $1 - \cos(t) \leq r \leq 2 - 2\cos(t)$ y~$0 \leq z \leq 2 - \frac{y}{2}$}
\label{fig:cardioide_y_inclinado_2}
\includegraphics[height=3.5cm]{Img/35a.pdf}\hspace{2mm}
\includegraphics[height=3.5cm]{Img/35b.pdf}\hspace{2mm}
\includegraphics[height=3.5cm]{Img/35c.pdf}
\fuentepropia
\end{figure}
...
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
a=ParametricPlot3D[{{(1-Cos[t])*Cos[t],(1-Cos[t])*Sin[t],u},
{(2-2*Cos[t])*Cos[t],(2-2*Cos[t])*Sin[t],u}},{u,0,3.5},
{t,0,2*Pi},PlotStyle->{Orange,RGBColor[0.7,0.1,0.1]},
Mesh->False,PlotPoints->80];
b=ContourPlot3D[{z==2-y/2},{x,-5,2},{y,-4,4},{z,-2,3.5},
...
& \hspace{10em} \frac{1}{2}(u+1)\sin(t)(\cos(t)-1)+2 \big \rangle \label{626x}
\end{align}
...
\includegraphics[height=3.5cm]{Img/35d.pdf} \hspace{5mm}
\includegraphics[height=3.5cm]{Fig/462.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=3.5cm]{Fig/463.pdf} \hspace{5mm}
\includegraphics[height=3.5cm]{Fig/464.pdf}
\fuentepropia
\end{figure}
...
&\qquad 2\sin^2\left(\frac{t}{2}\right)(2\cos (t)+1), w \sin ^2\left(\frac{t}{2}\right) (2 \cos (t)+1) \Big \rangle \displaybreak \\
...
\subsection{Dos cilindros cardióidicos y un paraboloide}
...
\includegraphics[height=3.5cm]{Img/37a.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Img/37b.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Img/37c.pdf}
\fuentepropia
\end{figure}
...
Mesh->False,PlotPoints->80];
b=ContourPlot3D[{4*z==x^2+y^2},{x,-4,4},{y,-4,4},{z,0,4},
ContourStyle->RGBColor[0.4,0.5,0.3],Mesh->False];
Show[b,a]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
\begin{figure}[H]
\centering
\caption{Sólido definido por $1 - \cos(t) \leq r \leq 2 - 2\cos(t)$ y $0 \leq 4z \leq r^2$}
\label{fig:cardioide_paraboloide}
\includegraphics[height=3.5cm]{Img/37d.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Img/37f.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Img/37e.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=4cm]{Fig/465.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Fig/466.pdf}
\fuentepropia
\end{figure}
...
\begin{figure}[H]
\centering
\caption{Sólido definido por $r = 2 - 2\cos(t)$ y $z = 1 - \frac{y}{3}$}
\label{fig:cardioide_plano_inclinado}
\includegraphics[height=3.5cm]{Img/38a.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Img/38b.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Img/38c.pdf}
\fuentepropia
\end{figure}
...
% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
a=ParametricPlot3D[{(2-2*Cos[t])*Cos[t],(2-2*Cos[t])*Sin[t],u},
{u,0,2},{t,0,2*Pi},Mesh->False,PlotStyle->Orange,PlotPoints->90];
b=ContourPlot3D[z==1-y/3,{x,-4,2},{y,-3,3},{z,0,2},Mesh->False,
ContourStyle->RGBColor[0.4,0.5,0.3],PlotPoints->80];
Show[b,a]
{r,t}={Sqrt[x^2+y^2],ArcTan[x,y]};
...
\begin{figure}[H]
\centering
\caption{Sólido definido por $0 \leq r \leq 2(1 - \cos t)$ y $0 \leq 3z \leq 3 - y$}
\label{fig:cardioide_plano_inclinado_final}
\includegraphics[height=4cm]{Fig/467.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Fig/468.pdf}
\fuentepropia
\end{figure}
...
\begin{gather*}
\begin{aligned}
{\bf r}_t &= \Big \langle 2u\sin(t)(2\cos(t)-1), 4u\sin^2\left(\frac{t}{2}\right)(2\cos(t)+1), \frac{2}{3}u(w-1)(\cos(t)-\cos(2t)) \Big \rangle,\\
{\bf r}_{u} &= \Big\langle 2(1-\cos(t))\cos(t), 2\sin(t)(1-\cos(t)), \frac{1}{3}(1-w)(\sin(2t)-2\sin(t)) \Big\rangle \quad \text{y}\\
{\bf r}_{w} &= \Big\langle 0,0,\frac{1}{3}(2u\sin(t)-2u\sin(t)\cos(t)-3) \Big\rangle.
\end{aligned}
\end{gather*}

\textls[-20]{Esto implica que $| {\bf r}_t \cdot ( {\bf r}_{u}\times {\bf r}_{w}) | =| \frac{16}{3}u\sin^4\left(\frac{t}{2}\right)(3-2u\sin(t)+u\sin(2t)) |$.}
Por lo tanto, el volumen del sólido está dado por:
\begin{gather*}
\int_{0}^{1}\int_{0}^{1}\int_{0}^{2\pi }\left( \frac{4}{3}u\left( \cos (t) -1\right) ^{2}\left( 2u\sin (t) \left( \cos (t) -1\right) +3\right)\right) dtdudw= 6\pi.
\end{gather*}
...
$r=1-\cos (t)$. Esta región se presenta en la sección \secref{cilcardiopar} del capítulo~\ref{superficiesysuscurvas}.
...
\begin{figure}[H]
\centering
\caption{Sólido definido por $r = 1 - \cos t$ y $3z = 4 - 4x - x^2 - 2y - y^2$}
\label{fig:cardioide_superficie_parabolica}
\includegraphics[height=3.5cm]{Img/58a.pdf}\hspace{5mm}
\includegraphics[height=3.5cm]{Img/58b.pdf}
\fuentepropia
\end{figure}
...
\begin{gather*}
\frac{1}{6}\Big( (4u-u^2)\cos(2t) + (4u^2-8u)\cos(t)-4u\sin(t)+2u\sin(2t)-3u^2+4u+8 \Big).
\end{gather*}
...
\includegraphics[height=4cm]{Fig/469.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Fig/470.pdf}
\fuentepropia
\end{figure}
...
{z,0,4/3-4/3*r*Cos[\[Theta]]-r^2/3-2/3*r*Sin[\[Theta]]}]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
Las superficies definidas por las ecuaciones $z=x^{2}+y^{2}$ y $z=e^{1-x^{2}-y^{2}}$ acotan el sólido que se muestra a continuación:

\begin{figure}[H]
\centering
\caption{Sólido definido por $x^{2}+y^{2} \leq z \leq e^{1-x^{2}-y^{2}}$}
\label{fig:paraboloide_exponencial}
\includegraphics[height=3.3cm]{Img/54a.pdf} \hspace{2mm}
\includegraphics[height=3.3cm]{Img/54b.pdf} \hspace{2mm}
\includegraphics[height=3.3cm]{Img/54c.pdf}
\fuentepropia
\end{figure}

La figura~\ref{fig:paraboloide_exponencial} se obtiene por medio de las siguientes instrucciones:

% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
RegionPlot3D[x^2+y^2<z<Exp[1-x^2-y^2]&&-Sqrt[1-x^2]<y<Sqrt[1-x^2]
&&-1<x<1,{x,-1,1},{y,-1,1},{z,0,3},PlotPoints->90,
PlotStyle->{Blend[{Orange,Red},1/4]},Mesh->False]
...
\includegraphics[height=3cm]{Fig/471.pdf} \hspace{5mm}
\includegraphics[height=3cm]{Fig/472.pdf}
\fuentepropia
\end{figure}

Ahora presentamos las integrales que se requieren evaluar para hallar el volumen del sólido mencionado.
\begin{gather*}
...
\end{gather*}
Al despejar $y$, de las expresiones que determinan las superficies e integrar primero con respecto a $y$, se obtiene por un lado que $y=\pm \sqrt{1-x^{2}-\ln z}$ y $y=\pm \sqrt{z-x^{2}}$, por el otro. Entonces, el volumen está dado por:
\begin{gather*}
...
{z,x^2+y^2,Exp[1-x^2-y^2]}]
Integrate[1,{z,0,1},{x,-Sqrt[z],Sqrt[z]},
{y,-Sqrt[z-x^2],Sqrt[z-x^2]}]+Integrate[1,{z,1,Exp[1]},
{x,-Sqrt[1-Log[z]],Sqrt[1-Log[z]]},
...
Integrate[r,{\[Theta],0,2*Pi},{r,0,1},{z,r^2,Exp[1-r^2]}]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
\begin{figure}[H]
\centering
\caption{Sólido definido por $1 \leq y^2 + z^2 \leq 9 - x^2$ y $z \geq 0$}
\label{fig:cilindro_parabolico_superior}
\includegraphics[height=4cm]{Img/56c.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Img/56d.pdf}
\fuentepropia
\end{figure}

\textls[-20]{Las siguientes instrucciones permiten obtener el gráfico del sólido (figura~\ref{fig:cilindro_parabolico_superior}).}

% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
RegionPlot3D[x^2+y^2+z^2<9&&y^2+z^2>1&&-3<z<0,{x,-3,3},{y,-3,3},
{z,-3,2},PlotPoints->90,Mesh->False,PlotStyle->Orange,
Ticks->{{-4,-2,0,2,4},{-3,-1,1,3},{-2,0,2}},AxesLabel->{x,y,z}]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on

Con el fin de plantear las integrales que determinan el volumen del sólido, se presenta la figura~\ref{figsemicirc}.

\begin{figure}[H]
\centering
\caption{Proyección del sólido en los planos coordenados}
\label{figsemicirc}
\includegraphics[height=3cm]{Fig/473.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Fig/474.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Fig/475.pdf}
\fuentepropia
\end{figure}
...
\shoveright{+\int_{1}^{3}\int_{-\sqrt{9-y^2 }}^{0}\int_{-\sqrt{9-y^2 -z^2 }}^{\sqrt{9-y^2 -z^2 }}dxdzdy = \frac{32}{3}\sqrt{2}\pi}\\[1em]
...
\shoveright{+\int_{-3}^{-1}\int_{-\sqrt{9-z^{2}}}^{\sqrt{9-z^{2}}}\int_{-\sqrt{9-x^{2}-z^{2}}}^{\sqrt{9-x^{2}-z^{2}}}dydxdz = \frac{32}{3}\sqrt{2}\pi}\\[1em]
...
\int_{1}^{3}\int_{-\sqrt{9-y^2}}^{\sqrt{9-y^2}}\int_{-\sqrt{9-x^2 -y^2 }}^{0}dzdxdy+\int_{-3}^{-1}\int_{-\sqrt{9-y^2 }}^{\sqrt{9-y^2 }}\int_{-\sqrt{9-x^2 -y^2 }}^{0}dzdxdy\\
 \shoveright{+\int_{-1}^{1}\int_{-\sqrt{8}}^{\sqrt{8}}\int_{-\sqrt{9-x^2 -y^2 }}^{-\sqrt{1-y^2 }}dzdxdy= \frac{32}{3}\sqrt{2}\pi}\\[1em]
...
Al hacer un cambio a coordenadas cilíndricas $y = r\cos \theta$, $z = r\sin \theta$, el volumen está dado por:
...
\begin{SaveVerbatim}{apretar_5}
Integrate[r,{t,Pi,2*Pi},{r,1,3},{x,-Sqrt[9-r^2],Sqrt[9-r^2]}]
Integrate[1,{y,-3,-1},{z,-Sqrt[9-y^2],0},{x,-Sqrt[9-y^2-z^2],
Sqrt[9-y^2-z^2]}]+Integrate[1,{y,-1,1},{z,-Sqrt[9-y^2],-Sqrt[1-y^2]},
{x,Sqrt[9-y^2-z^2],Sqrt[9-y^2-z^2]}]+Integrate[1,{y,1,3},
{z,-Sqrt[9-y^2],0},{x,-Sqrt[9-y^2-z^2],Sqrt[9-y^2-z^2]}]
Integrate[1,{z,-1,0},{x,-Sqrt[8],Sqrt[8]},{y,-Sqrt[9-x^2-z^2],
-Sqrt[1-z^2]}]+Integrate[1,{z,-1,0},{x,-Sqrt[8],Sqrt[8]},
{y,Sqrt[1-z^2],Sqrt[9-x^2-z^2]}]+Integrate[1,{z,-3,-1},
{x,Sqrt[9-z^2],Sqrt[9-z^2]},{y,-Sqrt[9-x^2-z^2],Sqrt[9-x^2-z^2]}]
...
% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]
\textls[-20]{\UseVerbatim[formatcom=\letraverbatim]{apretar_5}}
\end{tcolorbox}
% tex-fmt: on
...
\textls[-10]{Consideremos la proyección del sólido en el plano $yz$ (ver la figura \ref{figsemicirc}). Un punto sobre la semicircunferencia de radio $1$ posee coordenadas $(\cos(t),$ $\sin(t))$ y un punto sobre la semicircunferencia de radio $3$, es de la forma $(3\cos(t),$ $3\sin(t))$, con $t \in [\pi,2\pi]$. Por lo tanto, una combinación convexa de estos dos puntos parametriza la región en mención: $(1-u)$ $(\cos(t),$ $\sin(t))+u(3\cos(t),$ $3\sin(t))$, que se simplifica como $((1+2u)\cos(t),(1+2u)\sin(t))$.}

Sobre el sólido, $x$ recorre los puntos que van desde la parte negativa de la esfera hasta su parte positiva. Dos puntos arbitrarios
...
al integrarlo con los límites definidos, nos lleva al volumen del sólido
\[\int_{0}^{1}\int_{0}^{1}\int_{\pi}^{2\pi}8(1+2u)\sqrt{(u+2)(1-u)}\,dtdudw=\frac{32}{3}\sqrt{2}\pi.\]

\subsection{Sólidos cardióidicos}\index{Cardioide}\index{Sólidos!cardióidicos}
...
\subsection{Toro cardióidico generado por \texorpdfstring{\boldmath{$\protect\mathsf{r=1-\sin t}$}}{r=1-sin t}}\index{Toro cardióidico!volumen}
...
El volumen del sólido generado cuando la curva parametrizada en la forma $\langle x(t),y(t)\rangle$, con $t \in [a,b]$, gira alrededor del eje $y$,
está dado por $\pi \int_{a}^{b}\left( x(t)\right) ^{2}y^{\prime }(t)dt$.
El volumen está dado por $\pi \int_{a}^{b}\left( y(t)\right) ^{2}x^{\prime }(t)dt$, si el giro se hace alrededor del eje $x$. En el caso de la cardioide $r=1-\sin \theta$ que se desplazada tres unidades sobre el eje polar, esta curva se puede parametrizar como $x(t)=3+\left( 1-\sin (t) \right) \cos (t)$, $y(t)=\left( 1-\sin (t) \right) \sin (t) $, $0\leq t \leq 2\pi$. Entonces el volumen $V$ del sólido que se obtiene al girar la cardioide sobre la recta $\theta = \pi/2$ está dado por:
\begin{gather*}
V=\pi \int_{0}^{2\pi }\left( 3+\left( 1-\sin (t) \right) \cos(t) \right) ^{2}(\cos t-2\cos t\sin t)dt= 9\pi ^{2}.
\end{gather*}

\begin{figure}[H]
\centering
\caption{Toro cardióidico generado por $r = 1 - \sin \theta$}
\label{fig:toro_cardióidico}
\includegraphics[height=3cm]{Img/63d.pdf} \hspace{5mm}
\includegraphics[height=3cm]{Img/63e.pdf}
\fuentepropia
\end{figure}
...
\textls[-20]{El volumen de este sólido, usando el teorema de Pappus, es $2\pi \left( \frac{3}{2}\pi \right) \left( 3\right) = 9\pi ^{2}$.}\index{Teorema de Pappus!volumen}
...
{\bf r}_{v} = (3+u(1-\sin t) \cos t) \langle - \sin v,\cos t) \cos v,0\rangle, \\
{\bf r}_{t} = \bigg \langle -u( \cos \left( 2t\right) +\sin t) \cos v,-u\left( \cos \left( 2t\right) +\sin t\right) \sin v, u\left( 1-2\sin t\right) \cos t \bigg \rangle.
\end{gather*}

Con ellos, se obtiene el elemento diferencial de volumen
\begin{gather*}
|{\bf r}_{t}\cdot \left( {\bf r}_{u}\times {\bf r}_{v}\right)| = |u\left( 6-3\cos ^{2}t+u\left(\sin t-3\right) \cos ^{3}t+4u(1-\sin t)\cos t-6\sin t\right)|,
\end{gather*}
cuya integración nos proporciona el volumen del sólido
...
\textls[-10]{Consideraremos la cardioide con ecuación $r=1-\cos(t)$, $0\leq t \leq 2\pi$. En el plano polar, si esta curva se desplaza tres unidades sobre el eje polar, y luego rota alrededor de una recta paralela a $\theta=\pi/2$, se obtiene el sólido~$E$.}

\begin{figure}[H]
\centering
\caption{Toro cardióidico generado por $r = 1 - \cos \theta$}
\label{fig:toro_cardióidico_cos}
\includegraphics[height=3cm]{Img/59f.pdf} \hspace{5mm}
\includegraphics[height=3cm]{Img/59e.pdf}
\fuentepropia
\end{figure}
...
De acuerdo con el teorema de Pappus, el volumen del toro cardióidico generado por
$r=1-\cos t$ es:
...
${\bf r}_1(t,u)$ $=\langle 3+u(1-\cos (t)) \cos (t),u(1-\cos (t)) \sin (t) \rangle $, con $t\in [0,2\pi ],\,\, u\in [0,1]$. Si esta región gira sobre la recta $x=3$, se genera un toro cardióidico; cualquier punto sobre este sólido tiene la forma determinada por la siguiente función:
\begin{multline*}
...
\textls[-10]{En \verb"Mathematica" se pueden efectuar estos cálculos ejecutando las siguientes instrucciones:}
...
\includegraphics[height=4cm]{Img/65a.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Img/65b.pdf}
\fuentepropia
\end{figure}
...
R=(1-v)*{x,y,0}+v*{x,y,z};
ParametricPlot3D[{x,y,z},{t,0,2*Pi},{u,0,1},Ticks->{{-2,-1,0},
{-1,0,1},{0,2}},MeshStyle->Gray,PlotPoints->80,PlotStyle->Orange,
PlotRange->{{-2,1/2},{-3/2,3/2},{0,2}}]
A=Simplify[Abs[Dot[D[R,t],Cross[D[R,u],D[R,v]]]]];
Integrate[A,{t,0,2*Pi},{u,0,1},{v,0,1}]
Clear[r,z,t]
Integrate[r,{t,0,2*Pi},{r,0,1-Cos[t]},{z,0,r^2-(r^2+r*Cos[t])^2}]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on

\subsection{Un cardioide revolucionado} \index{Cardioide}
...
\label{fig:toro_cardióidico_E}
\includegraphics[height=4cm]{Img/66b.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Img/66a.pdf}
\fuentepropia
\end{figure}
...
en donde $t\in [0,\pi]$ y $u\in [0,1]$. Si esta región gira sobre el eje polar, agregando $\cos(v)$ y $\sin(v)$ a $y$, con $v \in [0,2\pi]$, se obtiene una parametrización de $E$, esto es:
\[{\bf r}(t,u,v)=u(1-\cos (t))\left\langle \cos (t) ,\sin (t) \cos (v) ,\sin(t) \sin (v) \right \rangle.\]

El producto vectorial triple es $\left| {\bf r}_{t}\cdot \left( {\bf r}_{u}\times {\bf r}_{v}\right) \right| = \left| 8 u^2 \sin ^6\left(\frac{t}{2}\right) \sin (t)\right| $.
...
\includegraphics[height=3.5cm]{Imgn/T_20a.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Imgn/T_20b.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Imgn/T_20c.pdf}
\fuentepropia
\end{figure}
...
\item El sólido acotado por las superficies de los paraboloides con ecuaciones $2z=6-2x^2-y^2$ y $z+3=x^2+y^2$ se muestra a continuación.\label{ejercicio2paraboloides}

\begin{figure}[H]
\centering
\caption{$2x^2+2y^2-6\leq 2z\leq 6-2x^2-y^2$}
\includegraphics[height=4cm]{Imgn/T_8a.pdf} \hspace{5mm}
\includegraphics[height=4.5cm]{Imgn/T_8e.pdf}
\fuentepropia
\end{figure}
...
% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
RegionPlot3D[z<(6-2*x^2-y^2)/2&&z>x^2+y^2-3,{x,-2,2},{y,-2,2},
...
$xy$, a una elipse alargada en sentido de las $y$ centrada en el origen. Por lo tanto, el volumen del sólido está dado por:
...
\end{align*}
El elemento diferencial de volumen es $\left\vert {\bf r}_{w}\cdot \left({\bf r}_{\theta}\times {\bf r}_{u}\right) \right\vert= 12\sqrt{3}u\left( 1-u^{2}\right) $, cuya integración con los límites establecidos nos proporciona el volumen del sólido
\[\int_{0}^{1}\int_{0}^{1}\int_{0}^{2\pi }12\sqrt{3}u\left( 1-u^{2}\right) d\theta dudw= 6\sqrt{3}\pi.\]
...
\includegraphics[height=3.8cm]{Imgn/T_7a} \hspace{2mm}
\includegraphics[height=3.8cm]{Imgn/T_7b.pdf} \hspace{2mm}
\includegraphics[height=3.8cm]{Imgn/T_7c.pdf}
\fuentepropia
\end{figure}

\textls[-25]{Esta figura y su proyección en el plano $xy$ se obtienen con estas instrucciones:}

% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
PolarPlot[{1+Cos[t],2+Cos[t]},{t,0,2Pi}]
RegionPlot3D[x^2+y^2+z^2<9&&(x^2+y^2-x)^2>x^2+y^2&&
(x^2+y^2-x)^2<3*(x^2+y^2),{x,-1.2,3.2},{y,-2.5,2.5},{z,-3,3},
PlotPoints->90,Mesh->False]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
\includegraphics[height=4cm]{Imgn/T_600.pdf}
\fuentepropia
\end{figure}
...
(1+Cos[t])*Sin[t]}+u*{(2+Cos[t])*Cos[t],(2+Cos[t])*Sin[t]}];
w=(1-v)*{x,y,-Sqrt[9-x^2-y^2]}+v*{x,y,Sqrt[9-x^2-y^2]};
...
\includegraphics[height=4cm]{Imgn/T_9a.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Imgn/T_9d.pdf}
\fuentepropia
\end{figure}
...
En el plano $xy$ la proyección del cilindro y su interior se parametriza como $x=2u\cos \theta$, $y=2u\sin \theta $ con $u \in [0,1]$ y $\theta \in [0,2\pi];$ sobre la esfera, la expresión correspondiente es:
...
El elemento diferencial de volumen es:
\begin{gather*}
\left\vert {\bf r}_{w}\cdot \left({\bf r}_{u}\times {\bf r}_{\theta }\right) \right\vert =8u\sqrt{9-4u^{2}},
\end{gather*}
%
...
\includegraphics[height=4cm]{Imgn/T_12a} \hspace{5mm}
\includegraphics[height=4cm]{Imgn/T_12b}
\fuentepropia
\end{figure}
...
{x,-1/2,2},{y,-3/2,3/2},{z,-3,3},Mesh->False,PlotPoints->80]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
\item La figura~\ref{ejercicio4a} muestra el sólido acotado por el paraboloide $x^2+y^2=3-z$ y el paraboloide hiperbólico $x^2-y^2=3z+6$.\label{ej:ejercicio6hiperbolico}

\begin{figure}[H]
\centering
\caption{$x^2+y^2\geq 3-z$ \& $x^2-y^2\leq 3z+6$}
\label{ejercicio4a}
\includegraphics[height=4cm]{Imgn/T_10a.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Imgn/T_10b.pdf}
\fuentepropia
\end{figure}
...
La intersección de estas dos superficies se obtiene al igualar las expresiones para $z$, esto es:
\[3-x^{2}-y^{2}=\frac{x^{2}-y^{2}-6}{3},\]
la cual se simplifica como $4x^2+2y^2=15$. Esta ecuación corresponde a una elipse en el plano $xy$ centrada en el origen y alargada en sentido de las $y$. Por lo tanto, el volumen del sólido está dado por:
...
\item \textls[-15]{El sólido cuya región descrita en coordenadas esféricas comprende los puntos que satisfacen la expresión $\rho \leq 1+\cos \phi$ se presenta a continuación:}

\begin{figure}[H]
\centering
\caption{Cardioide de revolución}
\includegraphics[height=4cm]{Imgn/T_13a.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Imgn/T_13d.pdf}
\fuentepropia
\end{figure}
...
Además, ${\bf r}_{u}\times {\bf r}_{\phi }= \left\langle  -u\left( \cos \phi +1\right) ^2 \sin \theta ,u\left( \cos \phi +1\right) ^2 \cos \theta ,0 \right\rangle$.
El elemento diferencial de volumen es $\left\vert {\bf r}_{\theta }\cdot \left({\bf r}_{u}\times {\bf r}_{\phi }\right) \right\vert =u^{2}\left( \cos \phi +1\right) ^{3}\sin \phi$; con lo anterior, se plantea la integral que determina el volumen del sólido
\[\int_{0}^{1}\int_{0}^{2\pi }\int_{0}^{\pi }u^{2}\left( \cos \phi +1\right) ^{3}\sin \phi d\phi d\theta du= \frac{8}{3}\pi.\]

\item El sólido acotado por la superficie del semicono $y=\sqrt{x^2+z^2}$ y la esfera $x^2+y^2+z^2=9$ se muestran enseguida. \label{ejercicio7a}

\begin{figure}[H]
  \centering
  \caption{$\sqrt{x^2+z^2}\leq y$ \& $x^2+y^2+z^2\leq 9$}
  \includegraphics[height=4cm]{Imgn/T_14a.pdf} \hspace{5mm}
  \includegraphics[height=4cm]{Imgn/T_14b.pdf}
  \fuentepropia
\end{figure}
...
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]
\begin{Verbatim}[formatcom=\letraverbatim]
RegionPlot3D[y>Sqrt[x^2+z^2]&&x^2+y^2+z^2<9,{x,-2.5,2.5},{y,0,3.2},
{z,-2.5,2.5},PlotPoints->90,Mesh->False,BoxRatios->{1,1,1}]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on

La intersección de las dos superficies está dada por la expresión $x^{2}+z^{2}=\frac{9}{2}$. Además, sobre el sólido $y$ recorre los puntos que van desde el semicono hasta la esfera. Por lo tanto, el volumen se determina evaluando la siguiente integral:
...
También se puede calcular el volumen considerando un punto sobre el cono $P\left(u\cos v,u,u\sin v\right)$ y otro punto $Q\left( u\cos v,\sqrt{9-u^{2}},u\sin v\right)$ sobre la esfera. De esta manera, se forma una combinación convexa entre estos puntos y se parametriza el sólido. Esto es:
\begin{align*}
  {\bf r}(u,v,w) &=(1-w) P +wQ  = \left\langle u\cos v,u+w\sqrt{9-u^{2}}-uw,u\sin v\right\rangle,
\end{align*}

con $u\in \lbrack 0,\frac{3}{\sqrt{2}}]$, $v\in \lbrack 0,2\pi ]$ y $w\in \lbrack 0,1]$. De esta función se obtienen los siguientes vectores:
\begin{align*}
...
El elemento diferencial de volumen es:
\[\left\vert {\bf r}_{u}\cdot \left({\bf r}_{v}\times {\bf r}_{w}\right)\right\vert=\left\vert u^{2}-u\sqrt{9-u^{2}}\right\vert.\]

Con lo anterior, el volumen está dado por:
\[\int_{0}^{1}\int_{0}^{2\pi }\int_{0}^{\frac{3}{\sqrt{2}}}\left\vert u^{2}-u \sqrt{9-u^{2}}\right\vert dudvdw= 9\pi \left( 2-\sqrt{2}\right).\]
...
\includegraphics[height=4cm]{Imgn/T_11a.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Imgn/T_11b.pdf}
\fuentepropia
\end{figure}
...
{x,-2,2},{y,-2,2},{z,-3,3.2},PlotPoints->90,Mesh->False];
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
Hay una región en la cual los límites de integración para $z$ van desde el elipsoide hasta el mismo elipsoide, mientras que en la región restante, los límites para $z$ van desde el hiperboloide hasta el elipsoide. Por la simetría de la figura se puede establecer que el volumen está dado por:
\begin{multline}
...
\begin{gather}
\bigintsss_{0}^2 \bigintsss_{\sqrt{5-x^{2}}}^{\sqrt{9-2x^{2}}}\bigintsss_{0}^{\sqrt{9-2x^{2}-z^{2}}}8dydzdx +
...
{y,Sqrt[(7-2*x^2)/3],Sqrt[4-x^2]},{z,Sqrt[2*x^2+3*y^2-7],
Sqrt[9-2*x^2-y^2]}]+NIntegrate[8,{x,Sqrt[7/2],2},{y,0,Sqrt[4-x^2]},
{z,Sqrt[2*x^2+3*y^2-7],Sqrt[9-2*x^2-y^2]}]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
\includegraphics[height=4cm]{Imgn/T_15a.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Imgn/T_15b.pdf}
\fuentepropia
\end{figure}
...
{y,0,3.7},{z,-3,3},PlotPoints->90,Mesh->False,BoxRatios->{1,1,1}]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
centrado en el origen de radio $4$. Por lo tanto, utilizando coordenadas rectangulares e integrando primero con respecto a $y$, la integral que determina el volumen es:
...
\begin{gather*}
\left( 1-w\right) \left( \sqrt{8}u\cos v,2u^{2},\sqrt{8}u\sin v\right)+w\left( \sqrt{8}u\cos v,2\sqrt{3-2u^{2}},\sqrt{8}u\sin v\right);
\end{gather*}
...
\includegraphics[height=4cm]{Imgn/T_17a.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Imgn/T_17b.pdf}
\fuentepropia
\end{figure}
...
{x,0,3.25},{y,-2,2},{z,-2,2},PlotPoints->90,Mesh->False]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on

Estas superficies se intersecan en una región del plano $yz$
determinada por la ecuación $y^{2}+z^{2}=4$.
Se debe tener presente que $x$ recorre los puntos desde el semicono hasta el paraboloide. También se presenta la integral correspondiente al cambio a coordenadas cilíndricas; por lo tanto,
el volumen del sólido está dado por:
...
\label{fig:3y2z2}
\includegraphics[height=3.5cm]{Imgn/T_16a.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Imgn/T_16b.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Imgn/T_16c.pdf}
\fuentepropia
\end{figure}
...
{y,-2,2},{z,-2.2,2.2},PlotPoints->90,Mesh->False,BoxRatios->{1,1,1}]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
\includegraphics[height=4cm]{Imgn/T_19a.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Imgn/T_19b.pdf}
\fuentepropia
\end{figure}
...
% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
Integrate[1,{x,-3,1-Sqrt[5]/2},{y,-Sqrt[9-x^2],Sqrt[9-x^2]},
{z,-Sqrt[9-x^2-y^2],Sqrt[9-x^2-y^2]}]+
NIntegrate[1,{x,1-Sqrt[5]/2,1+Sqrt[5]/2},
{y,-Sqrt[9-x^2],1/2-Sqrt[5/4-(x-1)^2]},{z,-Sqrt[9-x^2-y^2],
Sqrt[9-x^2-y^2]}]+Integrate[1,{x,1+Sqrt[5]/2,3},
{y,-Sqrt[9-x^2],Sqrt[9-x^2]},{z,-Sqrt[9-x^2-y^2],Sqrt[9-x^2-y^2]}]+
NIntegrate[1,{x,1-Sqrt[5]/2,1+Sqrt[5]/2},{y,1/2+Sqrt[5/4-(x-1)^2],
...
\includegraphics[height=3.2cm]{Imgn/5b.pdf} \hspace{2mm}
\includegraphics[height=3.2cm]{Imgn/5a.pdf} \hspace{2mm}
\includegraphics[height=3.2cm]{Imgn/5c.pdf}
\fuentepropia
\end{figure}
...
-Integrate[1,{y,-1,1},{z,2-Sqrt[1-y^2],2+Sqrt[1-y^2]},{x,0,4-z}]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on

\textls[-20]{El mencionado sólido se parametrizó mediante la expresión \ref{solidohueco2}. Con las siguientes instrucciones se define la parametrización, se halla el elemento diferencial de volumen y se evalúan las integrales con los límites establecidos:}

\begin{SaveVerbatim}{apretar_6}
r1={0,(1-u)*Cos[t]+u*(2-4*t/Pi),(1-u)*(2+Sin[t])+16*t*u/Pi*(1-t/Pi)};
r2={0,(1-u)*Cos[t]+u*(4*(t-Pi)/Pi-2),(1-u)*(2+Sin[t])};
r3={4-(1-u)*(2+Sin[t])-16*t*u/Pi*(1-t/Pi),(1-u)*Cos[t]+u*(2-4*t/Pi),
(1-u)*(2+Sin[t])+16*t*u/Pi*(1-t/Pi)};
r4={4-((1-u)*(2+Sin[t])),(1-u)*Cos[t]+u*(4*(t-Pi)/Pi-2),
(1-u)*(2+Sin[t])};
{R1,R2}={(1-w)*r1+w*r3,(1-w)*r2+w*r4};
Integrate[Dot[D[R1,w],Cross[D[R1,u],D[R1,t]]],{t,0,Pi},
{u,0,1},{w,0,1}]+Integrate[Dot[D[R2,w],Cross[D[R2,u],D[R2,t]]],
{t,Pi,2*Pi},{u,0,1},{w,0,1}]
\end{SaveVerbatim}

% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]
\textls[-25]{\UseVerbatim[formatcom=\letraverbatim]{apretar_6}}
\end{tcolorbox}
% tex-fmt: on
\end{parrafonumerado}
...
\begin{ejer}
Determine el volumen del sólido acotado por las figuras de las expresiones señaladas. Hágalo de diversas maneras, incluyendo la parametrización de la región. Se agrega la figura y las instrucciones para conseguirlo.
\end{ejer}
...
% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
RegionPlot3D[x^2+y^2-4<=z&&z<=(4-x^2-y^2)*Exp[1-x^2-y^2],
{x,-2,2},{y,-2,2},{z,-4,12},PlotPoints->90,Mesh->False]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
\includegraphics[height=3.5cm]{Imgn/T_42a.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Imgn/T_42b.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Imgn/T_42c.pdf}
\fuentepropia
\end{figure}
...
% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
RegionPlot3D[x^2+y^2<=z<=4-3*(x^2+y^2)^3&&x^2+y^2<=1,
{x,-1,1},{y,-1,1},{z,0,4},Mesh->False,PlotPoints->90,
PlotStyle->RGBColor[0.3,0.6,0.3]]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
\includegraphics[height=3cm]{Imgn/T_40a.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Imgn/T_40b.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Imgn/T_40c.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=3cm]{Imgn/T_41a.pdf} \hspace{5mm}
\includegraphics[height=3cm]{Imgn/T_41b.pdf}
\fuentepropia
\end{figure}

% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
RegionPlot3D[3*(x^2+y^2)^6<=z<=4-x^2-y^2&&x^2+y^2<=1,
{x,-1,1},{y,-1,1},{z,0,4},PlotPoints->90,Mesh->False,
PlotStyle->RGBColor[0.6,0.2,0.2]]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
