...
\[{\bf r}\left( u,v,w\right) =\left\langle \frac{1}{2}+u\cos (v) ,u\sin (v) , (w-1)u\sin (v) \right\rangle\]
...
$\frac{(z-2)^2}{4}+\frac{(y-3)^2}{9}=1-\frac{x}{4}$. Esta superficie junto con el plano $x=0$, acotan un sólido, que se presenta en la figura~\ref{fig:solido_eliptico_desplazado_2}.
...
se obtiene {\footnotesize $x=4\left( 1-\frac{(z-2)^2}{4}-\frac{(y-3)^2}{9}\right)$,} por lo tanto
\[
...
Con ayuda de la figura~\ref{fig:proyecciones_planes_curvas} se pueden plantear las seis integrales triples que permiten calcular el volumen del sólido en mención.
...
Ejecutando las siguientes instrucciones, se consigue la figura~\ref{fig:3y2z2}:
