...
En el caso de plantear las integrales en el orden $dxdydz$ y $dydxdz$ puede ser necesario presentar cuatro integrales triples, los gráficos de la figura~\ref{fig:volumen_solido_proyecciones} ilustran el porqué se da esta situación.
...
\centering
\caption{Proyección en el plano $xz$}
\includegraphics[height=4cm]{Fig/327.pdf}
\fuentepropia
\end{figure}
...
Consideremos el sólido acotado por el gráfico de las ecuaciones $y=4-x^2$, $z=2-y/2$, $y=0$ y $z=0$ (figura~\ref{fig:parabolas_z}), hallaremos su volumen de varias maneras.
...
\includegraphics[height=4cm]{Fig/384.pdf}
\fuentepropia
\end{figure}
...
Si la densidad del sólido en cualquier punto $(x,y,z)$ está dada por $\delta(x,y,z)$ $= xy$, entonces la masa del sólido es inversa.
\[M=\int _0^2\int {x^3}^{\sqrt{8 (10-x)}}\int 0^{10-x-\frac{y^2}{8}}xydzdydx=\frac{13\,000}{63}.\]
...
\begin{figure}[H]
\centering
\caption{Región delimitada por $r = 1 - \cos(t)$, $r = 2 - 2\cos(t)$, y $z = 2 - \frac{y}{2}$}
...
También se puede calcular el volumen considerando un punto sobre el cono $P\left(u\cos v,u,u\sin v\right)$ y otro punto $Q\left( u\cos v,\sqrt{9-u^{2}},u\sin v\right)$ sobre la esfera. De esta manera de forma una combinación convexa entre estos puntos y se parametriza el sólido. Esto es:
\begin{align*}
