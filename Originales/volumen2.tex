...
\includegraphics[height=3.5cm]{Img/11d.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Img/11c.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Img/11b.pdf}
\fuentepropia
\end{figure}
...
\caption{Proyecciones del sólido en los planos coordenados}
\label{figura115}
\includegraphics[height=3.5cm]{Fig/421.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Fig/422.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Fig/423.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=4cm]{Img/29a.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Img/29b.pdf}

\includegraphics[height=4cm]{Img/29c.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Img/29d.pdf}
\fuentepropia
\end{figure}
...
De la expresión $x^2+z^2=16$, se sigue que $x=\pm \sqrt{16-z^2}$. Del reemplazo en la otra ecuación se obtiene
$16-z^2+2y^2=4\sqrt{16-z^2}$, que equivale a $\left( z^2-y^2\right) ^2=16\left( z^2+2y^2\right)$.
De esta expresión se obtiene $z=\sqrt{8+\frac{y^2}{2}\pm 2\sqrt{16-2y^2}}$.
...
Sqrt[64-8*y^2]]},{x,2-Sqrt[16-2*y^2]/2,2+Sqrt[16-2*y^2]/2}]+
...
\includegraphics[height=3.5cm]{Img/85c.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Fig/428.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Img/85b.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=3.5cm]{Fig/429.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Fig/430.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Fig/431.pdf}
\fuentepropia
\end{figure}
...
Integrate[1,{z,0,1},{x,-Sqrt[1-z],Sqrt[1-z]},{y,-Sqrt[1-x^2],Sqrt[1-x^2]}]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
\textls[-15]{La base del sólido es un círculo unitario que se parametriza $(u\cos \theta ,u\sin \theta ,0)$,} sobre el cilindro parabólico se satisface que $z=1-x^2=1-u^2\cos ^2\theta $. El sólido se parametriza formando una combinación convexa entre un punto en la base y otro punto sobre el cilindro parabólico, esto es
$(1-w)(u\cos \theta ,u\sin \theta ,0) +w( u\cos \theta ,u\sin \theta ,1-u^2\cos ^2\theta)$; al simplificarse, nos permite definir la función
...
\includegraphics[height=3.5cm]{Img/17c.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Img/17d.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Img/17b.pdf}
\fuentepropia
\end{figure}
...
% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
ContourPlot3D[{z==4-x^2,2*x==y^2,4*x==y^4-2*y^2},{x,-1,2},{y,0,2},{z,0,4},
ContourStyle->{Orange,Blend[{Yellow,Pink,Green}],LightGray},
Mesh->None,PlotPoints->60]
RegionPlot3D[0<z<4-x^2&&(y^4-2*y^2)/4<x<y^2/2,{x,0,2},{y,0,2},{z,0,4},
PlotStyle->Blend[{Yellow,Orange,Red}],PlotPoints->90,Mesh->None]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
\includegraphics[height=4cm]{Img/83a.pdf} \hspace{2mm}
\includegraphics[height=4cm]{Img/83b.pdf} \hspace{2mm}
\includegraphics[height=4cm]{Img/83c.pdf}
\fuentepropia
\end{figure}
...
{t,-Pi/2,k},PlotRange->{{0,2},{-2,2}}],{k,-Pi/2+Pi/40,Pi/2}]
...
$ (2( 1+u)\cos^2(\theta), ( 1+u)\sin (2\theta) )$, y parametriza la región acotada por estas dos curvas.
Sobre el cilindro $x^2+z^2 = 16$ se satisface que $z = \pm 2\sqrt{4-(1+u) ^2\cos ^{4}(\theta) }$.
Sobre el cilindro circular, consideremos dos puntos $P_1$ y $Q_1$.
...
\includegraphics[height=3.5cm]{Img/18d.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Img/18c.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Img/18e.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=4cm]{Img/18a.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Img/18b.pdf}
\fuentepropia
\end{figure}
...
Directive[Blend[{Green,Orange,Red}],Opacity[0.75]],Opacity[0.75]}];
...
\includegraphics[height=4cm]{Fig/440.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Fig/441.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=3.5cm]{Img/55a.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Img/55b.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Img/55c.pdf}
\fuentepropia
\end{figure}
...
{z,-12*y/5+4-2*Sqrt[30*y-20-9y^2]/5,12*y/5+4+2*Sqrt[30*y-20-9y^2]/5},
{x,-a,5-z-3*y}]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
\includegraphics[height=4cm]{Fig/447.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Fig/448.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=4cm]{Fig/449.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Fig/450.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=4cm]{Fig/451.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Fig/452.pdf}
\fuentepropia
\end{figure}
...
Por lo tanto, el sólido se parametriza mediante una combinación convexa de dos puntos de la forma
%
...
&&-1<x<1,{x,-1,1},{y,-1,1},{z,-1,1},PlotStyle->RGBColor[0.8,0.3,0.3],
PlotPoints->90,Mesh->False]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
\includegraphics[height=4cm]{Img/52a.pdf} \hspace{5mm}
...
{y,0,Sqrt[r^2-x^2]},{z,0,Sqrt[r^2-x^2]}]+Integrate[1,{x,0,r/Sqrt[2]},
{y,x,Sqrt[r^2x^2]},{z,0,Sqrt[r^2-y^2]}])]
Assuming[r\[Element]Reals&&r>0,8*(Integrate[1,{y,0,r/Sqrt[2]},
{x,y,Sqrt[r^2-y^2]},{z,0,Sqrt[r^2-x^2]}]+
Integrate[1,{y,0,r/Sqrt[2]},{x,0,y},{z,0,Sqrt[r^2-y^2]}]+
Integrate[1,{y,r/Sqrt[2],r},{x,0,Sqrt[r^2-y^2]},{z,0,Sqrt[r^2-y^2]}])]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on
...
\includegraphics[height=4.5cm]{Img/90b.pdf} \hspace{0.2cm}
...
\includegraphics[height=4cm]{Fig/458.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Img/36a.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=4cm]{Fig/459.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Fig/460.pdf}
\fuentepropia
\end{figure}
...
\subsection{Cilindros cardióidicos y el plano \texorpdfstring{$z=2-y/2$}{z=2-y/2}}
...
\includegraphics[height=4cm]{Fig/461.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Img/35e.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=4cm]{Img/35d.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Fig/462.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=4cm]{Fig/463.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Fig/464.pdf}
\fuentepropia
\end{figure}
...
Esto implica que $\left| {\bf r}_t \cdot \left( {\bf r}_{u}\times {\bf r}_{w}\right) \right| =
...
\begin{gather*}
\frac{1}{6}\Big( (4u-u^2)\cos(2t) + (4u^2-8u)\cos(t) \\
-4u\sin(t)+2u\sin(2t)-3u^2+4u+8 \Big).
\end{gather*}
...
\includegraphics[height=4cm]{Fig/471.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Fig/472.pdf}
\fuentepropia
\end{figure}
...
\caption{Proyección del sólido en los planos coordenados}
\label{figsemicirc}
\includegraphics[height=3.5cm]{Fig/473.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Fig/474.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Fig/475.pdf}
\fuentepropia
\end{figure}
...
%\begin{tcolorbox}[title=\bfseries Parametrizando el sólido]
Consideremos la proyección del sólido en el plano $yz$, (ver la figura \ref{figsemicirc}). Un punto sobre la semicircunferencia de radio $1$, posee coordenadas
...
\index{Toro cardióidico!volumen}
...
\includegraphics[height=4.5cm]{Img/59f.pdf} \hspace{0.4cm}
...
Si esta región gira sobre la recta $x=3$, se genera un toro cardióidico, cualquier punto sobre este sólido tiene la forma determinada por la si\-guiente función:
\begin{multline*}
...
\includegraphics[height=3.5cm]{Imgn/T_7a} \hspace{2mm}
\includegraphics[height=3.5cm]{Imgn/T_7b.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Imgn/T_7c.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=3.5cm]{Imgn/5b.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Imgn/5a.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Imgn/5c.pdf}
\fuentepropia
\end{figure}
...
\begin{figure}[H]
  ...
  \includegraphics[height=3.5cm]{Imgn/T_40a.pdf} \hspace{2mm}
  \includegraphics[height=3.5cm]{Imgn/T_40b.pdf} \hspace{2mm}
  \includegraphics[height=3.5cm]{Imgn/T_40c.pdf}
  \fuentepropia
\end{figure}
...
\begin{figure}[H]
  ...
  \includegraphics[height=4cm]{Imgn/T_41a.pdf} \hspace{5mm}
  \includegraphics[height=4cm]{Imgn/T_41b.pdf}
  \fuentepropia
\end{figure}
