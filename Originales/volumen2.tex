...
% tex-fmt: off
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
Integrate[1,{x,-2,2},{z,6-x^2/2,8-x^2},{y,-Sqrt[8-z-x^2],Sqrt[8-z-x^2]}]
+Integrate[1,{x,-2,2},{z,x^2,6-x^2/2},{y,-Sqrt[(z-x^2)/3],Sqrt[(z-x^2)/3]}]
...
Integrate[1,{z,0,4},{x,-Sqrt[z],Sqrt[z]},{y,-Sqrt[(z-x^2)/3],Sqrt[(z-x^2)/3]}]
\end{Verbatim}
\end{tcolorbox}
% tex-fmt: on

Integrando primero con respecto a $x$, las integrales triples que determinan el volumen del sólido son las siguientes:
\begin{gather} \bi_{-\sqrt{2}}^{\sqrt{2}}\bi_{4+y^2 }^{8-y^2}\bi_{-\sqrt{8-z-y^2}}^{\sqrt{8-z-y^2}}dxdzdy
...
Con las siguientes instrucciones se obtuvieron los gráficos de la figura~\ref{fig:region_paraboloides_89}.
...
Los gráficos de la figura~\ref{fig:bicilindro} se obtienen ejecutando las siguientes instrucciones, en ellas se consideró $r=1$.
...
Los gráficos de la figura~\ref{fig:paraboloide_exponencial} se obtienen por medio de las siguientes instrucciones:
...
Las siguientes instrucciones permiten obtener el gráfico del sólido (figura~\ref{fig:cilindro_parabolico_superior}).
