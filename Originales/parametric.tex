\chapter{Parametrizaciones básicas}
...
tal que $\alpha =r\circ g$, a $\alpha$, se le denomina una \emph{reparametrización} de $\ve{r}$. Si la función $g$ es creciente $\left(g^{\prime }(t)>0\right)$, entonces $\alpha $ preserva la orientación, y si $g$ es decreciente $\left( g^{\prime }(t)<0\right), $ entonces $\alpha $ invierte la orientación de la curva.
...
\begin{figure}[H]
\centering
\caption{${\bf u}(t)=\langle t^3-3t, t \rangle$}
\includegraphics[height=4.5cm]{Fig/20.pdf}
\fuentepropia
\end{figure}
...
\begin{figure}[H]
\centering
\caption{${\bf u}(t)=\langle  t,t^4-3t^2 \rangle$}
\includegraphics[height=4.5cm]{Fig/21.pdf}
\fuentepropia
\end{figure}

La función $y=x^4-3x^2$, con $x\in[-2,2]$ se parametriza mediante la expresión
$\ve{r}(t)=\langle t,t^4-3t^2 \rangle$ con $t \in [-2,2]$; el punto inicial de
la curva descrita es  $(-2,4)$ y el punto final es $(2,4)$.
...
\begin{tcolorbox}[title=\bf Parametrización de un segmento]
...
\begin{tcolorbox}[title=\bf Parametrización de la circunferencia unitaria]
...
\begin{figure}[H]
\centering
\caption{Gráficos de ${\bf u}(t)=\langle\cos(t),\sin(t)\rangle$ y ${\bf u}(t)=\langle\sin(t),\cos(t)\rangle$}
\includegraphics[height=4.5cm]{Fig/22.pdf}
\fuentepropia
\end{figure}
...
\begin{tcolorbox}[title=\bf Parametrización de la hipérbola unitaria]
...
\begin{figure}[H]
\centering
\caption{Gráficos de ${\bf r}(t)=\la \cosh(t),\sinh(t)\ra$ y ${\bf r}(t)=\la \sinh(t),\cosh(t)\ra$}
\includegraphics[width=0.8\textwidth]{Fig/23.pdf}
\fuentepropia
\end{figure}

\subsection{Ejemplos de parametrización de curvas}

$\bullet$\quad El segmento de recta que une los puntos $A(1,1)$ y $B(3,2)$, iniciando en $A$ y terminando en $B$, se parametriza al simplificar la combinación convexa
\[ (1-t)(1,1) + t(3,2), \]
...
\begin{figure}[H]
\centering
\caption{Segmento en el plano}
\includegraphics[width=0.4\textwidth]{Fig/24.pdf}
\fuentepropia
\end{figure}

\clearpage

$\bullet$\quad \textls[-20]{El segmento rectilíneo con punto inicial $(2,-1,0)$ y punto final $(-1, 2, 2)$ se parametriza simplificando una combinación convexa de los puntos}
\[
(1 - t)(2,-1,0) + t(-1,2,2),
\]
...
\begin{figure}[H]
\centering
\caption{Segmento en el espacio}
\label{segmento_espacio}
\includegraphics[width=.45\textwidth]{Fig/18.pdf}
\fuentepropia
\end{figure}

\enlargethispage*{\baselineskip}

$\bullet$\quad La elipse centrada en el origen y alargada en el sentido de las $x$
...
\begin{figure}[H]
\centering
\caption{${\bf r}(t)=\langle 3\cos(t),2\sin(t)\rangle$}
\includegraphics[width=.4\textwidth]{Fig/25.pdf}
\fuentepropia
\end{figure}

$\bullet$\quad Con $t \in [0,\pi]$ se describe la mitad de la elipse. Utilizando la fórmula \ref{param3}, se obtiene $x = -3\cos(t)$ y $y = 2\sin(t)$. De esta manera se describe la misma curva, variando sus puntos terminales y la orientación.

\begin{figure}[H]
\centering
\caption{${\bf r}(t) = \langle -3\cos(t),\, 2\sin(t) \rangle$}
\label{semielipse_izquierda}
\includegraphics[width=.4\textwidth]{Fig/26.pdf}
\fuentepropia
\end{figure}

$\bullet$\quad En el espacio, la circunferencia de radio $2$ centrada
en el punto $(0, 2, 0)$
\textls[-10]{y paralela al plano $xz$ se puede parametrizar como $\ve{r}(t) = \la 2\cos t, 2, 2\sin t\ra$, $t\in[0,2\pi]$.}
Obsérvese que esta curva se halla en el plano $y=2$.

\begin{figure}[H]
\centering
\caption{Circunferencia en el espacio}
\label{Circunferencia_espacio}
\includegraphics[width=.4\textwidth]{Fig/19.pdf}
\fuentepropia
\end{figure}

$\bullet$\quad Las ecuaciones $x-y+3z=3$ y $x^2+y^2=4$ representan un plano y un cilindro. En el plano $xy$ la ecuación del cilindro corresponde a una circunferencia de radio $2$ que se parametriza con $x=2 \cos t$, $y=2 \sin t$. De~la ecuación del plano se obtiene $z$.
Luego, la intersección de las superficies está dada por $\ve{r}(t)=\la 2\cos t, 2\sin t,1-\frac{2}{3}(\cos t+\sin t) \ra$.

\begin{figure}[H]
\centering
\caption{Elipse en el espacio}
\label{Elipse_espacio}
\includegraphics[width=0.4\textwidth]{Fig/27.pdf}
\fuentepropia
\end{figure}
...
$\bullet$\quad Con las funciones $g(t)=\sqrt[4]{t}$
y $f(t)=(1-t)^3$, uniremos los puntos $A(1,1)$ y $B(3,2)$ mediante la expresión
$(1-t)^3 A + \sqrt[4]{t} B$.

\textls[-20]{Esto permite definir la función
${\bf r}(t)=(1-t) ^{3}(1,1) +\sqrt[4]{t}(3,2)$,
con  $t\in[0,1]$.}

\begin{figure}[H]
\centering
\caption{${\bf r}(t)=(1-t) ^{3}(1,1) +\sqrt[4]{t}(3,2)$}
\includegraphics[width=0.4\textwidth]{Fig/28.pdf}
\fuentepropia
\end{figure}

$\bullet$\quad Con ayuda de las funciones $g(t) = t^6$ y $f(t) = (1 - t^2)^3$, se define la función
\[
...
\begin{figure}[H]
\centering
\caption{${\bf r}(t) = (1 - t^2)^3(1,1) + t^6(3,2)$}
\includegraphics[width=0.4\textwidth]{Fig/29.pdf}
\fuentepropia
\end{figure}

$\bullet$\quad Utilizando una interpolación cuadrática entre los puntos $(1,1)$, $(3,2)$ y un punto intermedio
entre ellos, se obtienen las siguientes funciones:
\begin{gather*}
y=\frac{51-61t+16t^2}{6},\quad y=\frac{27-29t+8t^2}{6},\quad y=\frac{22-27t+7t^2}{6},\\
y=\frac{-16+33t-7t^2}{10},\quad y=\frac{-5+16t-3t^2}{8}.
\end{gather*}
...
\begin{figure}[H]
\centering
\caption{Cinco polinomios que unen $A$ con $B$}
\includegraphics[width=0.4\textwidth]{Fig/30.pdf}
\fuentepropia
\end{figure}
...
$\bullet$\quad Utilizando las funciones $f(t)=\cos(\frac{\pi}{2}t)$ y $g(t)=\sin(\frac{\pi}{2}t)$, se define
...
para $0\leq t\leq 1$.
Por lo tanto, la parametrización escogida es $\ve{r}(t)$.

\begin{figure}[H]
\centering
\caption{${\bf r}(t)=\cos\left( \frac{\pi t}{2}\right)A +\sin \left( \frac{\pi t}{2}\right)B$}
\includegraphics[width=0.4\textwidth]{Fig/31.pdf}
\fuentepropia
\end{figure}
...
\begin{figure}[H]
\centering
\caption{${\bf u}(r,\theta) =\la r \cos \theta, r \sin \theta \ra$}
\label{fig:32}
\includegraphics[width=0.35\textwidth]{Fig/32.pdf}
\fuentepropia
\end{figure}
...
\begin{figure}[H]
\centering
\caption{${\bf u}(r,\theta) =\la 3r \cos \theta, 2r \sin \theta \ra$}
\label{fig:33}
\includegraphics[width=0.35\textwidth]{Fig/33.pdf}
\fuentepropia
\end{figure}
...
\begin{figure}[H]
\centering
\caption{Triángulo parametrizado $(1-v)C+v\left((1-u)A+uB \right)$}
\label{fig:161}
\includegraphics[width=0.35\textwidth]{Fig/161.pdf}
\fuentepropia
\end{figure}
...
\begin{figure}[H]
\centering
\caption{Cuadrilátero parametrizado}
\label{fig:Cuadrilátero_parametrizado}
\includegraphics[width=0.35\textwidth]{Fig/35.pdf}
\fuentepropia
\end{figure}
...
$P(x,f(x))$ y $Q(x,g(x))$. Por lo tanto,
...
\begin{figure}[H]
\centering
\caption{Región parametrizada}
\label{fig:Región_parametrizada}
\includegraphics[width=0.35\textwidth]{Fig/36.pdf}
\fuentepropia
\end{figure}
...
$u \in [0,1]$, $y \in [c,d]$,
una función que describe la dicha región es:
\[
...
\includegraphics[width=0.35\textwidth]{Fig/37.pdf}
\fuentepropia
\end{figure}
...
\begin{figure}[H]
\centering
\caption{$y=4-x^2$ y $y=x^3-4x$}
\label{fig:38}
\includegraphics[width=0.35\textwidth]{Fig/38.pdf}
\fuentepropia
\end{figure}
...
\begin{figure}[H]
\centering
\caption{$y=x+1$\; y\; $y=x^2-1$}
\label{fig:39}
\includegraphics[width=0.35\textwidth]{Fig/39.pdf}
\fuentepropia
\end{figure}

La región acotada por las graficas de las expresiones $y=x^4-x^2$, $y=4-x^2$ y $x=1$
se parametriza por medio de la expresión $(1-u)(x,x^4-x^2)+u(x,4-x^2)$,
que al simplificarse, con $x \in [-\sqrt{2},1]$, $u \in [0,1]$,
permite definir la función $\ve{r}(x,u)=\la x, u(4-x^4)+x^2(x^2-1) \ra$.

\begin{figure}[H]
\centering
\caption{$\la x, u(4-x^4)+x^2(x^2-1) \ra$}
\label{fig:region_gris}
\includegraphics[width=0.35\textwidth]{Fig/40.pdf}
\fuentepropia
\end{figure}
...
\begin{tcolorbox}[title=\bf Instrucción \verb"Mathematica"]
\begin{Verbatim}[formatcom=\letraverbatim]
B=ParametricPlot[{x,u*(4-x^4)+x^2*(x^2-1)},{x,-Sqrt[2],1},{u,0,1}];
...
\begin{tcolorbox}[title=\bf Instrucción \verb"Mathematica"]
\begin{Verbatim}[formatcom=\letraverbatim]
A=ContourPlot[{x==y^2-5*y,x==3*y-y^2},{x,-7,4},{y,-1,5}];
B=ParametricPlot[(1-v){u^2-5*u,u}+v*{3*u-u^2,u},{v,0,1},{u,0,4}];
Show[A,B]
\end{Verbatim}
\end{tcolorbox}
...
\begin{figure}[H]
\centering
\caption{$ \la (8v-5)u+(1-2v)u^2,u \ra$}
\label{fig:41}
\includegraphics[width=0.35\textwidth]{Fig/41.pdf}
\fuentepropia
\end{figure}

\subsection{Superficies parametrizadas} \index{Superficies parametrizadas}

\textls[-25]{Recordemos un concepto que permite hacer estas construcciones en el espacio.}

\begin{tcolorbox}[title=\bf Definición]
...
$\bullet$\quad Utilizando coordenadas esféricas, la superficie de la esfera unitaria se puede parametrizar
...
La figura~\ref{fig:esferauni} se obtiene al ejecutar las siguientes instrucciones:
...
\begin{figure}[H]
  \centering
  \caption{La esfera unitaria y el elipsoide parametrizado por ${\bf r}(\theta, \phi)$}
  \label{fig:esferauni}
  \includegraphics[height=2.7cm]{Img/T_53a.pdf} \hspace{2mm}
  \includegraphics[height=2.7cm]{Img/T_53b.pdf} \hspace{2mm}
  \includegraphics[height=2.7cm]{Img/T_53c.pdf}
  \fuentepropia
\end{figure}

$\bullet$\quad La superficie $\sigma$ sobre el paraboloide
...
\begin{figure}[H]
  \centering
  \caption{Superficie $\sigma$}
  \label{Superficie_sigma}
  \includegraphics[width=0.4\textwidth]{Fig/42.pdf}
  \fuentepropia
\end{figure}

$\bullet$\quad La superficie del cilindro con ecuación $x^2+y^2=2x$, para $z \in [-1,2]$, se
parametriza en la forma
\[{\bf r}(u,t)= \la 1+\cos(t),\sin(t), u \ra,\] con $t \in [0,2\pi]$, $u\in [-1,2]$.
En el plano $xy$ el cilindro corresponde a la circunferencia $(x-1)^2+y^2=1$.\enlargethispage*{\baselineskip}

\begin{figure}[H]
\centering
\caption{${\bf r}(u,t)= \la 1+\cos t,\sin t, u \ra$}
\label{fig:43}
\includegraphics[width=0.4\textwidth]{Fig/43.pdf}
\fuentepropia
\end{figure}

$\bullet$\quad Las expresiones $2z=x^{2}-y^{2}$ y $2x^{2}+y^{2}+2y=8$ representan un paraboloide hiperbólico y un cilindro elíptico, respectivamente. La ecuación
...
\begin{figure}[H]
\centering
\caption{Superficie sobre el paraboloide hiperbólico}
\includegraphics[height=4cm]{Img/73a.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Img/73b.pdf}
\end{figure}
...
\begin{tcolorbox}[title=\bf Instrucción \verb"Mathematica"]
\begin{Verbatim}[formatcom=\letraverbatim]
a=ContourPlot3D[{2*z==x^2-y^2,2*x^2+y^2+2*y==8},{x,-5,5},{y,-5,5},
{z,-9,5},Mesh->False,ContourStyle->{Directive[Orange,Opacity[0.6]],
Directive[Cyan,Opacity[0.2]]},PlotPoints->80,Ticks->{{-3,0,3},
{-3,0,3},{-8,-4,-2,2,4}}];
...
$\bullet$\quad Las ecuaciones $x^{2}+\left( y-3\right) ^{2}=4$ y $4z=36-\left(x^{2}+y^{2}\right) $
...
{x,-6,6},{y,-6,6},{z,0,9},Mesh->False,ContourStyle->{Orange,Cyan}]
ParametricPlot3D[{2*(2*u+1)*Sin[t],2*(2*u+1)Cos[t]-3*u+3,
(u-1)*(12*(1+2u)*Cos[t]-23-25u)/4},{u,0,1},{t,0,2*Pi}]
\end{Verbatim}
\end{tcolorbox}

\begin{figure}[H]
\centering
\caption{Superficie sobre el paraboloide exterior al cilindro}
\label{Superficie_paraboloide_exterior_cilindro}
\includegraphics[height=4.5cm]{Img/86a.pdf} \hspace{5mm}
\includegraphics[height=4.5cm]{Fig/44.pdf}
\fuentepropia
\end{figure}

La base del cilindro se puede parametrizar como
\begin{equation} \label{sup5a}
x=2\sin (t), \,\, y=3+2\cos (t), \, t\in [ 0,2\pi ]
\end{equation}

Mientras que la intersección del paraboloide y el plano $z=0$ se parametriza como $x=6\sin (t) $, $y=6\cos (t) $, con $t\in [ 0,2\pi ]$.

\clearpage

Con el fin de parametrizar la proyección de $\sigma$ sobre el plano $xy$, se puede formar una combinación convexa entre dos puntos de la forma $P = (2\sin(t),\, 3 + 2\cos(t),\, 0)$ y $Q = (6\sin(t),\, 6\cos(t),\, 0)$. La expresión que permite describir la región acotada por las dos circunferencias está~\mbox{dada}~por:
\[
(1 - u)\,P + u\,Q.
\]
...
\begin{figure}[H]
\centering
\caption{Proyección de $\sigma$}
\label{fig:45}
\includegraphics[width=0.4\textwidth]{Fig/45.pdf}
\fuentepropia
\end{figure}

Por lo tanto, la función que parametriza la región sobre el plano $xy$ acotada por las dos
...
$\bullet$\quad Con algunos de los elementos anteriores construiremos el siguiente ejemplo.
...
\begin{figure}[H]
\centering
\caption{Superficie sobre el paraboloide hiperbólico $5z=x^2-y^2$}
\label{Superficie_paraboloide_hiper}
\includegraphics[height=4cm]{Fig/46a.pdf}
\includegraphics[height=4cm]{Fig/46b.pdf}
\fuentepropia
\end{figure}
...
\begin{tcolorbox}[title={Código en \verb"Mathematica"}]
\begin{Verbatim}[formatcom=\letraverbatim]
...
\begin{tcolorbox}[title=\bf Una manera de parametrizar una superficie]
Para dos funciones vectoriales $\vec{\alpha}$ y $\vec{\beta}$ en $\mathbb{R}^n$, si $f$ y $g$ son
funciones reales contínuas en el intervalo $[a,b]$, que satisfacen que
$f(a)=1$, $g(a)=0$ y $f(b)=0$, $g(b)=1$, entonces la función vectorial
\[\ve{r}(u,t)=f(u)\vec{\alpha}(t)+g(u)\vec{\beta}\]
es una parametrización de la superficie $\sigma$ acotada por las curvas determinadas por $\vec{\alpha}$ y $\vec{\beta}$.
\end{tcolorbox}

Veamos algunos ejemplos de la expresión anterior.

$\bullet$\quad La cardioide $r=1-\cos(t)$, en el plano $z=2$, se define por medio de la función vectorial
...
\begin{figure}[H]
\centering
\caption{Superficie que conecta una cardioide y una circunferencia}
\label{Superficie_cardioide_circunferencia}
\includegraphics[height=2.4cm]{Fig/47.pdf} \hspace{3mm}
\includegraphics[height=2.4cm]{Img/42a.pdf} \hspace{3mm}
\includegraphics[height=2.4cm]{Img/42b.pdf}
\fuentepropia
\end{figure}
...
a=ParametricPlot3D[{q,{3*Cos[t],3*Sin[t],0}},{t,0,2*Pi},
PlotStyle->{Directive[Black,Thickness->0.01],
PlotPoints->90,Directive[Black,Thickness->0.01]}];
b=ParametricPlot3D[r,{t,0,2*Pi},{u,0,1},PlotStyle->Orange,
MeshStyle->Gray];
Show[a,b]
\end{Verbatim}
\end{tcolorbox}

$\bullet$\quad Con las funciones vectoriales
...
que representan dos elipses en el espacio, se forma una combinación convexa de ellas con parámetro $u\in \lbrack 0,1]$. Simplificando la expresión $(1-u)\overrightarrow{r}_1(t)+u\overrightarrow{r}_2(t)$
...
\begin{figure}[H]
\centering
\caption{Superficie que une dos elipses mediante segmentos}
\label{conos_67}
\includegraphics[height=4cm]{Img/33a.pdf} \hspace{2mm}
\includegraphics[height=4cm]{Img/33b.pdf} \hspace{2mm}
\includegraphics[height=4cm]{Img/33c.pdf}
\fuentepropia
\end{figure}
...
$\bullet$\quad Las dos circunferencias en el espacio, representadas por las funciones vectoriales
...
\begin{figure}[H]
\centering
\caption{Superficies que conectan dos circunferencias}
\label{superficies_circunferencias68}
\includegraphics[height=2.2cm]{Img/8c.pdf} \hspace{2mm}
\includegraphics[height=2.2cm]{Img/8b.pdf} \hspace{2mm}
\includegraphics[height=2.2cm]{Img/8a.pdf}
\fuentepropia
\end{figure}
...
{2*Cos[t],2*Sin[t],0}+u^k*{Cos[t],Sin[t],2},{t,0,2Pi},{u,0,1}],
{k,0.5,2,0.1}]
\end{Verbatim}
\end{tcolorbox}

$\bullet$\quad Con las funciones $f(t)=te^{t-1}$ y $g(t)=(1-t)e^{t}$,
es sencillo ver que $f(0)=0=g(1)$ y $f(1)=1=g(0)$. Además, con las funciones vectoriales
\begin{gather*}
\vec{\alpha}(t) = \left\langle 3\cos(t),2\sin(t),2-\frac{\sin(t)}{2}\right\rangle
\, \text{y} \,
\vec{\beta}(t) = \left\langle 2\cos(t),\sin(t),\frac{\sin (2t)}{2} \right\rangle
\end{gather*}
se define la función
${\bf r}(u,t)= f(u)\vec{\alpha}(t)+g(u)\vec{\beta}(t)$, $t\in [0,2\pi]$, $u\in [0,1]$,
cuya figura es la siguiente:

\begin{figure}[H]
\centering
\caption{Superficie que conecta las curvas $\alpha$ y $\beta$}
\label{superficie_conecta_alfa_beta}
\includegraphics[height=3cm]{Fig/48.pdf} \hspace{5mm}
\includegraphics[height=3cm]{Fig/49.pdf}
\fuentepropia
\end{figure}

$\bullet$\quad \textls[-25]{Las siguientes funciones vectoriales
$\vec{\alpha}(t)= \langle3\cos(t),2\sin(t),2-\frac{1}{2}\sin(t)\rangle$ y
$\vec{\beta}(t)= \langle 2\cos(t),\sin(t),\frac{1}{2}\sin ( 2t) \rangle$, $t\in [0,2\pi]$}
...
definir la función ${\bf r}(u,t)= f(u)\vec{\alpha}(t)+g(u)\vec{\beta}(t)$ con $t \in [0,2\pi]$, $u \in [0,1]$.
Esta une los puntos de las curvas determinadas por $\vec{\alpha}(t)$
y $\vec{\beta}(t)$, a través de una superficie curva.

\begin{figure}[H]
\centering
\caption{Superficie determinada por ${\bf r}(u,t)$}
\label{Superficie_determinada}
\includegraphics[height=3cm]{Fig/50.pdf} \hspace{5mm}
\includegraphics[height=3cm]{Img/69a.pdf}
\fuentepropia
\end{figure}

La figura~\ref{Superficie_determinada} se genera con ayuda de las siguientes instrucciones:
...
$\bullet$\quad Las dos circunferencias unitarias ubicadas en el plano $z=2$ y $z=0$,
...
\begin{figure}[H]
\centering
\caption{Circunferencias conectadas}
\includegraphics[height=3.5cm]{Fig/51.pdf}
\fuentepropia
\end{figure}

Estas funciones se utilizan para formar la siguiente combinación.
\begin{gather*}
f(u)\vec{\alpha}(t)+g(u)\vec{\beta}(t)
= \left\la  \frac{u+1}{u^2+1}\cos t,\frac{u+1}{u^2+1} \sin t,\frac{4u}{u^2+1}\right\ra,u \in[0,1], t\in[0,2\pi].
\end{gather*}

$\bullet$\quad Las funciones {\small $\vec{\alpha}(t) = \langle(2-2\cos(t)) \cos(t), (2-2\cos(t))\sin(t),2\rangle$} y {\small $\vec{\beta}(t) = \langle ( 1-\cos(t)) \cos(t),( 1-\cos(t)) \sin(t),0\rangle$}
representan dos cardioides.

Se forma la combinación
\[{\bf r}(u,t)= (1-u^{4})\vec{\alpha}(t) +u^{3}\vec{\beta}(t),\]
...
\begin{figure}[H]
\centering
\caption{Dos cardioides conectadas}
\label{Dos_cardioides_conectadas}
\includegraphics[height=3cm]{Fig/52.pdf}
\fuentepropia
\end{figure}

$\bullet$\quad La figura \ref{fig:53} de la función vectorial {\small ${\bf r}(t)= \langle 4 \cos(t)-\cos(4t),4\sin(t)-\sin(4t),0 \rangle$,} con
...
\begin{figure}[H]
\centering
\caption{${\bf r}_1(u,t)=\la x(u,t),y(u,t),0 \ra$}
\label{fig:53}
\includegraphics[height=3.5cm]{Fig/53.pdf}
\fuentepropia
\end{figure}
...
${\bf r}_1(t,u)$ y ${\bf r}_2(t,u)$ se muestran en la siguiente figura.

\begin{figure}[H]
\begin{center}
\caption{Superficies determinadas por ${\bf r}_1(u,t)$ y ${\bf r}_2(u,t)$}
\includegraphics[height=3cm]{Img/78c.pdf}\hspace{5mm}
\includegraphics[height=3cm]{Img/78a.pdf} \\
\includegraphics[height=3cm]{Img/78b.pdf}
\end{center}
\parbox{0.95\linewidth}{\centering\fontsize{8pt}{10pt}\selectfont{\bf Fuente:} elaboración propia.}
\end{figure}

Las siguientes instrucciones permiten obtener los gráficos de la figura anterior.

\begin{tcolorbox}[title=\bf Instrucción \verb"Mathematica"]
\begin{Verbatim}[formatcom=\letraverbatim]
p={4*Cos[t]-Cos[4*t],4*Sin[t]-Sin[4*t],0};
r=(1-u)^(3/4)*p+u^(2/4)*{1,1,3};
ParametricPlot3D[{r,p*u},{u,0,1},{t,0,2Pi},PlotStyle->{Orange,Cyan}]
\end{Verbatim}
\end{tcolorbox}
...
$\bullet$\quad Las circunferencias parametrizadas por
$\vec{\alpha}(t)= \langle \cos(t),\sin(t),0 \rangle $ y $\vec{\beta}(t)= \langle 2\cos(t),2\sin(t),1 \rangle $,
se unen utilizando las funciones $g(u)= \sqrt{u}$ y $f(u)=1-u^2$; mediante la combinación
${\bf r}(u,t)= f(u)\vec{\alpha}(t) +g(u)\vec{\beta}(t)= \langle (2-2u^2+\sqrt{u})\cos t,(2-2u^2+\sqrt{u})\sin t,1- u^2\rangle$
...
\includegraphics[height=4cm]{Fig/54.pdf}
\fuentepropia
\end{figure}

$\bullet$\quad La curva parametrizada por las ecuaciones $x(t)= 16\sin ^{3}(t)$,
$y(t)=13\cos (t) -5\cos \left( 2t\right) -2\cos \left( 3t\right) -\cos \left(4t\right)$,
con $t\in [ 0,2\pi ]$, gira alrededor del eje vertical y genera una superficie.
Al hacer coincidir el eje vertical con el eje $z$, entonces la función que describe la superficie en mención, para $t\in [0,2\pi]$, $u\in [0,1]$, es:
\begin{gather*}
...
\includegraphics[height=3cm]{Img/49a.pdf} \hspace{1em}
\includegraphics[height=3cm]{Img/49b.pdf} \hspace{1em}
\includegraphics[height=3cm]{Fig/55.pdf}
\fuentepropia
\end{figure}
...
$x=\sqrt{2}u\cos (t)$, $z=\frac{3\sqrt{2}}{4}u\sin (t)$, para $t\in [ 0,2\pi ]$, $u\in [0,1]$. Al reemplazar estas expresiones en las ecuaciones del paraboloide y del paraboloide hiperbólico, se obtiene:
\[
...
\includegraphics[height=3.5cm]{Img/71b.pdf} \hspace{5mm}
\includegraphics[height=3.5cm]{Img/71d.pdf} \hspace{5mm}
\includegraphics[height=3.5cm]{Fig/56.pdf}
\fuentepropia
\end{figure}
...
Los gráficos de la figura~\ref{fig:superficies_parametrizadas} se obtienen al ejecutar las siguientes instrucciones. Al ingresar el código se usó la identidad $2\cos^2(t) = 1 + \cos(2t)$.
...
$\langle(1-\cos(t))\cos(t),(1-\cos(t))\sin(t)\rangle$ y la elipse parametrizada en la forma $\langle 3\cos(t),2\sin(t)\rangle$, $t\in [0,2\pi]$ determina una región en el plano acotada por sus gráficos (figura~\ref{Superficie_cilindro_parabólico}).

\begin{figure}[H]
\centering
\caption{Superficie sobre el cilindro parabólico $z=1+(1-y)^2/4$}
\label{Superficie_cilindro_parabólico}
\includegraphics[height=4cm]{Fig/57.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Fig/58.pdf}
\fuentepropia
\end{figure}
...
cilindro con ecuación $z=1+(1-y)^2/4$, que se encuentra entre el cilindro cardióidico
\index{Cilindro cardiodico}
con ecuación polar $r=1-\cos(t)$ y el cilindro elíptico con ecuación
$\frac{x^2}{9}+\frac{y^2}{4}=1$. La figura~\ref{Superficie_cilindro_parabólico_2} muestra esta situación.
\enlargethispage*{\baselineskip}

Los gráficos de la figura~\ref{Superficie_cilindro_parabólico_2} se elaboraron en \verb"Mathematica".
...
\centering
\caption{Superficie sobre el cilindro parabólico $z=1+(1-y)^2/4$}
\label{Superficie_cilindro_parabólico_2}
\includegraphics[height=5cm]{Img/43b.pdf} \hspace{5mm}
\includegraphics[height=5cm]{Img/43a.pdf}
\fuentepropia
\end{figure}
...
PlotRange->{{-3, 3}, {-2, 2}},MeshStyle->Gray]
a=ContourPlot3D[{z==1+(1-y)^2/4},{x,-4,4},{y,-4,4},{z,-1,5},
ContourStyle->RGBColor[0.1,0.4,0.3], Mesh->False];
b=ParametricPlot3D[{{x1,y1,u},{x2,y2, u}},{u,0,5},{t,0,2*Pi},
Mesh->False];
Show[a, b];
  \end{Verbatim}
\end{tcolorbox}
...
\begin{figure}[H]
\centering
\caption{Superficie sobre el cilindro $z=\cos (2x)$}
\includegraphics[height=4.5cm]{Img/46a.pdf} \hspace{5mm}
\includegraphics[height=4.5cm]{Img/46b.pdf}
\fuentepropia
\end{figure}
...
Se presenta ahora la figura~\ref{fig:superficie_cilindro_sin_2x} y las instrucciones
que se requieren para obtenerla:

\begin{figure}[H]
\centering
\caption{Superficie sobre el cilindro $z=\sin(2x)$}
\label{fig:superficie_cilindro_sin_2x}
\includegraphics[height=4cm]{Img/47b.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Img/47a.pdf}
\fuentepropia
\end{figure}
...
\begin{figure}[H]
\centering
\caption{Superficie sobre el cilindro $z=\frac{1}{5}y^{2}-\frac{1}{4}(x-1) ^{2}$}
\includegraphics[height=4cm]{Img/45a.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Img/45b.pdf}
\fuentepropia
\end{figure}

Como se señaló antes, nos falta determinar la coordenada $z$, esto es
\begin{align*}
z & =\frac{1}{5}y^{2}-\frac{1}{4}\left( x-1\right) ^{2} \\
& =\frac{1}{5}\big( \sin(t) \left( 1+u+(u-1) \cos(t) \right) \big)^{2} \\
& \quad -\frac{1}{4}\big(\cos(t)\left(\cos(t) \left( u-1\right) +1+2u\right)-1\big)^{2},
\end{align*}
...
para conseguir la figura se muestran enseguida.
...
\begin{figure}[H]
\centering
\caption{Región parametrizada por ${\bf r}(u,t)=\left\langle \cos(t)(3-u),\, \sin(t)(6-5u) \right\rangle$}
\label{fig:59}
\includegraphics[height=3.5cm]{Img/1a.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Fig/59.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Fig/60.pdf}
\fuentepropia
\end{figure}
...
\begin{figure}[H]
\centering
\caption{Cilindros elípticos intersecados por el plano $6z=2x+y+12$}
\label{fig:cilindros_intersecados}
\includegraphics[height=4cm]{Img/1c.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Img/1d.pdf}
\fuentepropia
\end{figure}
...
\end{multline*}
con $t\in \lbrack 0,2\pi ],\,\, u\in \lbrack 0,1]$.\enlargethispage*{\baselineskip}

\begin{figure}[t]
\centering
\caption[Región sobre el plano $6z=2x+y+12$ acotada por los cilindros elípticos]{Región sobre el plano $6z=2x+y+12$\\ acotada por los cilindros elípticos}
\label{Región_cilindros_elípticos}
\includegraphics[width=0.8\textwidth]{Fig/61.pdf}
\fuentepropia
\end{figure}
...
\begin{figure}[H]
\centering
\caption[Superficie sobre el paraboloide acotada por los cilindros elípticos]{Superficie sobre el paraboloide\\ acotada por los cilindros elípticos}
\label{Superficie_paraboloide_acotada_cilindros_elípticos}
\includegraphics[height=3.5cm]{Img/1e.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Img/1f.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Fig/62.pdf}
\fuentepropia
\end{figure}

Por lo tanto, la función
\begin{multline*}
\overrightarrow{r}(u,t) = \big\langle \cos(t)(3-u) ,\sin(t)( 6-5u) , -31+\left( 27-54u+24u^{2}\right) \\
\cos ^{2}(t) +\left( 6-2u\right) \cos (t) +60u-25u^{2} \big\rangle,
\end{multline*}
...
representan un paraboloide y un paraboloide hiperbólico (figura~\ref{fig:4yz}).

\begin{figure}[t]
\centering
\caption{$4y=z^{2}-x^{2}$ y $y=4-x^{2}-z^{2}$}
\label{fig:4yz}
\includegraphics[width=0.4\textwidth]{Img/4a.pdf} \hspace{5mm}
\includegraphics[width=0.4\textwidth]{Img/4b.pdf}
\fuentepropia
\end{figure}
...
el plano $xz$ (figura~\ref{fig:63}).

\begin{figure}[H]
\centering
\caption{$3x^{2}+5z^{2}\leq 16$}
\label{fig:63}
\includegraphics[height=4cm]{Fig/63.pdf}
\fuentepropia
\end{figure}

\textls[-20]{La frontera puede parametrizarse en la forma}
...
\]
con $t\in \lbrack 0,2\pi ]$, representa la curva $C$, que es la intersección.

$\bullet$\quad La superficie sobre el paraboloide hiperbólico acotado por la curva $C$ se puede
...
\begin{figure}[H]
\centering
\caption{Superficie determinada por $\mathbf{r}(t,u)$}
\label{fig:64}
\includegraphics[height=4cm]{Fig/64.pdf}
\fuentepropia
\end{figure}

$\bullet$\quad Ahora se desea parametrizar la parte del paraboloide acotado por la curva $C$.
...
\begin{figure}[H]
\centering
\caption[Superficie acotada por los paraboloides $4y=z^{2}-x^{2}$ y $y=4-x^{2}-z^{2}$]{Superficie acotada por los paraboloides\\ $4y=z^{2}-x^{2}$ y $y=4-x^{2}-z^{2}$}
...
4-32/15*u^2*Cos[t]^2-16*u^2/5,4*u/Sqrt[5]*Sin[t]},{t,0,2*Pi},
{u,0,1},PlotPoints->90,Ticks->{{-2,0,2},{0,2,4},{-1,0,1}},
PlotStyle->RGBColor[0.9,0.1,0.1,1],
MeshStyle->RGBColor[0.3,0.1,0.1,1]];
...
\begin{center}
\centering
\caption{Esfera y un cilindro elíptico}
\includegraphics[height=5cm]{Img/2a.pdf}\hspace{0.5cm}
\includegraphics[height=5cm]{Img/2b.pdf}
\fuentepropia
\end{center}
\end{figure}
...
\begin{figure}[H]
\centering
\caption{Esfera y un cilindro elíptico con su curva de intersección}
\includegraphics[height=5.5cm]{Img/2c.pdf} \hspace{5mm}
\includegraphics[height=5.5cm]{Img/2d.pdf}
\fuentepropia
\end{figure}
...
de donde, \[z= \pm \sqrt{15-6u\cos (t) -9u^{2}+5u^{2}\sin ^{2}(t)};\] con esto se establece que
\begin{gather*}
...
\begin{figure}[H]
\centering
\caption{Superficie sobre la esfera acotada por el cilindro elíptico}
\includegraphics[height=4.5cm]{Img/2e.pdf} \hspace{5mm}
\includegraphics[height=4.5cm]{Img/2f.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=3.5cm]{Img/2g.pdf} \hspace{3mm}
\includegraphics[height=3.5cm]{Img/2h.pdf} \hspace{3mm}
\includegraphics[height=3.5cm]{Fig/65.pdf}
\fuentepropia
\end{figure}
...
Los paraboloides elípticos con ecuaciones $z=3-2x^2-y^2$ y $z=x^2+2y^2$ se intersecan en una región determinada por $x^2+y^2=1$, cuyo interior se representa con $x=u \cos v$, $y=u \sin v$ con $u\in [0,1]$ y $v\in [0,2\pi]$.

\begin{figure}[H]
\centering
\caption{Sólido acotado por paraboloides}
\label{fig:300}
\includegraphics[width=0.5\textwidth]{Fig/300.pdf}
\fuentepropia
\end{figure}
...
$r=3 \cos\theta$, $z=-y$ y $z=0$. Esta región se muestra en la figura~\ref{Sólido_determinado}.

\begin{figure}[H]
\centering
\caption{Sólido determinado por $0\leq z \leq -y$, $r \leq 3 \cos \theta$}
\label{Sólido_determinado}
\includegraphics[height=3cm]{Fig/66.pdf}\hspace{2mm}
\includegraphics[height=3cm]{Fig/67.pdf}\hspace{2mm}
\includegraphics[height=3cm]{Fig/68.pdf}
\fuentepropia
\end{figure}
...
\begin{figure}[H]
\centering
\caption[Semiesfera $z=\sqrt{6-x^2-y^2+4x}$ y semicono $z=\sqrt{x^2+y^2}$]{Semiesfera $z=\sqrt{6-x^2-y^2+4x}$\\ y semicono $z=\sqrt{x^2+y^2}$}
\label{Semiesfera_y_semicono}
\includegraphics[height=4.5cm]{Img/74c.pdf}\hspace{5mm}
\includegraphics[height=4.5cm]{Fig/69.pdf}
...
\begin{figure}[H]
\centering
\caption{Región determinada por $x^2+y^2 \leq z^2 \leq 6-x^2-y^2+4x$}
\label{region_conos}
\includegraphics[height=4cm]{Img/74a.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Img/74b.pdf}
\fuentepropia
\end{figure}
...
\begin{figure}[H]
\centering
\caption{Sólido interior al paraboloide y exterior al cilindro}
\label{conos_naranjas}
\includegraphics[height=3.5cm]{Img/79a.pdf} \hspace{3mm}
\includegraphics[height=3.5cm]{Img/79c.pdf} \hspace{3mm}
\includegraphics[height=3.5cm]{Img/79b.pdf}
\fuentepropia
\end{figure}
...
usando una combinación convexa entre dos puntos $\left( 1+\cos (2t),\sin (2t)\right)$ y $\left(3\cos(2t),3\sin(2t)\right)$, la cual se simplifica como
\begin{align*}
...
\caption{${\bf r}(u,t)$}
\label{fig:70}
\includegraphics[height=3.5cm]{Fig/70.pdf}
\fuentepropia
\end{figure}
...
Las ecuaciones $z=4-y^{2}$, $z=4-x$, $z=0$ y $x=0$ representan un cilindro parabólico y
...
que se muestra en la figura~\ref{fig:71}.

\begin{figure}[H]
\centering
\caption{$z=4-y^2$, $z=4-x$}
\label{fig:71}
\includegraphics[height=3.5cm]{Fig/71.pdf}
\fuentepropia
\end{figure}
...
\begin{tcolorbox}[title=\bf Instrucción \verb"Mathematica"]
\begin{Verbatim}[formatcom=\letraverbatim]
RegionPlot3D[0<x<4-z&&(z-2)^2+y^2>1&&0<z<4-y^2&&-2<y<2,{x,0,4},
{y,-2,2},{z,0,4},PlotPoints->90,PlotStyle->Orange,Mesh->False]
\end{Verbatim}
\end{tcolorbox}

\begin{figure}[H]
\centering
\caption{Región determinada por $0\leq z \leq 4-x$, $z\leq 4-y^2$, $1\leq (z-2)^2+y^2$}
\includegraphics[height=2.5cm]{Img/5a.pdf} \hspace{3mm}
\includegraphics[height=2.5cm]{Img/5c.pdf} \hspace{3mm}
\includegraphics[height=2.5cm]{Img/5b.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=4cm]{Fig/72.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Fig/73.pdf}
\fuentepropia
\end{figure}
%
...
$\bullet$\quad {\bf Región 1.} Para aplicar el intervalo $[-2,2]$ en $[0,\pi ]$, se utiliza la relación
...
\begin{gather*}
{\bf r}_1(t,u)  =\left\langle 0, (1-u)\cos (t) +u\left(2-\frac{4t}{\pi}\right), \frac{16(\pi-t)tu}{\pi^2}-(u-1)(\sin(t)+2) \right\rangle,
\end{gather*}
para $t\in [0,\pi ]$ y $u\in [0,1]$.

$\bullet$\quad {\bf Región 2.} El segmento que une los puntos $\left(0,-2,0 \right) $ con $\left(0,2,0 \right)$,
...
\begin{multline*}
{\bf r}_3(u,t)=\bigg\langle 4-\frac{16 (\pi-t) t u}{\pi ^2}+(u-1) (\sin (t)+2), (1-u)\cos (t) \\
+u\left(2-\frac{4t}{\pi}\right), \frac{16 (\pi -t) t u}{\pi ^2}-(u-1) (\sin (t)+2) \bigg\rangle, t\in[0,\pi],\, u\in[0,1].
\end{multline*}
\begin{multline*}
{\bf r}_4(u,t)= \bigg\langle 4-(1-u)(\sin(t)+2),\\
\left(\frac{4(t-\pi)}{\pi}-2\right)u+(1-u)\cos(t),
(1-u)(\sin (t)+2)\bigg\rangle,\,t\in[\pi,2\pi],\, u\in[0,1].
\end{multline*}
...
{y2,z2}={(1-u)*Cos[t]+u*(4*(t-Pi)/Pi-2),(1-u)*(2+Sin[t])};
A1=ParametricPlot3D[{{0,y1,z1},{4-z1,y1,z1}},{t,0,Pi},{u,0,1},
Mesh->False,PlotStyle->Orange];
A2=ParametricPlot3D[{{0,y2,z2},{4-z2,y2,z2}},{t,Pi,2*Pi},{u,0,1},
Mesh->False,PlotStyle->Cyan];
...
$\bullet$\quad La cardioide con ecuación $r=1+\cos (t) $
...
\begin{figure}[H]
\centering
\caption{Gráfico de ${\bf r}\left(t,u,w\right)$}
\label{grf_bfr_tuw}
\includegraphics[height=2cm]{Img/76b.pdf}\hspace{3mm}
\includegraphics[height=2cm]{Img/76a.pdf}\hspace{3mm}
\includegraphics[height=2cm]{Img/76c.pdf}
\fuentepropia
\end{figure}
...
Las siguientes instrucciones, con $u=1$, permiten obtener la figura~\ref{grf_bfr_tuw}.

\begin{tcolorbox}[title=\bf Instrucción \verb"Mathematica"]
\begin{Verbatim}[formatcom=\letraverbatim]
r=(1-v)^(2/5)*{(1+Cos[t])*Cos[t],(1+Cos[t])*Sin[t],0}+v^2*{1,0,1};
p={r[[1]],r[[2]],0};
ParametricPlot3D[{r,p},{v,0,1},{t,0,2Pi},PlotPoints->80,
PlotStyle->{Orange,Cyan},MeshStyle->Gray]
\end{Verbatim}
\end{tcolorbox}

$\bullet$\quad De manera similar al ejemplo anterior, se puede utilizar
la función
\[{\bf r}(t,u,v)=\sqrt[4]{(1-v)^3}\, u(1+\cos(t)) (\cos(t),\sin(t),0)+\sqrt[4]{v^3}(1,0,1),\]
con $t \in [0,2\pi]$, $u \in [0,1]$ y $w \in [0,1]$. Para $u=1$ se genera la superficie cuya figura se muestra
a continuación.
...
\caption{Gráfico de ${\bf r}\left(t,u,w\right)$}
\label{grf_bfr_tuw_2}
\includegraphics[height=2cm]{Img/77a.pdf}\hspace{3mm}
\includegraphics[height=2cm]{Img/77b.pdf}
\fuentepropia
\end{figure}

Con las siguientes instrucciones se puede obtener la figura~\ref{grf_bfr_tuw_2}.
...
\subsection{Cono cardióidico} \index{Cono cardióidico}

\textls[-20]{El interior de la cardioide con ecuación polar $r=1+\cos(t)$, \index{Cardioide}
...
con el punto $\left( 1,0,1\right) $ es un \emph{cono cardióidico}\footnote{Este término fué acuñado por el profesor Juan Zambrano, de la Universidad Distrital Francisco José de Caldas.}.

\begin{figure}[H]
\centering
\caption{Cono cardióidico}
\includegraphics[height=2cm]{Img/75a.pdf}\hspace{3mm}
\includegraphics[height=2cm]{Img/75b.pdf}\hspace{3mm}
\includegraphics[height=2cm]{Img/75c.pdf}
\fuentepropia
\end{figure}
...
%\clearpage
\begin{ejer}
\textls[-20]{Parametrice y grafique en \verb"Mathematica" las siguientes regiones.}
\end{ejer}
...
\includegraphics[height=3.5cm]{Fig/74.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=3.5cm]{Fig/75.pdf} \hspace{5mm}
\includegraphics[height=3.5cm]{Fig/76.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[width=0.5\linewidth]{Fig/77.pdf}
\fuentepropia
\end{figure}
...
\begin{figure}[H]
\begin{center}
\caption{Región exterior a dos circunferencias}
\includegraphics[height=4cm]{Img/T_71a.pdf}
\fuentepropia
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
\caption{Región sobre el paraboloide hiperbólico}
\includegraphics[height=4cm]{Img/T_71b.pdf} \hskip0.5cm
\includegraphics[height=4cm]{Img/T_71c.pdf}
\fuentepropia
\end{center}
\end{figure}
...
\begin{figure}[H]
\centering
\caption{$2x^2+y^2\leq 16$, $ x^2-y^2-12 \leq 4z\leq 20 + x^2-2y^2$}
\includegraphics[width=4cm]{Img/T_56a.pdf} \hspace{5mm}
\includegraphics[width=4cm]{Img/T_56b.pdf}
\fuentepropia
\end{figure}
...
\begin{figure}[H]
\centering
\caption{$\sqrt{x^2+y^2} \leq z \leq (20-x-y)/5$}
\includegraphics[width=0.4\textwidth]{Img/T_39a.pdf}
\fuentepropia
\end{figure}
...
\begin{figure}[H]
\centering
\caption{$4x^2+9y^2=36$, $-9+y \leq 3z \leq 9-x$}
\includegraphics[width=0.35\textwidth]{Img/T_38a.pdf}
\fuentepropia
\end{figure}
