...
\begin{tabular}{p{0.26\textwidth}!{\vrule width 0.9pt}p{0.69\textwidth}}
  ...
  ¿Como citar este libro?~/ How to cite this book?} \\[3.5pt]
  & \hangindent=2mm \hangafter=0
  \fontsize{9pt}{10pt}\selectfont
  Zambrano Caviedes, J. y Baquero Torres, E. (2026). \emph{Problemas resueltos de integración múltiple con aplicaciones en Wolfram Mathematica.} Universidad Distrital Francisco José de Caldas-Editorial UD. DOI: XXXX
\end{tabular}\par
