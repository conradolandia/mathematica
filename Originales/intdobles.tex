...
\begin{ejemplo}
  ...
  \begin{figure}[H]
    ...
    \includegraphics[height=2.2cm]{Img/T_69c.pdf} \hspace{2mm}
    \includegraphics[height=2.2cm]{Img/T_69b.pdf} \hspace{2mm}
    \includegraphics[height=2.2cm]{Img/T_69a.pdf}
    \fuentepropia
  \end{figure}
...
\begin{figure}[t]
  ...
  \includegraphics[height=2cm]{Img/T_70a.pdf} \hspace{2mm}
  \includegraphics[height=2cm]{Img/T_70b.pdf} \hspace{2mm}
  \includegraphics[height=2cm]{Img/T_70c.pdf}
  \fuentepropia
\end{figure}
...
\includegraphics[height=2.2cm]{Img/T_68a.pdf} \hspace{2mm}
\includegraphics[height=2.2cm]{Img/T_68b.pdf} \hspace{2mm}
\includegraphics[height=2.2cm]{Img/T_68c.pdf}
\fuentepropia
\end{figure}
...
Las figuras y los cálculos anteriores se hicieron en \verb"Mathematica" ejecutando las siguientes instrucciones:
...
\includegraphics[height=4.5cm]{Fig/83.pdf}
\fuentepropia
\end{figure}
...
\begin{figure}[H]
\centering
\caption{$\sqrt{4-x^2} \leq y \leq x$}
\label{fig:141}
\includegraphics[height=3.5cm]{Fig/84.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Fig/85.pdf}
\fuentepropia
\end{figure}

Apoyándonos en la figura~\ref{fig:141}, la integral $\ds\iint_{D}xydA$ se puede evaluar como sigue:
...
\label{fig:142}
\includegraphics[height=3.5cm]{Fig/86.pdf}
\fuentepropia
\end{figure}
...
\[\int_{0}^{1}\int_{\sqrt{y}}^{2-y}xy\, dxdy.\]
...
\includegraphics[height=3cm]{Fig/80.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Fig/81.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Fig/82.pdf}
\fuentepropia
\end{figure}
...
Integrate[x*y,{x,0,1},{y,0,x^2}]+Integrate[x*y,{x,1,2},{y,0,2-x}]
\end{Verbatim}
\end{tcolorbox}
...
\begin{parrafonumerado}[resume=ordenint]
\item Determinar el centro de masa de una lámina delgada cuya densidad de área está dada por $\delta (x,y)=x$ $kg/m^2$ y posee la forma de la región en el primer cuadrante interior a la circunferencia con ecuación $x^{2}+y^{2}=4$ y exterior a la circunferencia $x^{2}+y^{2}=2x$.
\end{parrafonumerado}
...
\includegraphics[height=4cm]{Fig/87.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=3.7cm]{Fig/88.pdf} \hspace{2mm}
\includegraphics[height=3.7cm]{Fig/89.pdf} \hspace{2mm}
\includegraphics[height=3.7cm]{Fig/90.pdf}
\fuentepropia
\end{figure}
...
\label{fig510}
\includegraphics[height=3.5cm]{Fig/91.pdf}
\fuentepropia
\end{figure}
...
\centering
\caption{$2\sin \theta \leq r \leq 2$}
\includegraphics[height=3.5cm]{Fig/92.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Fig/93.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Fig/94.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=4cm]{Fig/95.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=3.5cm]{Fig/96.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Fig/97.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Fig/98.pdf}
\fuentepropia
\end{figure}
...
\begin{parrafonumerado}[resume=ordenint]
\item
Escribir en coordenadas rectangulares la siguiente integral: \[\ds\int_{0}^{\pi/4}\int_{0}^{2\sqrt{2}}r^2drd\theta.\]
\end{parrafonumerado}
...
\includegraphics[height=4cm]{Fig/99.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[width=0.3\linewidth]{Fig/100.pdf} \hfill
\includegraphics[width=0.3\linewidth]{Fig/101.pdf} \hfill
...
\begin{gather*}
\int_{0}^{\pi /4}\int_{0}^{2\sqrt{2}}r^2drd\theta = \int_{0}^2\int_{0}^{x}\sqrt{x^2+y^2}dydx + \\ \int_{2}^{2\sqrt{2}}\int_{0}^{\sqrt{8-x^2}}\sqrt{x^2+y^2}dydx = \int_0^2 \int _y ^{\sqrt{8-y^2}} \sqrt{x^2+y^2}\, dxdy = \frac{4\sqrt{2} \pi}{3}.
\end{gather*}
...
\includegraphics[height=4cm]{Fig/103.pdf}
\fuentepropia
\end{figure}
...
\centering
\caption{$x^2 + 2x - 2 \leq y \leq 2 - x^2$}
\includegraphics[height=3.5cm]{Fig/104.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Fig/105.pdf}
\fuentepropia
\end{figure}
...
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
Integrate[y-x,{x,-2,1},{y,x,2-x^2}]+Integrate[x-y,{x,-2,1},
{y,x^2+2*x-2,x}]
\end{Verbatim}
\end{tcolorbox}
...
\begin{parrafonumerado}[resume=ordenint]
\item
Evaluar $\ds \iint_R x dA$, donde $R$ es la región acotada por las figuras de las ecuaciones $x^2+y^2=4$
...
\centering
\caption{$x^2+y^2=4$}
\includegraphics[height=4cm]{Fig/106.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=3.5cm]{Fig/107.pdf}\hspace{2mm}
\includegraphics[height=3.5cm]{Fig/108.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Fig/109.pdf}
\fuentepropia
\end{figure}
...
\begin{gather*}
\begin{aligned}
\ds \iint_R x dA &= \int_{-\sqrt{3}}^{1}\int_{\frac{1}{2}\left(1-\sqrt{3}\right)(y-1)}^{\sqrt{4-y^{2}}}\!\!xdxdy + \int_1^2\int_{0}^{\sqrt{4-y^{2}}}\!\!xdxdy \\
...
entonces:
\begin{multline*}
A=\frac{1}{2}\int_{0}^{2\pi}\big((2a\sin(t)+a\cos(2t))(b\sin(t))\\ +(2a\cos(t)-a\sin(2t))(b\cos t) \big) dt  = 2\pi ab.
\end{multline*}

\begin{figure}[H]
\centering
\caption{${\bf r}(t)=\langle 2a\cos t-a\sin (2t),b\sin t\rangle$, $t\in [0,2\pi ]$}
\includegraphics[height=3.5cm]{Fig/110.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=4cm]{Fig/113.pdf}
\fuentepropia
\end{figure}
...
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
Integrate[x*y,{y,1,Sqrt[3]},{x,1/y,y}]+Integrate[x*y,{y,Sqrt[3],3},
{x,y/3,3/y}]
...
\item Evaluar $\ds \iint_R xy dA$, en donde $R$ es la región en el primer cuadrante acotada por las gráficas de las expresiones
$x^{2}y=1$, $x^{2}y=4$, $y=x^{2}$ y $y=4x^{2}$.

\begin{figure}[H]
\centering
\caption{${\bf T}(u,v)= (\sqrt[4]{\frac{u}{v}},\sqrt{uv})$}
\includegraphics[height=4cm]{Fig/114.pdf}
\fuentepropia
\end{figure}
...
\begin{gather*}
\begin{aligned}
\ds \iint_R xy dA &= \int_{\frac{1}{\sqrt{2}}}^{1}\int_{1/x^{2}}^{4x^{2}}xydydx+\int_{1}^{\sqrt{2}}\int_{x^{2}}^{4/x^{2}}xydydx \\
...
También se puede utilizar el teorema de cambio de variable, definiendo $u=x^{2}y$ y $v=y/x^{2}$, de donde $x=\sqrt[4]{\frac{u}{v}}$, $y=\sqrt{u}\sqrt{v}$; por lo tanto, el jacobiano de la transformación es:
\[\left|
...
&=\int_{1}^{4}\int_{1}^{4}\frac{1}{4}\frac{\sqrt{u}}{\sqrt{v}}\, dudv\\
&= \frac{7}{3}.
\end{align*}
...
\includegraphics[height=3.5cm]{Fig/115.pdf} \hspace{5mm}
\includegraphics[height=3.5cm]{Fig/116.pdf}
\fuentepropia
\end{figure}
...
\textls[-10]{que se reduce a $u^{2}=1$, es decir, $u=\pm 1$.
...
En coordenadas rectangulares, la integral $\iint _{R}\frac{x-y}{x+y}dA$ se puede evaluar como se muestra a continuación:
...
La figura~\ref{transformacion_uv_117} muestra la región transformada; el jacobiano de la transformación es
$J=\det \left(
\begin{array}{cc}
\frac{1}{2} & -\frac{1}{2} \\[3pt]
\frac{1}{2} & \phantom{-}\frac{1}{2}
\end{array} \right) = \frac{1}{2}$; luego
$I=\int_{2}^{4}\int_{0}^2\frac{-v}{u}\left( \frac{1}{2}\right) dvdu= -\ln \left( 2\right) $.

\begin{figure}[H]
\centering
\caption{${\bf T}(u,v)= \left(\frac{u - v}{2},\, \frac{u + v}{2}\right)$}
\label{transformacion_uv_117}
\includegraphics[height=3.5cm]{Fig/117.pdf} \hspace{5mm}
\includegraphics[height=3.5cm]{Fig/118.pdf}
\fuentepropia
\end{figure}

\item Evaluar $\iint_R \sqrt{xy}\ln \left( \frac{y}{x}\right) dA$, en donde $R$ es la región en el plano $xy$ determinada por el cambio de variables
$u^{2}=xy$, $v=\ln \left( y/x\right) $, con $u\in \lbrack 1,2]$, $v\in [0,2]$.
...
\item Si $u=2$ y $0\leq v\leq 2$, entonces $x=2e^{-v/2}$ y $y=2e^{v/2}$, es decir, $xy=4$.
\item Si $v=0$ y $1\leq u\leq 2$, se sigue que $x=u$ y $y=u$, entonces $x=y$.
\item Si $v=2$ y $1\leq u\leq 2$ Entonces, $x=ue^{-1}$ y $y=ue$; por lo tanto, $y=e^{2}x$.
\end{itemize}
...
se muestran en la figura~\ref{fig:121x}.
...
\includegraphics[height=4cm]{Fig/123.pdf}
\fuentepropia
\end{figure}
...
\centering
\caption{${\bf T}(u,v)= (x,y)$}
\includegraphics[height=4cm]{Fig/124.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=3cm]{Fig/125.pdf} \hspace{5mm}
\includegraphics[height=3cm]{Fig/126.pdf}
\fuentepropia
\end{figure}
...
A=Assuming[t>=0&&u>=0,Simplify[Norm[Cross[D[r,u],D[r,t]]]]]
...
\includegraphics[height=3.5cm]{Img/6g.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Img/6a.pdf} \hspace{2mm}
\includegraphics[height=3.5cm]{Img/6b.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=4cm]{Img/6f.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Img/6c.pdf}
\fuentepropia
\end{figure}
...
\centering
\caption{Curva de intersección de la esfera y los cilindros}
\label{fig:curvas_interseccion_esfera_cilindros}
\includegraphics[height=3cm]{Img/6d.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Img/6e.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Fig/127.pdf}
\fuentepropia
\end{figure}

La figura~\ref{fig:curvas_interseccion_esfera_cilindros} se obtiene ejecutando las siguientes instrucciones:
...
\begin{tcolorbox}[title=\bf Instrucción en \verb"Mathematica"]\begin{Verbatim}[formatcom=\letraverbatim]
ContourPlot3D[{x^2+y^2+z^2==4,x^2+y^2==2*x,x^2+z^2==2*x},
{x,-2,2},{y,-2,2},{z,-2,2},PlotPoints->80,Mesh->False]
ContourStyle->{Orange,Yellow,LightGreen}
\end{Verbatim}
\end{tcolorbox}

Región sobre la esfera acotada por los cilindros, se definen tres objetos nombrados \verb"a,b,c", luego se muestran en una sola figura usando la función \verb"Show".
...
{t,0,2*Pi},{u,0,1},PlotStyle->Blend[{Yellow,Pink,Green}]];
...
\subsection{Un cilindro cardióidico bajo un paraboloide}
...
\begin{figure}[H]
\centering
\caption{Cilindro cardióidico y paraboloide}
\includegraphics[height=3cm]{Img/40a.pdf} \hspace{5mm}
\includegraphics[height=3cm]{Img/40b.pdf}
\fuentepropia
\end{figure}
...
\begin{figure}[H]
\centering
\caption[Superficie sobre el cilindro cardióidico acotada por el paraboloid]{Superficie sobre el cilindro cardióidico\\ acotada por el paraboloide}
\includegraphics[height=3cm]{Fig/128.pdf} \hspace{5mm}
\includegraphics[height=3cm]{Img/39c.pdf}
\fuentepropia
\end{figure}
...
\begin{gather*} \overrightarrow{p}(t,u)=\big\langle (1-\cos(t))\cos(t),(1-\cos(t))\sin(t), \\ \frac{1}{6}\left(u(13-4\sin(t)+2\sin(2t)+\cos(2t)) \right)\big\rangle,
\end{gather*}
...
\end{multline*}
Al integrarlo con los límites descritos antes, proporciona el valor del área del cilindro cardióidico que se encuentra entre el plano $xy$ y el paraboloide, esto es:
...
\subsection{Un paraboloide fuera de un cilindro cardióidico}
...
\end{align*}
Entonces la superficie sobre el paraboloide que se encuentra fuera del cilindro cardióidico, y sobre el plano $xy$ se parametriza como:
\begin{gather*}
...
\includegraphics[height=4cm]{Img/55d.pdf} \hspace{3mm}
\includegraphics[height=4cm]{Img/55c.pdf} \hspace{3mm}
\includegraphics[height=4cm]{Img/55b.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=3.5cm]{Img/32.pdf} \hspace{3mm}
\includegraphics[height=3.5cm]{Fig/131.pdf} \hspace{3mm}
\includegraphics[height=3.5cm]{Fig/132.pdf}
\fuentepropia
\end{figure}
...
La superficie del cilindro cardióidico con ecuación
$r=2(1+\cos(t))$, acotada por los planos $z=0$ y $z=2-x/2$, se presenta a continuación. También se muestra la porción sobre el plano $z=2-x/2$ acotada por el cilindro cardióidico. Hallaremos el área de estas dos superficies.

\begin{figure}[H]
\centering
\caption{Superficies sobre el cilindro cardióidico y sobre el plano \( z = 2 - \frac{x}{2} \)}
\includegraphics[height=3cm]{Fig/134.pdf} \hspace{5mm}
\includegraphics[height=3cm]{Fig/135.pdf}
\fuentepropia
\end{figure}
...
por lo tanto, la curva de intersección entre el plano y el cilindro cardióidico se parametriza como
...
\begin{align*}
{\bf r}(u,t)&=(1-u) \la 2\left( 1+\cos (t) \right) \cos (t) ,2\left( 1+\cos (t) \right) \sin (t) ,0\ra \\
&\quad +u\big \langle 2\left( 1+\cos (t) \right) \cos(t) , 2\left( 1+\cos (t) \right) \sin (t),\\
&\quad 2-\left( 1+\cos (t) \right) \cos (t) \big \rangle = \big \langle 2( \cos (t)+1) \cos (t),\\
&\quad 2\sin (t)+\sin (2t), u(2-\left( 1+\cos (t) \right) \cos (t)) \big \rangle \\
&\quad t\in [0,2\pi], u\in [0,1].
\end{align*}
...
Hallaremos ahora el área de la región sobre el plano $z=2-x/2$, acotada por el cilindro cardióidico.
...
Entonces, la parte del plano acotada por el cilindro cardióidico se parametriza por medio de la siguiente función:
\begin{gather*}
...
\subsection{Dos cilindros cardióidicos entre dos planos}
Las ecuaciones $r = 1-\cos(t)$ y $r = 2- 2\cos(t)$ representan, en el plano, dos cardioides, y en el espacio estas mismas ecuaciones representan dos cilindros cardióidicos\footnote{Este término fue acuñado por el profesor Juan Zambrano, de la Universidad Distrital Francisco José de Caldas.}. Estas cilíndricas se cortan por los planos $z=0$ y $z=2-x/2$.
%
\begin{figure}[H]
\centering
\caption{Superficie sobre el plano \( z = 2 - x/2 \) acotada por dos cilindros cardióidicos}
\includegraphics[height=4cm]{Fig/136.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Img/36b.pdf}
\fuentepropia
\end{figure}
%
En el plano $xy$ los cilindros cardióidicos se  parametrizan en la forma:
\begin{eqnarray*}
...
\begin{gather*}
\begin{aligned}
\overrightarrow{p}(t) &= \big\langle \left( 1-\cos(t) \right)\cos(t),\left( 1-\cos(t) \right)\sin(t), 2-\left( \left( 1-\cos(t) \right)\cos(t) \right)/2 \big\rangle \\
...
\begin{figure}[H]
\centering
\caption{Cilindros cardióidicos acotados por dos planos}
\includegraphics[height=4cm]{Fig/137.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Fig/138.pdf}
\fuentepropia
\end{figure}
...
\begin{figure}[H]
\centering
\caption{Cilindros cardióidicos}
\includegraphics[height=4cm]{Img/57a.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Img/57b.pdf}
\fuentepropia
\end{figure}
...
\includegraphics[height=4cm]{Img/19a.pdf}
\fuentepropia
\end{figure}

con la función ${\bf r}\left( t,u\right) $ hallamos ${\bf r}_{t}=\left\langle -\sin (t) \left( 1+u\right) ,\cos \left(t\right) \left( 1+u\right) ,0\right\rangle$ y
\textls[-15]{${\bf r}_{u}=\left\langle 1+\cos (t) ,\sin (t),3\right\rangle$, que determinan el elemento diferencial de área}
...
\includegraphics[height=2.8cm]{Fig/139.pdf} \hspace{2mm}
\includegraphics[height=2.8cm]{Img/20a.pdf} \hspace{2mm}
\includegraphics[height=2.8cm]{Img/20b.pdf}
\fuentepropia
\end{figure}
...
\end{parrafoitemize}
Los cuales describen las direcciones tangentes de la superficie parametrizada. Además, el producto cruz
...
\subsection{Cono cardióidico oblicuo y truncado}
...
\end{eqnarray*}
Con $t \in [0,2\pi]$, se trazan segmentos rectilíneos entre estas dos curvas, lo que produce una parametrización de un cono truncado oblicuo, cuyos cortes paralelos al plano $xy$ son cardioides\index{Cono cardióidico!oblicuo y truncado}.
...
\begin{figure}[t]
\centering
\caption{Cono cardióidico oblicuo truncado}
\includegraphics[height=3cm]{Fig/140.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Img/21a.pdf} \hspace{2mm}
\includegraphics[height=3cm]{Img/21b.pdf}
\fuentepropia
\end{figure}
...
\begin{parrafoitemize}
\item {\small ${\bf r}_{t}= \left\langle -\sin (t) \left( 1+2\cos (t) \right) (1+u) ,\left( 1+\cos(t) \right) \left( 2\cos(t) -1\right)( 1+u) ,0\right\rangle.$}
\item {\small $ {\bf r}_{u}=\left\langle \cos (t) \left( 1+\cos \left(t\right) \right) ,\sin (t) \left( 1+\cos (t) \right),3\right\rangle.$}
\end{parrafoitemize}
Además,
\begin{multline*}
...
\includegraphics[height=30mm, valign=m]{Fig/141.pdf} \hspace{5mm}
\includegraphics[height=30mm, valign=m]{Img/48a.pdf}
\fuentepropia
\end{figure}
...
Sqrt[2-Sin[3*t]^2]},{t,0,2*Pi},
PlotPoints->80,PlotStyle->{Black,Thickness->0.012}];
Show[A,c,b]
\end{Verbatim}
\end{tcolorbox}
...
\centering
\caption{La flor $r=3\sin(3\theta)$ sobre una esfera}
\includegraphics[height=4cm]{Img/68a.pdf} \hspace{5mm}
\includegraphics[height=4cm]{Img/68b.pdf}
\fuentepropia
\end{figure}
...
\subsection{Toros cardióidicos} \index{Toro cardióidico}
...
\includegraphics[height=3.5cm]{Fig/143.pdf} \hspace{3mm}
\includegraphics[height=3.5cm]{Fig/144.pdf} \hspace{3mm}
\includegraphics[height=3.5cm]{Fig/145.pdf}
\fuentepropia
\end{figure}

\subsubsection{Toro cardióidico generado por \texorpdfstring{$r=1-\sin(t)$}{r=1-sin(t)}}
...
\textls[-30]{De esta manera, las coordenadas del centro de masa de la curva están dadas~por:}
\begin{eqnarray*}
...
se satisface que si un punto sobre esta curva gira alrededor del eje $z$, entonces se obtiene una circunferencia y se genera una superficie que denominaremos \emph{toro cardióidico.}
\index{Toro cardióidico}

\begin{figure}[H]
\centering
\caption{Toro cardióidico construido a partir de $r=1-\sin(t)$}
\includegraphics[height=3cm]{Fig/147.pdf} \hspace{5mm}
\includegraphics[height=3cm]{Img/63a.pdf}
\fuentepropia
\end{figure}
...
\centering
\caption{Toro cardióidico construido a partir de $r=1-\sin(t)$}
\includegraphics[height=3cm]{Img/63b.pdf} \hspace{5mm}
\includegraphics[height=3cm]{Img/63c.pdf}
\fuentepropia
\end{figure}
...
\end{multline*}
\textls[-20]{que se integra y nos proporciona el área superficial de la región en mención.}
\begin{multline*}
...
\subsubsection{Toro cardióidico generado por \texorpdfstring{$r=1-\cos(t)$}{r=1-cos(t)}}
...
De acuerdo con el teorema de Pappus, el área de la superficie de revolución es $2\pi \left( \frac{11}{5}\right) \left( 8\right) = \frac{176}{5}\pi $.
...
\begin{figure}[H]
\centering
\caption{Toro cardióidico construido a partir de $r=1-\cos(t)$}
\includegraphics[height=3cm]{Img/59a.pdf} \hspace{5mm}
\includegraphics[height=3cm]{Img/59b.pdf} \hspace{5mm}
\includegraphics[height=3cm]{Img/59c.pdf}
\fuentepropia
\end{figure}
...
ParametricPlot[{x,y},{t,0,2*Pi}]
ParametricPlot3D[{x*Cos[u],x*Sin[u],y},{t,0,2*Pi},{u,0,2*Pi}]
\end{Verbatim}
\end{tcolorbox}
...
La superficie obtenida se puede observar en la figura~\ref{torocardio2x}.

\begin{figure}[H]
\centering
\caption{Toro cardióidico construido a partir de $r=1+\cos(t)$}
\label{torocardio2x}
\includegraphics[height=2.2cm]{Img/64a.pdf} \hspace{2mm}
\includegraphics[height=2.2cm]{Img/64b.pdf} \hspace{2mm}
\includegraphics[height=2.2cm]{Img/64c.pdf}
\fuentepropia
\end{figure}
...
y=(1+Cos[t])*Sin[t];
ParametricPlot[{x,y},{t,0,2*Pi}]
ParametricPlot3D[{x*Cos[u],x*Sin[u],y},{t,0,2*Pi},{u,0,4*Pi/3},
MeshStyle->Gray]
\end{Verbatim}
\end{tcolorbox}

Con ayuda de la función ${\bf r}$, hallamos los siguientes vectores:
\begin{multline*}
...
x=3+(1+Cos[t])*Cos[t];
y=(1+Cos[t])*Sin[t];
ParametricPlot[{x,0,y},{t,0,2*Pi}];
RevolutionAxis->{0,0,1},
MeshStyle->Gray,Ticks->{{-3,0,3},{-3,0,3},{-1,0}},PlotStyle->Orange]
r={x*Cos[u],x*Sin[u],y};
A=Assuming[t>=0&&u>=0,Simplify[Norm[Cross[D[r,t],D[r,u]]]]]
Integrate[A,{t,0,2*Pi},{u,0,2*Pi}]
\end{Verbatim}
\end{tcolorbox}
...
\begin{enumerate}
\item La superficie sobre el paraboloide $2z=x^2+y^2$ acotada por el cilindro cardióidico $r=1+\cos(t)$.

\begin{figure}[H]
\centering
\caption{Paraboloide acotada por el cilindro cardióidico}
\includegraphics[height=3cm]{Img/T_30a.pdf} \hspace{3mm}
\includegraphics[height=3cm]{Img/T_30b.pdf} \hspace{3mm}
\includegraphics[height=3cm]{Img/T_30c.pdf}
\fuentepropia
\end{figure}

\item La superficie sobre el paraboloide hiperbólico $2z=y^2-x^2$ acotada por el cilindro cardióidico $r=1+\cos(t)$.

\begin{figure}[H]
\centering
\caption{Un paraboloide hiperbólico y un cilindro cardióidico}
\includegraphics[height=2.5cm]{Img/T_31a.pdf} \hspace{3mm}
\includegraphics[height=2.5cm]{Img/T_31b.pdf}
\fuentepropia
\end{figure}

\enlargethispage*{\baselineskip}

\item La superficie sobre la esfera con ecuación $x^2+y^2+z^2=4$ acotada por el cilindro cardióidico $1+\cos(t)$.

\begin{figure}[H]
\centering
\caption{Esfera y cilindro cardióidico}
\includegraphics[height=2.5cm]{Img/T_32a.pdf} \hspace{3mm}
\includegraphics[height=2.5cm]{Img/T_32b.pdf} \hspace{3mm}
\includegraphics[height=2.5cm]{Img/T_32c.pdf}
\fuentepropia
\end{figure}

\item Un pétalo de la flor $r=\sin(3\theta)$ gira alrededor de una recta perpendicular al eje polar, que pasa por el polo. Hallar el área de la superficie obtenida.

\begin{figure}[H]
\centering
\caption{Superficie obtenida de girar $r=\sin(3\theta)$}
\includegraphics[height=2.5cm]{Img/99a.pdf} \hspace{5mm}
\includegraphics[height=2.5cm]{Img/99b.pdf} \hspace{5mm}
\includegraphics[height=2.5cm]{Img/99c.pdf}
\fuentepropia
\end{figure}
\end{enumerate}
\end{ejer}
