...
\begin{figure}[H]
\centering
\caption{Cilindros cardiotónicos}
...
t\right) \left( 1+u\right) ,0\right\rangle$\; y\; ${\bf r}_{u}=\left\langle 1+\cos (t) ,\sin (t),3\right\rangle$, que determinan el elemento diferencial de área
