...
\includegraphics[height=4cm]{Fig/171.png}
\fuentepropia
\end{figure}
...
Evalúe $\iint_S \rot{\bf F} \cdot d{\bf S}$ en donde ${\bf F}(x,y,z)=\left\langle y^{2},yz-x,xz-y\right\rangle $ y %% $
...
\end{align*}
\textls[-10]{Entonces, ${\bf F}({\bf r}(u,v)) \cdot ({\bf r}_{u}\times {\bf r}_{v}) = u(2-u)$. Con lo cual, el flujo está dado por}
...
Evalúe $\int_S\rot{\bf F}\cdot d{\bf S}$ y $\int_C{\bf F}\cdot d{\bf r}$; en donde $S$ es la superficie en mención y $C$ es su frontera.
