...
\textls[-20]{De acuerdo con \cite{marsden_calculo_2013}, la longitud de arco $L$ de la curva $C$ en $\mathbb{R}^3$, determinada por la función vectorial
...
\label{fig:67}
\includegraphics[height=5cm]{Img/67a.pdf} \hspace{5mm}
\includegraphics[height=5cm]{Fig/301.pdf}
\fuentepropia
\end{figure}
...
Show[ContourPlot3D[{x^2+y^2==4,z==x^2-y^2},{x,-4,4},{y,-4,4},{z,-5,5},
Mesh->False,PlotPoints->50,ContourStyle->{Orange,RGBColor[0.1,0.6,0.2]}],
