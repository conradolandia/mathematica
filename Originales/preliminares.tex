...
de $f$. De acuerdo con \cite{apostol_calculus_1999}, a las funciones definidas cuando $n=m=1$, se denominan \emph{funciones reales,} las cuales se estudian en los cursos de \emph{cálculo diferencial} y \emph{cálculo integral.}
...
\end{eqnarray*}
El volumen de esta región, $\Delta V$, está dada por:
\begin{equation}
