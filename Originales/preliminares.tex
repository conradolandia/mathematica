...
En el caso general una función ${\bf F}:\mathbb{R}^{n}\rightarrow \mathbb{R}^{m}$ se dice
diferenciable en $a\in \mathbb{R}^{n}$
si existe una transformación lineal $\lambda :\mathbb{R}^{n}\rightarrow \mathbb{R}^{m}$, tal que
...
\begin{equation*}
\Delta x= \frac{\frac{\pi}{2}-\left(\frac{-\pi}{2}\right)}{n}=\frac{\pi}{2n}\quad
\Delta y= \frac{\frac{\pi}{4}-0}{m}=\frac{\pi}{4m}\quad \text{y}\quad \Delta z= \frac{1}{l}.
\end{equation*}
Además,
...
\includegraphics[height=3cm]{Fig/10.pdf}\hspace{5mm}
\includegraphics[height=3cm]{Fig/11.pdf}\\[5mm]
\includegraphics[height=3cm]{Fig/12.pdf}
\fuentepropia
\end{figure}
