...
\begin{document}
\begin{pspicture}(-2,-0.8)(3.5,3.1) % \psgrid
\psset{algebraic,Alpha=40,Beta=20,plotstyle=curve,xunit=0.7,yunit=0.8}
\pstThreeDCoor[linecolor=black,Dy=2,deltay=2,xMin=-4.3,xMax=3,yMin=-3,yMax=4.1,zMin=-1,zMax=4.2,spotZ=180,IIIDticks,IIIDlabels]
...
\pstThreeDLine[linecolor=black!50,linewidth=1.2pt](-2,1,0)(-2,1,0.5)
\pscustom[fillstyle=hlines,hatchcolor=gray!30,hatchwidth=0.8pt,hatchsep=0.8pt,linestyle=none]{
\parametricplotThreeD(0,\psPiTwo){(2-2*cos(t))*cos(t)|(2-2*cos(t))*sin(t)|1-((2-2*cos(t))*sin(t))/3}
} 
\parametricplotThreeD[linecolor=black!60,linewidth=1pt](0,\psPiTwo){2*(1-cos(t))*cos(t)|2*(1-cos(t))*sin(t),1-(2*(1-cos(t))*sin(t))/3} 
